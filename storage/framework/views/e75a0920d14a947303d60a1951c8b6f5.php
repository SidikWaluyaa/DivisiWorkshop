<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="group bg-white rounded-3xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100 hover:border-[#22AF85]/50 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Pendapatan (<?php echo e($periodLabel); ?>)</p>
            <h3 class="text-3xl font-black text-gray-800 tracking-tight group-hover:text-[#22AF85] transition-colors">
                Rp <?php echo e(number_format($revenueData['total'] / 1000, 0, ',', '.')); ?><span class="text-lg text-gray-400 font-bold">rb</span>
            </h3>
            <div class="mt-4 flex items-center gap-2">
                <span class="px-2 py-1 bg-[#22AF85]/10 text-[#22AF85] text-xs font-bold rounded-lg group-hover:bg-[#22AF85]/20 transition-colors">
                    +<?php echo e(count($revenueData['daily']['data'])); ?> Data Point
                </span>
    ...
    <div class="group bg-white rounded-3xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100 hover:border-[#22AF85]/50 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Net Profit (<?php echo e($periodLabel); ?>)</p>
            <h3 class="text-3xl font-black text-gray-800 tracking-tight group-hover:text-[#22AF85] transition-colors">
                Rp <?php echo e(number_format($financialMetrics['net_profit'] / 1000, 0, ',', '.')); ?><span class="text-lg text-gray-400 font-bold">rb</span>
            </h3>
            <div class="mt-4 flex items-center gap-2">
                <span class="px-2 py-1 bg-[#22AF85]/10 text-[#22AF85] text-xs font-bold rounded-lg group-hover:bg-[#22AF85]/20 transition-colors">
                    <?php echo e($financialMetrics['margin']); ?>% Margin
                </span>
    ...
    <div class="group bg-white rounded-3xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100 hover:border-[#22AF85]/50 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-3xl font-black text-gray-800 tracking-tight group-hover:text-[#22AF85] transition-colors">
                <?php echo e($customerRetention['rate']); ?>%
            </h3>
            <div class="mt-4 flex items-center gap-2">
                <span class="px-2 py-1 bg-[#22AF85]/10 text-[#22AF85] text-xs font-bold rounded-lg group-hover:bg-[#22AF85]/20 transition-colors">
                    <?php echo e($customerRetention['returning']); ?> Repeat
                </span>
                 <span class="text-xs text-gray-400 font-medium">vs <?php echo e($customerRetention['new']); ?> New</span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\dashboard\partials\metrics.blade.php ENDPATH**/ ?>