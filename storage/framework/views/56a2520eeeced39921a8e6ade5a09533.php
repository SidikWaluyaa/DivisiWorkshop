                                    ...
                                    <td class="px-8 py-8 text-right">
                                        ...
                                        <div class="space-y-1 pt-2 border-t border-gray-50">
                                            <div class="flex justify-end items-center gap-2">
                                                ...
                                                <span class="text-[10px] font-black text-emerald-600 italic tabular-nums">Rp <?php echo e(number_format($invoice->total_dp, 0, ',', '.')); ?> <span class="text-[8px] opacity-60">(<?php echo e($invoice->dp_unique_code ?? '-'); ?>)</span></span>
                                            </div>
                                            <div class="flex justify-end items-center gap-2">
                                                <span class="text-[8px] font-black text-gray-400 italic uppercase tracking-tighter">Penagihan Full:</span>
                                                <span class="text-[10px] font-black text-rose-600 italic tabular-nums">Rp <?php echo e(number_format($invoice->total_full, 0, ',', '.')); ?> <span class="text-[8px] opacity-60">(<?php echo e($invoice->final_unique_code ?? '-'); ?>)</span></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-8 py-8 text-center">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-0.5 mt-2 pt-2 border-t border-gray-50">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-[9px] font-black text-emerald-600 italic">Rp <?php echo e(number_format($invoice->total_dp, 0, ',', '.')); ?> (<?php echo e($invoice->dp_unique_code ?? '-'); ?>)</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-[7px] font-black text-gray-400 italic uppercase">Full:</span>
                                        <span class="text-[9px] font-black text-rose-600 italic">Rp <?php echo e(number_format($invoice->total_full, 0, ',', '.')); ?> (<?php echo e($invoice->final_unique_code ?? '-'); ?>)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
