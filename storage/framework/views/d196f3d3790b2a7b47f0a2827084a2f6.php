                                ...
                                <tr class="hover:bg-gray-50/50 transition group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($spk->items_count > 1): ?>
                                                <span class="bg-[#22AF85] text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-sm">
                                                    <?php echo e($spk->items_count); ?> Item
                                                </span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <div class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter mb-2"><?php echo e($spk->lead?->customer_phone ?? '-'); ?></div>
                                        
                                        
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($spk->items && count($spk->items) > 0): ?>
                                        <div class="space-y-2 border-t border-gray-50 pt-2">
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $spk->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <div class="flex flex-col group/item">
                                                <div class="flex items-center gap-1.5">
                                                    <span class="text-xs"><?php echo e($item->category_icon); ?></span>
                                                    <span class="text-[10px] font-black text-gray-700 uppercase tracking-tight"><?php echo e($item->shoe_brand); ?></span>
                                                    <span class="text-[10px] font-bold text-gray-400"><?php echo e($item->shoe_type); ?></span>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($itemWo): ?>
                                                ...
                                                <div class="pl-5 text-[9px] font-bold text-[#22AF85] leading-none mt-0.5">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($item->services)): ?>
                                                        <?php echo e(collect($item->services)->map(fn($s) => is_array($s) ? ($s['name'] ?? '-') : $s)->implode(' • ')); ?>

                                                    <?php else: ?>
                                                        <?php echo e($item->services); ?>
                                        ...
                                        <?php elseif($spk->shoe_brand): ?> 
                                        <div class="mt-1 flex flex-col border-t border-gray-50 pt-2">
                                            <div class="flex items-center gap-1.5">
                                                <span class="text-[10px] font-black text-gray-700 uppercase tracking-tight"><?php echo e($spk->shoe_brand); ?></span>
                                                <span class="text-[10px] font-bold text-gray-400"><?php echo e($spk->shoe_type); ?></span>

                                                
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($spk->workOrder): ?>
                                                    <span class="text-[9px] font-black text-[#22AF85] bg-[#22AF85]/10 px-1.5 py-0.5 rounded-md ml-auto border border-[#22AF85]/20 shadow-sm" title="No. WO di Workshop">
                                                        <?php echo e($spk->workOrder->spk_number); ?>

                                                    </span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            <div class="text-[9px] font-bold text-[#22AF85]">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($spk->services)): ?>
                                                    <?php echo e(collect($spk->services)->map(fn($s) => is_array($s) ? ($s['name'] ?? '-') : $s)->implode(' • ')); ?>

                                                <?php else: ?>
                                                    <?php echo e($spk->services); ?>
