                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="entry_date" required value="<?php echo e(date('Y-m-d')); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-700 mb-1">Estimasi Selesai *</label>
                                <input type="date" name="estimation_date" required value="<?php echo e(date('Y-m-d', strtotime('+3 days'))); ?>"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            </div>
                        </div>
                    </div>
...
<div id="orderDetailModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-[60]">
    <div class="relative top-10 mx-auto p-6 border w-full max-w-2xl shadow-2xl rounded-xl bg-white my-10 animate-fade-in">
        ...
        <div class="space-y-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($order->warehouse_qc_status)): ?>
        ...
        <div class='mt-3'>
            ...
            <div class='mb-6'>
                ...
                <select id='storage_rack_id' class='w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:ring-2 focus:ring-[#22AF85] focus:border-[#22AF85] text-sm font-bold text-gray-900 bg-gray-50/50 transition-all'>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($availableBeforeRacks)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableBeforeRacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value='<?php echo e($rack->rack_code); ?>'>
                                <?php echo e($rack->rack_code); ?> (<?php echo e($rack->location); ?>) - Sisa: <?php echo e($rack->capacity - $rack->current_count); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\reception\partials\modals.blade.php ENDPATH**/ ?>