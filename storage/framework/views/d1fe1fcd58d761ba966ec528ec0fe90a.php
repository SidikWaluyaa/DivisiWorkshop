                                ...
                                <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-900/30 transition-colors group">
                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <div class="flex items-center justify-end gap-3 transition-opacity">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('admin') || $rev->created_by === auth()->id()): ?>
                                                <form action="<?php echo e(route('revision.destroy', $rev->id)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
