...
<head>
    ...
    <title>Status Sepatu - <?php echo e($input); ?></title>
...
<body class="p-4 md:p-8 antialiased text-gray-800" 
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-10 items-center">
            <div>
                <a href="<?php echo e(route('tracking.index')); ?>" class="group inline-flex items-center gap-2 mb-4 md:mb-6 text-gray-500 hover:text-teal-600 transition-colors">
                ...
                <div class="flex items-center gap-3">
                    <span class="px-2 md:px-3 py-1 rounded bg-white border border-gray-200 text-gray-600 font-mono text-xs md:text-sm tracking-wider shadow-sm break-all">
                        <?php echo e($isPhone ? 'Pencarian No HP' : 'Pencarian SPK'); ?>: <?php echo e($input); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPhone || $orders->count() > 1): ?>
            <div class="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-8 border-t-4 md:border-t-8 border-teal-500 min-h-[400px]">
                <h2 class="text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-400 mb-4 md:mb-6">
                    Ditemukan <?php echo e($orders->count()); ?> Sepatu Aktif
                </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border border-gray-100 group relative overflow-hidden flex flex-col h-full">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroPhoto): ?>
                                <div class="w-full h-40 mb-4 rounded-xl overflow-hidden relative border border-gray-200 group-hover:shadow-md transition-shadow cursor-zoom-in"
                                     @click="openLightbox('<?php echo e($heroPhoto->photo_url); ?>', '<?php echo e($order->shoe_brand); ?> - <?php echo e(str_replace('_', ' ', $heroPhoto->step)); ?>')">
                                     <img src="<?php echo e($heroPhoto->photo_url); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" alt="Foto Sepatu">
                                     <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-3 pt-8">
                                         <span class="text-white text-[10px] font-black uppercase tracking-wider shadow-sm"><?php echo e(str_replace('_', ' ', $heroPhoto->step)); ?></span>
                                     </div>
                                 </div>
                            ...
                            <div class="relative z-10 flex-1">
                                ...
                                <h3 class="text-lg font-black text-gray-800 mb-1 leading-tight"><?php echo e($order->shoe_brand); ?></h3>
                                <p class="text-sm text-gray-500 mb-4"><?php echo e($order->shoe_color); ?></p>

                                <div class="mt-4 pt-4 border-t border-gray-200 flex justify-between items-center">
                                    <div class="flex flex-col">
                                        <span class="text-[10px] uppercase font-bold text-gray-400">Status</span>
                                        <span class="text-sm font-bold text-teal-600"><?php echo e(str_replace('_', ' ', $order->status->value ?? $order->status)); ?></span>
                                    </div>
                                    
                                    
                                    
                                    <form action="<?php echo e(route('tracking.track')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="spk_number" value="<?php echo e($order->spk_number); ?>">
                    ...
                    <div class="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-8 border-t-4 md:border-t-8 border-teal-500 relative overflow-hidden">
                        ...
                        <div class="space-y-5 relative z-10">
                            <div>
                                ...
                                <p class="font-bold text-lg text-gray-800"><?php echo e($order->customer_name); ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-orange-50 rounded-lg border border-orange-100">
                                    ...
                                    <p class="font-bold text-orange-700"><?php echo e($order->estimation_date->format('d M Y')); ?></p>
                                </div>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <div class="space-y-2">
                                    <div class="aspect-square rounded-xl bg-gray-50 border-2 border-gray-100 overflow-hidden relative group cursor-zoom-in"
                                         <?php if($refPhoto): ?> @click="openLightbox('<?php echo e($refPhoto->photo_url); ?>', 'Foto Referensi')" <?php endif; ?>>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($refPhoto): ?>
                                            <img src="<?php echo e($refPhoto->photo_url); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Reference">
                                        <?php else: ?>
                                ...
                                <div class="space-y-2">
                                    <div class="aspect-square rounded-xl bg-gray-50 border-2 border-teal-200 overflow-hidden relative group ring-4 ring-teal-50 cursor-zoom-in"
                                         <?php if($beforePhoto): ?> @click="openLightbox('<?php echo e($beforePhoto->photo_url); ?>', 'Foto Sebelum')" <?php endif; ?>>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($beforePhoto): ?>
                                            <img src="<?php echo e($beforePhoto->photo_url); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Before">
                                        <?php else: ?>
                                            <div class="w-full h-full flex items-center justify-center text-gray-300">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                            </div>
                                ...
                                <div class="space-y-2">
                                    <div class="aspect-square rounded-xl bg-gray-50 border-2 border-gray-100 overflow-hidden relative group cursor-zoom-in"
                                         <?php if($afterPhoto): ?> @click="openLightbox('<?php echo e($afterPhoto->photo_url); ?>', 'Foto Sesudah')" <?php endif; ?>>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($afterPhoto): ?>
                                            <img src="<?php echo e($afterPhoto->photo_url); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="After">
                                        <?php else: ?>
                                            <div class="w-full h-full flex items-center justify-center text-gray-300">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-10 relative overflow-hidden min-h-[400px]">
                        ...
                        <div class="relative w-full pb-0 md:pb-8">
                            ...
                            ?>
                            <div class="hidden md:block absolute top-[20px] left-0 h-1 bg-teal-500 z-0 translate-y-1/2 transition-all duration-1000 ease-out" style="width: <?php echo e($progressPercent); ?>%;"></div>
                            ...
                            <div class="flex flex-col md:flex-row items-start justify-between w-full relative space-y-8 md:space-y-0 px-0 md:px-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    ...
                                    <div class="relative z-10 flex flex-row md:flex-col items-center group cursor-default w-full md:w-auto gap-4 md:gap-0">
                                        ...
                                        <!-- Number Bubble -->
                                        <div class="w-12 h-12 flex-shrink-0 rounded-full border-4 <?php echo e($circleColorClass); ?> flex items-center justify-center font-bold text-base transition-all duration-300 relative bg-white">
                                            <?php echo e($loop->iteration); ?>

                                            
                                            <!-- Valid Checkmark for past items -->
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCompleted && !$isCurrent): ?>
                                        ...
                                        <div class="hidden md:block h-8 border-l-2 border-dashed <?php echo e($isCompleted ? 'border-teal-300' : 'border-gray-300'); ?> my-1"></div>

                                        <!-- Content Wrapper (Mobile Row / Desktop Col) -->
                                        <div class="flex flex-row md:flex-col items-center flex-1 gap-4 md:gap-0">
                                            
                                            <!-- Icon -->
                                            <div class="<?php echo e($iconColorClass); ?> transition-all duration-300 transform group-hover:scale-110 flex-shrink-0">
                                            ...
                                            <div class="md:mt-2 text-left md:text-center w-full">
                                                <p class="text-sm md:text-sm font-bold <?php echo e($isCompleted ? 'text-gray-800' : 'text-gray-400'); ?>"><?php echo e($status['label']); ?></p>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($timestamp): ?>
                                                    <p class="text-[10px] text-gray-500 mt-0.5 md:mt-1 font-mono bg-gray-50 px-1 rounded inline-block">
                                                        <?php echo e(\Carbon\Carbon::parse($timestamp)->format('d/m H:i')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentIndex !== false && isset($statusKeys[$currentIndex])): ?>
                             <div class="mt-8 bg-teal-50 rounded-xl p-6 border border-teal-100 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 class="font-bold text-teal-800 text-lg">Status Saat Ini: <?php echo e($statuses[$statusKeys[$currentIndex]]['label']); ?></h3>
                                    <p class="text-teal-700/80 text-sm mt-1">
                                        Order Anda sedang dalam proses <?php echo e(strtolower($statuses[$statusKeys[$currentIndex]]['label'])); ?>. 
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentIndex < count($statuses)-1): ?>
                                            Langkah berikutnya: <strong><?php echo e($statuses[$statusKeys[$currentIndex+1]]['label']); ?></strong>.
                                        <?php else: ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\tracking\result.blade.php ENDPATH**/ ?>