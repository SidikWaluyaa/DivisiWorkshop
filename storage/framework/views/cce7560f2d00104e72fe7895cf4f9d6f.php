            ...
            <div class="max-w-7xl mx-auto px-6 py-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="<?php echo e(route('finance.payments.print', request()->all())); ?>" target="_blank" class="group relative inline-flex items-center justify-center w-14 h-14 bg-white border-2 border-gray-100 text-gray-400 rounded-full hover:border-[#1B8A68] hover:text-[#1B8A68] transition-all duration-500 shadow-lg hover:shadow-[#1B8A68]/10" title="Cetak Laporan">
