    ...
    <div class="min-h-screen bg-[#F8FAFC] pb-32">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-5">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3 sm:gap-6">
                        <a href="<?php echo e(route('finance.invoices.index')); ?>" class="group flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 hover:border-[#1B8A68]/30 hover:shadow-emerald-100 transition-all active:scale-95">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 mt-6 sm:mt-10">
            ...
            <div class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-2xl p-5 sm:p-10 border border-gray-100 relative overflow-hidden group">
                ...
                <form action="<?php echo e(route('finance.invoices.create')); ?>" method="GET" class="relative z-10">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($groupedOrders) && count($groupedOrders) > 0): ?>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-2 sm:gap-4">
                                <div class="px-3 sm:px-4 py-1 sm:py-1.5 bg-emerald-50 border border-emerald-100 rounded-full">
                                    <span class="text-[10px] sm:text-[11px] font-black text-[#1B8A68] uppercase tracking-widest italic tracking-tight"><?php echo e($customer->customer_name); ?></span>
                                </div>
                                <span class="text-gray-400 text-[10px] sm:text-[11px] font-black uppercase tracking-widest opacity-60 italic"><?php echo e($customer->customer_phone); ?></span>
                            </div>
                        </div>
                    ...
                    <form action="<?php echo e(route('finance.invoices.store')); ?>" method="POST" id="invoiceForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="customer_name" value="<?php echo e($customer->customer_name); ?>">
                        <input type="hidden" name="customer_phone" value="<?php echo e($customer->customer_phone); ?>">

                        <div class="space-y-5 sm:space-y-8">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKey => $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <?php
                                ...
                                <div class="bg-white rounded-2xl sm:rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden group/card transition-all duration-500 hover:shadow-[#1B8A68]/5">
                                    ...
                                    <div class="bg-gray-50/50 px-5 sm:px-10 py-4 sm:py-6 border-b border-gray-100 flex flex-col sm:flex-row gap-3 sm:gap-0 sm:justify-between sm:items-center relative overflow-hidden">
                                        ...
                                        <div class="flex items-center gap-3 sm:gap-6">
                                            ...
                                            <div class="min-w-0">
                                                <h3 class="font-black text-gray-900 text-sm sm:text-lg italic tracking-tight uppercase leading-none mb-1 sm:mb-1.5 truncate">Kedatangan: <?php echo e($spkNumber); ?></h3>
                                                <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest italic">Tanggal Masuk: <?php echo e($dropOffDate); ?></p>
                                            </div>
                                        </div>
                                        <label class="flex items-center gap-2 sm:gap-3 cursor-pointer group/toggle pl-14 sm:pl-0">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 sm:h-6 sm:w-6 text-[#1B8A68] rounded-lg border-2 border-gray-200 focus:ring-[#1B8A68]/20 group-checkbox transition-all" data-target=".group-<?php echo e(Str::slug($spkNumber)); ?>">
                                            ...
                                            <div class="group/item relative transition-all duration-300 hover:bg-[#F8FAFC]">
                                                <label class="flex items-start sm:items-center p-5 sm:p-10 cursor-pointer w-full">
                                                    <div class="flex-shrink-0 mr-4 sm:mr-8 relative pt-1 sm:pt-0">
                                                        <input type="checkbox" name="work_order_ids[]" value="<?php echo e($order->id); ?>" 
                                                               class="form-checkbox h-6 w-6 sm:h-8 sm:w-8 text-[#1B8A68] rounded-lg sm:rounded-xl border-2 border-gray-200 focus:ring-[#1B8A68]/20 order-checkbox group-<?php echo e(Str::slug($spkNumber)); ?> transition-all"
                                                               data-price="<?php echo e($order->total_transaksi); ?>">
                                                    </div>
                                                    ...
                                                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-8 items-start sm:items-center">
                                                        ...
                                                        <div class="flex items-center gap-3 sm:gap-6">
                                                            <div class="flex flex-col min-w-0">
                                                                <div class="flex items-center gap-2 sm:gap-3 mb-0.5 sm:mb-1">
                                                                    ...
                                                                    <p class="font-black text-gray-900 italic tracking-tight truncate text-sm sm:text-base"><?php echo e($order->spk_number); ?></p>
                                                                </div>
                                                                <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest italic leading-none opacity-60"><?php echo e($order->category); ?></p>
                                                            </div>
                                                            ...
                                                            <div class="flex flex-col items-center flex-shrink-0">
                                                                ...
                                                                <a href="<?php echo e(route('reception.print-tag', $order->id)); ?>" target="_blank" class="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white flex items-center justify-center text-[#1B8A68] shadow-lg border border-emerald-100 hover:border-[#1B8A68]/30 hover:bg-emerald-50 transition-all active:scale-95 group/btn" onclick="event.stopPropagation();">
                                                        ...
                                                        <div class="sm:col-span-2">
                                                            <div class="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-1.5">
                                                                ...
                                                                <p class="font-black text-gray-900 italic tracking-tight text-sm sm:text-lg leading-none uppercase truncate"><?php echo e($order->shoe_brand); ?> <?php echo e($order->shoe_type); ?></p>
                                                            </div>
                                                            <p class="text-[9px] sm:text-[10px] text-gray-400 font-black uppercase tracking-widest italic opacity-80 pl-4 truncate">
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                                    <?php echo e($svc->custom_service_name ?? ($svc->service ? $svc->service->name : 'Layanan')); ?>

                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$loop->last): ?> <span class="mx-1 sm:mx-1.5">•</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        ...
                                                        <div class="text-left sm:text-right flex sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2">
                                                            <p class="text-lg sm:text-2xl font-black text-gray-900 tracking-tighter italic tabular-nums leading-none">Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?></p>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === \App\Enums\WorkOrderStatus::SELESAI): ?>
                                                            ...
                                                            <?php else: ?>
                                                                <span class="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 bg-amber-50 text-[#FFC232] text-[8px] sm:text-[9px] font-black rounded-lg sm:rounded-xl border border-amber-100 uppercase tracking-[0.1em] sm:tracking-[0.2em] italic shadow-sm"><?php echo e($order->status); ?></span>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\finance\create-invoice.blade.php ENDPATH**/ ?>