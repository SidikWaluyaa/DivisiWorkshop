    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="group bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden transform hover:-translate-y-2 transition-all duration-500">
            ...
            <div class="bg-gradient-to-br from-red-500 to-pink-600 p-6 flex justify-between items-center text-white">
                ...
                <div class="bg-white/20 px-3 py-1 rounded-full text-xs font-black backdrop-blur-md">
                    <?php echo e($groups['Persiapan']['total'] ?? 0); ?> SPK
                </div>
            </div>
            ...
            <div class="p-8 space-y-4">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $persiapanItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="flex justify-between items-center group/item hover:bg-slate-50 p-2 rounded-xl transition-colors">
                        <span class="text-slate-600 font-bold tracking-tight"><?php echo e($label); ?></span>
        ...
        <div class="group bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden transform hover:-translate-y-2 transition-all duration-500">
            ...
            <div class="bg-gradient-to-br from-orange-400 to-yellow-500 p-6 flex justify-between items-center text-white">
                ...
                <div class="bg-white/20 px-3 py-1 rounded-full text-xs font-black backdrop-blur-md">
                    <?php echo e($groups['Reparasi']['total'] ?? 0); ?> SPK
                </div>
            </div>
            ...
            <div class="p-8 space-y-4">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $reparasiItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="flex justify-between items-center group/item hover:bg-slate-50 p-2 rounded-xl transition-colors">
                        <span class="text-slate-600 font-bold tracking-tight"><?php echo e($label); ?></span>
        ...
        <div class="group bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden transform hover:-translate-y-2 transition-all duration-500">
            ...
            <div class="bg-gradient-to-br from-teal-500 to-emerald-600 p-6 flex justify-between items-center text-white">
                ...
                <div class="bg-white/20 px-3 py-1 rounded-full text-xs font-black backdrop-blur-md">
                    <?php echo e($groups['Post']['total'] ?? 0); ?> SPK
                </div>
            </div>
            ...
            <div class="p-8 space-y-4">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $postItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="flex justify-between items-center group/item hover:bg-slate-50 p-2 rounded-xl transition-colors">
                        <span class="text-slate-600 font-bold tracking-tight"><?php echo e($label); ?></span>
        ...
        <div class="bg-gradient-to-r from-teal-600 via-teal-700 to-slate-900 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center shadow-2xl relative overflow-hidden group/total">
            ...
            <div class="mt-6 md:mt-0 relative z-10">
                <div class="bg-white px-8 py-4 rounded-[2rem] shadow-2xl text-center border-b-4 border-orange-500 flex flex-col items-center justify-center transform group-hover/total:scale-110 transition-transform duration-500">
                    <span class="text-4xl font-black text-slate-900 leading-none"><?php echo e($totalSpk); ?></span>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\workshop\dashboard\partials\spk-matrix.blade.php ENDPATH**/ ?>