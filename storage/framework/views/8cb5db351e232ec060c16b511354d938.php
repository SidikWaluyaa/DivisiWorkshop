...
<head>
    ...
    <title>Shipping Label - <?php echo e($assignment->workOrder->spk_number); ?></title>
...
<body>
    ...
    <div class="logo-decoration">
        <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('images/logo.png')))); ?>" alt="Shoe Workshop">
    </div>
        ...
        <div class="address-container">
            <div class="address-box">
                ...
                <div class="address-content">
                    <div class="customer-name"><?php echo e($assignment->workOrder->customer->name); ?></div>
                    <div class="customer-details">
                        <?php echo e($assignment->workOrder->customer->address ?? 'Alamat belum tersedia'); ?>

                    </div>
                    <div class="customer-phone">
                        📞 <?php echo e($assignment->workOrder->customer->phone); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\storage\shipping-label.blade.php ENDPATH**/ ?>