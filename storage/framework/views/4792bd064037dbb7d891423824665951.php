...
<head>
    ...
    <title>Invoice Premium #<?php echo e($order->spk_number); ?></title>
            ...
            <div class="floating-card w-full sm:w-[480px] bg-white p-6 sm:p-8 z-20 border border-gray-100 flex flex-col mt-6 sm:mt-0 sm:absolute sm:top-6 sm:right-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 w-full">
                    <div>
                        ...
                        <div class="info-box">
                            <span class="text-xs font-black text-gray-900 italic truncate"><?php echo e($order->customer_name); ?></span>
                        </div>
                    </div>
                    <div>
                        <p class="label-text text-gray-400">Shipment Method</p>
                        <div class="info-box">
                            <span class="text-xs font-black text-gray-900 uppercase italic"><?php echo e($order->shipping_type ?? 'OFFLINE'); ?></span>
                        </div>
                    </div>
                    <div>
                        <p class="label-text text-gray-400">Invoice Number</p>
                        <div class="info-box overflow-hidden">
                            <span class="text-[10px] sm:text-xs font-black text-gray-900 tracking-tight uppercase"><?php echo e($order->spk_number); ?></span>
                        </div>
                    </div>
                    <div>
        ...
        <div class="content-body flex-1 px-4 sm:px-10 pt-6 sm:pt-28 pb-6 bg-[#F8FAFC] flex flex-col">
            ...
            <div class="bg-white rounded-3xl sm:rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden flex flex-col min-h-[300px]">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="item-row grid grid-cols-1 sm:grid-cols-12 p-5 sm:py-5 sm:px-8 hover:bg-gray-50/50 transition-colors gap-3 sm:gap-0">
                        ...
                        <div class="hidden sm:flex col-span-1 items-center">
                            <span class="text-xs font-black text-gray-400 italic"><?php echo e($index + 1); ?></span>
                        </div>
                        ...
                        <div class="col-span-1 sm:col-span-3 flex flex-col">
                            ...
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-0.5 italic"><?php echo e($order->shoe_type); ?></p>
                            <p class="text-xs font-black text-gray-900 uppercase italic tracking-tight"><?php echo e($order->shoe_brand); ?></p>
                        </div>
                        ...
                        <div class="col-span-1 sm:col-span-5 flex flex-col">
                            ...
                            <p class="text-xs font-black text-gray-700 uppercase italic tracking-tight leading-tight">
                                <?php echo e($detail->custom_service_name ?? ($detail->service ? $detail->service->name : 'General Service')); ?>
                ...
                <div class="flex-1 flex flex-col gap-6 sm:gap-8">
                    <div class="totals-grid grid grid-cols-2 gap-y-5 gap-x-8 px-2 sm:px-0">
                        <div class="text-right">
                            ...
                            <p class="text-sm md:text-base font-black text-gray-900 italic tabular-nums leading-none tracking-tighter">Rp. <?php echo e(number_format($order->total_transaksi + $order->discount - $order->shipping_cost, 0, ',', '.')); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1 italic">Shipping</p>
                            <p class="text-sm md:text-base font-black text-gray-900 italic tabular-nums leading-none tracking-tighter">Rp. <?php echo e(number_format($order->shipping_cost, 0, ',', '.')); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1 italic">DP / Paid</p>
                            <p class="text-sm md:text-base font-black text-[#22AF85] italic tabular-nums leading-none tracking-tighter">Rp. <?php echo e(number_format($order->payments->sum('amount_total'), 0, ',', '.')); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1 italic">Discount</p>
                            <p class="text-sm md:text-base font-black text-red-500 italic tabular-nums leading-none tracking-tighter">- Rp. <?php echo e(number_format($order->discount, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-end gap-4 md:gap-8">
                        ...
                        <div class="bg-[#22AF85] px-8 md:px-12 py-4 rounded-2xl md:rounded-[1.5rem] shadow-2xl w-full sm:w-auto text-center min-w-[240px]">
                            <p class="text-white font-black italic text-xl md:text-2xl tabular-nums tracking-tighter leading-none">Rp. <?php echo e(number_format($order->sisa_tagihan, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\finance\print-invoice.blade.php ENDPATH**/ ?>