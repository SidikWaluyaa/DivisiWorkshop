<div>
            ...
            <div>
                ...
                <div class="relative">
                    <select wire:model.live="response" class="w-full appearance-none bg-gray-50/50 backdrop-blur-sm border border-gray-100 rounded-2xl px-4 py-3.5 text-sm focus:bg-white focus:ring-4 focus:ring-[#22AF85]/10 focus:border-[#22AF85]/40 transition-all font-bold text-gray-800 cursor-pointer">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Puas', 'Komplain', 'Kurang Puas', 'No Respon 1x24 Jam', 'Hold']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <option value="<?php echo e($res); ?>"><?php echo e($res); ?></option>
                    ...
                    <tr class="hover:bg-gray-50/80 active:bg-gray-100 transition-colors duration-200 group relative">
                        ...
                        <td class="px-8 py-5 align-top relative">
                            ...
                            <div class="flex flex-col gap-1">
                                <span class="text-xs font-black text-gray-800"><?php echo e($item->entered_at->format('d M Y')); ?></span>
                                <span class="text-[10px] text-gray-400 font-black uppercase tracking-wider"><?php echo e($item->entered_at->format('H:i')); ?> WIB</span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5 align-top">
                            <div class="flex flex-col gap-1.5">
                                <div class="flex items-center gap-2">
                                    <span class="text-xs font-black text-[#22AF85] bg-[#22AF85]/10 px-2 py-0.5 rounded-lg border border-[#22AF85]/20 uppercase tracking-tight"><?php echo e($item->workOrder->spk_number); ?></span>
                                </div>
                                <span class="text-sm font-black text-gray-900"><?php echo e($item->workOrder->customer_name); ?></span>
                                <div class="text-xs font-bold text-gray-500 flex items-center gap-1.5 select-all">
                                    ...
                                    <?php echo e($item->workOrder->customer_phone); ?>

                                </div>
                                <span class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1"><?php echo e($item->workOrder->shoe_brand); ?> - <?php echo e($item->workOrder->shoe_color); ?></span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5 align-top">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 rounded-xl bg-[#22AF85] flex items-center justify-center shadow-lg shadow-[#22AF85]/20 text-white font-black text-xs">
                                    <?php echo e(substr($item->pic->name, 0, 1)); ?>

                                </div>
                                <div class="flex flex-col gap-0.5">
                                    <span class="text-xs font-black text-gray-800 leading-tight uppercase"><?php echo e($item->pic->name); ?></span>
                                    <span class="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5"><?php echo e($item->contacted_at?->format('d/m/Y H:i')); ?></span>
                                </div>
                            </div>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-5 align-top">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($style): ?>
                                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl <?php echo e($style['bg']); ?> <?php echo e($style['border']); ?> border">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($style['dot']); ?>"></span>
                                    <span class="text-[10px] font-black uppercase tracking-widest <?php echo e($style['text']); ?>">
    ...
    <div x-data="{ open: false }" 
         ...
         x-cloak>
        <?php if (isset($component)) { $__componentOriginal8e334ff4114f93e516faa9927e0e7d99 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8e334ff4114f93e516faa9927e0e7d99 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal-custom','data' => ['xShow' => 'open','@close' => 'open = false','title' => '📝 Konfirmasi Status']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal-custom'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'open','@close' => 'open = false','title' => '📝 Konfirmasi Status']); ?>
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white rounded-[1.5rem] p-5 border border-gray-200/60 shadow-sm relative overflow-hidden">
                    ...
                    <div class="text-lg font-black text-gray-800 tracking-tight">
                        <?php echo e($editingId ? App\Models\CxAfterConfirmation::find($editingId)?->workOrder->customer_name : ''); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal8e334ff4114f93e516faa9927e0e7d99)): ?>
<?php $attributes = $__attributesOriginal8e334ff4114f93e516faa9927e0e7d99; ?>
<?php unset($__attributesOriginal8e334ff4114f93e516faa9927e0e7d99); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal8e334ff4114f93e516faa9927e0e7d99)): ?>
<?php $component = $__componentOriginal8e334ff4114f93e516faa9927e0e7d99; ?>
<?php unset($__componentOriginal8e334ff4114f93e516faa9927e0e7d99); ?>
<?php endif; ?>
    </div>

        <?php
        $__scriptKey = '2908820279-2';
        ob_start();
    ?>
    <script>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\cx\after-confirmation-list.blade.php ENDPATH**/ ?>