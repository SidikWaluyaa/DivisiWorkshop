        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
                <div class="p-8 border-b border-gray-50 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <form action="<?php echo e(route('cs.leads.closing')); ?>" method="GET" class="flex-1 max-w-md relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Nama/HP..." class="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-[#22AF85] font-bold transition-all">
                            ...
                            <tr class="hover:bg-gray-50/50 transition group">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="font-black text-gray-900"><?php echo e($lead->customer_name ?? 'Guest'); ?></div>
                                            <div class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter"><?php echo e($lead->customer_phone); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->spk): ?>
                                        <div class="text-sm font-bold text-gray-700"><?php echo e($lead->spk->spk_number); ?></div>
                                        <div class="text-[9px] text-gray-400 mt-1 uppercase font-black">Total: Rp <?php echo e(number_format($lead->spk->total_price, 0, ',', '.')); ?></div>
                                    <?php else: ?>
                                ...
                                <td class="px-8 py-6 text-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->spk): ?>
                                        <span class="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest leading-none <?php echo e($lead->spk->dp_status_badge_class); ?>">
                                            <?php echo e($lead->spk->dp_status); ?>
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2 text-right">
                                        <a href="<?php echo e(route('cs.leads.show', $lead->id)); ?>" class="p-2 bg-gray-50 text-gray-400 hover:bg-green-50 hover:text-green-600 rounded-xl transition shadow-sm">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                        </a>
                                        <form action="<?php echo e(route('cs.leads.destroy', $lead->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\closing.blade.php ENDPATH**/ ?>