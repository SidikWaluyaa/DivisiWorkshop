...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Laporan & Analitik')); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                <form method="GET" action="<?php echo e(route('admin.reports.index')); ?>" class="flex flex-col sm:flex-row gap-4 items-end">
                    <div class="w-full sm:w-auto">
                        <label for="start_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Dari Tanggal</label>
                        <input type="date" name="start_date" id="start_date" value="<?php echo e($startDate); ?>" class="w-full rounded-lg border-gray-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                    <div class="w-full sm:w-auto">
                        <label for="end_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sampai Tanggal</label>
                        <input type="date" name="end_date" id="end_date" value="<?php echo e($endDate); ?>" class="w-full rounded-lg border-gray-300 dark:bg-gray-700 dark:text-white dark:border-gray-600 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                     ...
                     <div class="p-6 bg-gradient-to-br from-green-500 to-emerald-600 text-white">
                        ...
                        <div class="space-y-1">
                            <div class="flex justify-between text-sm opacity-90">
                                ...
                                <span class="font-mono">Rp <?php echo e(number_format($revenue, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between text-sm opacity-90">
                                <span>Pengeluaran (Belanja)</span>
                                <span class="font-mono text-red-100">- Rp <?php echo e(number_format($expenses, 0, ',', '.')); ?></span>
                            </div>
                            <div class="mt-4 pt-3 border-t border-white/20 flex justify-between font-bold text-2xl">
                                <span>Profit Bersih</span>
                                <span>Rp <?php echo e(number_format($profit, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                     </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700">
                     <div class="p-6 bg-gradient-to-br from-blue-500 to-indigo-600 text-white">
                        ...
                        <div class="space-y-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $topTechnicians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="flex justify-between items-center text-sm">
                                <span class="font-medium flex items-center gap-2">
                                    <span class="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold"><?php echo e($loop->iteration); ?></span>
                                    <?php echo e($tech->name); ?>

                                </span>
                                <span class="font-mono bg-white/20 px-2 py-0.5 rounded text-xs"><?php echo e($tech->logs_count); ?> Tasks</span>
                            </div>
                     ...
                     <div class="p-6 bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <a href="<?php echo e(route('admin.reports.productivity.export', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" target="_blank" class="block w-full text-center py-3 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 text-gray-700 dark:text-gray-200 font-bold rounded-lg hover:bg-gray-50 dark:hover:bg-gray-500 hover:text-blue-600 transition-colors shadow-sm">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\reports\index.blade.php ENDPATH**/ ?>