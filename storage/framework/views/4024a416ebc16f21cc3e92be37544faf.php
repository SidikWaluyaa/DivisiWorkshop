...
<div id="sidebar-nav-container" class="flex-1 px-2 overflow-y-auto sidebar-scroll pb-4 min-h-0" style="max-height: calc(100vh - 180px);">
    ...
    <div x-data="{ 
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->hasAccess('cs')): ?>
        <a href="<?php echo e(route('cs.after-photos')); ?>" 
           class="nav-item <?php echo e(request()->routeIs('cs.after-photos') ? 'active' : ''); ?> flex items-center px-3 py-3 rounded-lg group relative"
           :class="sidebarCollapsed ? 'justify-center' : ''">
            <svg class="nav-icon flex-shrink-0" :class="sidebarCollapsed ? 'w-6 h-6' : 'w-5 h-5'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-data="{ 
        ...
        <a href="<?php echo e(route('storage.pickup-history')); ?>" 
           class="nav-item <?php echo e(request()->routeIs('storage.pickup-history') ? 'active' : ''); ?> flex items-center px-3 py-3 rounded-lg group relative"
           :class="sidebarCollapsed ? 'justify-center' : ''">
            <svg class="nav-icon flex-shrink-0 text-emerald-400" :class="sidebarCollapsed ? 'w-6 h-6' : 'w-5 h-5'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
            </svg>
    ...
    <div x-data="{ 
        ...
        <a href="<?php echo e(route('admin.custom-label.index')); ?>" 
           class="nav-item <?php echo e(request()->routeIs('admin.custom-label.index') ? 'active' : ''); ?> flex items-center px-3 py-3 rounded-lg group relative border border-teal-500/10 bg-teal-500/5 hover:bg-teal-500/20"
           :class="sidebarCollapsed ? 'justify-center' : ''">
            <svg class="nav-icon flex-shrink-0 text-teal-400" :class="sidebarCollapsed ? 'w-6 h-6' : 'w-5 h-5'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-data="{ 
        ...
        <a href="<?php echo e(route('finance.cs-verification')); ?>" 
           class="nav-item <?php echo e(request()->routeIs('finance.cs-verification') ? 'active' : ''); ?> flex items-center px-3 py-3 rounded-lg group relative border border-orange-500/20 bg-orange-500/5 hover:bg-orange-500/10"
           :class="sidebarCollapsed ? 'justify-center' : ''">
            ...
            <?php $pendingCsCount = \App\Models\OrderPayment::where('is_verified', false)->where('notes', 'LIKE', '%dari CS%')->count(); ?>
            <span x-show="!sidebarCollapsed && <?php echo e($pendingCsCount); ?> > 0" class="ml-auto bg-orange-500 text-white py-0.5 px-2 rounded-full text-[10px] font-black animate-pulse"><?php echo e($pendingCsCount); ?></span>
    ...
    <div x-data="{ 
        ...
        <a href="<?php echo e(route('cx.shipping-monitoring')); ?>" 
           class="nav-item <?php echo e(request()->routeIs('cx.shipping-monitoring') ? 'active' : ''); ?> flex items-center px-3 py-3 rounded-lg group relative"
           :class="sidebarCollapsed ? 'justify-center' : ''">
