<div class="supply-chain-ledger min-h-screen bg-[#F9FAFB] pb-12">
    ...
    <div class="bg-white text-gray-900 px-8 py-5 flex items-center justify-between sticky top-0 z-50 border-b border-gray-100 shadow-sm">
            ...
            <div class="hidden md:flex items-center gap-2">
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-3 text-[10px] font-black uppercase tracking-widest">
                        <li><a href="<?php echo e(route('dashboard')); ?>" class="text-gray-400 hover:text-[#22AF85] transition-colors">Utama</a></li>
                        ...
                        <li><a href="<?php echo e(route('admin.supply-chain.index')); ?>" wire:navigate class="text-gray-400 hover:text-[#22AF85] transition-colors">Supply Chain</a></li>
                        <li><svg class="h-3 w-3 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"/></svg></li>
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('admin.supply-chain.index')); ?>" wire:navigate
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-baseline gap-2 mt-2">
                        ...
                        <h3 class="text-3xl font-black text-gray-900 font-inter leading-none">
                            <?php echo e(number_format($stats['total_in_value'], 0, ',', '.')); ?>
            ...
            <div class="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm group hover:border-[#FFC232]/30 transition-all relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-baseline gap-2 mt-2">
                        <span class="text-[10px] font-black text-gray-400 uppercase">Rp</span>
                        <h3 class="text-3xl font-black text-gray-900 font-inter leading-none">
                            <?php echo e(number_format($stats['total_out_value'], 0, ',', '.')); ?>
            ...
            <div class="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm group hover:border-gray-900/30 transition-all relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-baseline gap-2 mt-2">
                        <span class="text-[10px] font-black text-gray-400 uppercase">Rp</span>
                        <h3 class="text-3xl font-black <?php echo e($stats['net_value'] >= 0 ? 'text-[#22AF85]' : 'text-rose-500'); ?> font-inter leading-none">
                            <?php echo e(number_format(abs($stats['net_value']), 0, ',', '.')); ?>

                        </h3>
                    </div>
                    <div class="mt-4 flex items-center gap-2 text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                        <div class="w-2 h-2 rounded-full <?php echo e($stats['net_value'] >= 0 ? 'bg-[#22AF85]' : 'bg-rose-500'); ?>"></div>
                        Status Kas GUDANG
                    </div>
                </div>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50/50 transition-colors group" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'tx-row-'.e($tx->id).''; ?>wire:key="tx-row-<?php echo e($tx->id); ?>">
                                <td class="px-8 py-8">
                                    <div class="text-sm font-black text-gray-900"><?php echo e($tx->created_at->format('d M Y')); ?></div>
                                    <div class="text-[10px] text-gray-300 font-bold uppercase tracking-wider mt-1"><?php echo e($tx->created_at->format('H:i')); ?> WIB</div>
                                </td>
                                <td class="px-8 py-8">
                                    <div class="text-base font-black <?php if($tx->material?->trashed()): ?> text-gray-400 <?php else: ?> text-[#22AF85] <?php endif; ?> line-clamp-1">
                                        <?php echo e($tx->material->name ?? 'Material Terhapus'); ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tx->material?->trashed()): ?>
                                    ...
                                    <div class="text-[10px] text-gray-400 uppercase font-black tracking-[0.1em] mt-2"><?php echo e($tx->material->category ?? 'Unknown'); ?></div>
                                </td>
                                <td class="px-8 py-8 text-center uppercase tracking-widest text-[10px] font-black">
                                    <span class="inline-flex items-center px-4 py-1.5 rounded-xl <?php echo e($tx->type == 'IN' ? 'bg-[#22AF85] text-white shadow-lg shadow-[#22AF85]/20' : 'bg-gray-900 text-[#FFC232]'); ?>">
                                        <?php echo e($tx->type); ?>

                                    </span>
                                </td>
                                <td class="px-8 py-8">
                                    <div class="text-lg font-black font-inter <?php echo e($tx->type == 'IN' ? 'text-[#22AF85]' : 'text-gray-900'); ?>">
                                        <?php echo e($tx->type == 'IN' ? '+' : '-'); ?> <?php echo e(number_format($tx->quantity, 0)); ?>

                                        <span class="text-[10px] text-gray-300 font-black ml-1 uppercase"><?php echo e($tx->material->unit ?? 'Unit'); ?></span>
                                    </div>
                                </td>
                                <td class="px-8 py-8 text-right">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tx->unit_price): ?>
                                        <div class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">@ Rp <?php echo e(number_format($tx->unit_price, 0, ',', '.')); ?></div>
                                        <div class="text-sm font-black text-gray-900 mt-1">Rp <?php echo e(number_format($tx->total_value, 0, ',', '.')); ?></div>
                                    <?php else: ?>
                                ...
                                <td class="px-8 py-8 text-center">
                                    <div class="inline-flex items-center px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-xs font-black text-gray-700 shadow-sm">
                                        <?php echo e($tx->balance_after ?? 'N/A'); ?>
                                ...
                                <td class="px-8 py-8">
                                    <div class="flex items-center gap-4">
                                        <div class="w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center text-[11px] font-black text-[#22AF85] border border-gray-100">
                                            <?php echo e(substr($tx->user->name ?? 'S', 0, 1)); ?>

                                        </div>
                                        <span class="text-xs font-black text-gray-700"><?php echo e($tx->user->name ?? 'System'); ?></span>
                                    </div>
                                </td>
                                <td class="px-8 py-8 text-right">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tx->reference_type === 'WorkOrder'): ?>
                                        <div class="inline-flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-2xl border border-gray-100 text-gray-900 shadow-sm">
                                            ...
                                            <span class="text-xs font-black tracking-widest"><?php echo e($tx->reference_label); ?></span>
                                        </div>
                                    <?php elseif($tx->reference_type === 'MaterialRequest'): ?>
                                        <div class="inline-flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-2xl border border-gray-100 text-gray-900 shadow-sm">
                                            <div class="w-2 h-2 rounded-full bg-[#22AF85]"></div>
                                            <span class="text-xs font-black tracking-widest"><?php echo e($tx->reference_label); ?></span>
                                        </div>
                                    <?php elseif($tx->reference_label): ?>
                                        <div class="inline-flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-2xl border border-gray-100 text-gray-900 shadow-sm">
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\admin\supply-chain\ledger.blade.php ENDPATH**/ ?>