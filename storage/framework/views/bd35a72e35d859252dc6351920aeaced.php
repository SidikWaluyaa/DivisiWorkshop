                ...
                <div class="p-8 bg-gray-50 rounded-[2rem] border-2 border-gray-100">
                    ...
                    <div id="service_edit_checklist" class="max-h-[300px] overflow-y-auto mb-6 pr-2 space-y-3 custom-scrollbar">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentCategory !== $service->category): ?>
                                ...
                                <?php $currentCategory = $service->category; ?>
                            ...
                            <div class="bg-white rounded-2xl border-2 border-white hover:border-[#22AF85]/20 p-4 transition duration-300 group shadow-sm">
                                <label class="flex items-center justify-between cursor-pointer">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="text-xs font-bold text-gray-700 group-hover:text-gray-900 transition"><?php echo e($service->name); ?></span>
                                    </div>
                                    <span class="text-xs font-black text-[#22AF85]">Rp <?php echo e(number_format($service->price, 0, ',', '.')); ?></span>
                                </label>
                                <div id="detail_container_<?php echo e($service->id); ?>" class="hidden mt-4 pt-4 border-t border-dashed border-gray-100">
                                    <input type="text" name="service_details[<?php echo e($service->id); ?>]" id="service_detail_<?php echo e($service->id); ?>"
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\modals\edit-item.blade.php ENDPATH**/ ?>