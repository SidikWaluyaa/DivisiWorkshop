...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
         <div class="flex flex-col md:flex-row justify-between items-center gap-4">
             ...
             <div class="flex items-center gap-3">
                ...
                <form method="GET" action="<?php echo e(route('production.index')); ?>" class="relative">
                 ...
                 <div class="px-3 py-1 bg-white/10 text-white rounded-full text-xs font-bold border border-white/20">
                    <?php echo e($orders->total()); ?> Order Aktif
                </div>
             </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-6 bg-gray-50 min-h-screen" 
         x-data="{ activeTab: '<?php echo e($activeTab ?? 'sol'); ?>', selectedItems: [] }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'sol', 'page' => null])); ?>"
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-white"><?php echo e($countSol); ?></span>
                ...
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'upper', 'page' => null])); ?>"
                     class="group relative overflow-hidden rounded-2xl p-6 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-white"><?php echo e($countUpper); ?></span>
                            <span class="text-white/70 text-sm font-medium">antrian</span>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'treatment', 'page' => null])); ?>"
                     class="group relative overflow-hidden rounded-2xl p-6 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                     :class="{ 'ring-4 ring-teal-400 ring-opacity-50': '<?php echo e($activeTab); ?>' === 'treatment' }">
                    ...
                    <div class="relative z-10">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if('<?php echo e($activeTab); ?>' === 'treatment'): ?>
                                <span class="px-3 py-1 bg-white/30 backdrop-blur-md rounded-full text-white text-xs font-bold">Active</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-white"><?php echo e($countTreatment); ?></span>
                            <span class="text-white/70 text-sm font-medium">antrian</span>
                        </div>
                    </div>
                </a>
                ...
                <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'all', 'page' => null])); ?>"
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-white"><?php echo e($countAll); ?></span>
...
<?php endif; ?>
            ...
            <div x-show="activeTab === 'sol'" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" style="display: none;">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['sol']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$order->prod_sol_completed_at): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.station-card','data' => ['order' => $order,'type' => 'item_prod_sol','technicians' => $techs['sol'],'techByRelation' => 'prodSolBy','startedAtColumn' => 'prod_sol_started_at','byColumn' => 'prod_sol_by','color' => 'orange','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => ($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['order' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order),'type' => 'item_prod_sol','technicians' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($techs['sol']),'techByRelation' => 'prodSolBy','startedAtColumn' => 'prod_sol_started_at','byColumn' => 'prod_sol_by','color' => 'orange','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div x-show="activeTab === 'upper'" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" style="display: none;">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['upper']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$order->prod_upper_completed_at): ?>
                             <div class="flex items-start gap-4 p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex-1">
                                    <?php if (isset($component)) { $__componentOriginale671599c22350500c6881a76377982e5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale671599c22350500c6881a76377982e5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.station-card','data' => ['order' => $order,'type' => 'item_prod_upper','technicians' => $techs['upper'],'techByRelation' => 'prodUpperBy','startedAtColumn' => 'prod_upper_started_at','byColumn' => 'prod_upper_by','color' => 'purple','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => ($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('station-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['order' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order),'type' => 'item_prod_upper','technicians' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($techs['upper']),'techByRelation' => 'prodUpperBy','startedAtColumn' => 'prod_upper_started_at','byColumn' => 'prod_upper_by','color' => 'purple','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
             ...
             <div x-show="activeTab === 'treatment'" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" style="display: none;">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['treatment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$order->prod_cleaning_completed_at): ?>
                             <div class="flex items-start gap-4 p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex-1">
                                    <?php if (isset($component)) { $__componentOriginale671599c22350500c6881a76377982e5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale671599c22350500c6881a76377982e5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.station-card','data' => ['order' => $order,'type' => 'item_prod_cleaning','technicians' => $techs['treatment'],'techByRelation' => 'prodCleaningBy','startedAtColumn' => 'prod_cleaning_started_at','byColumn' => 'prod_cleaning_by','color' => 'teal','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => ($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('station-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['order' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($order),'type' => 'item_prod_cleaning','technicians' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($techs['treatment']),'techByRelation' => 'prodCleaningBy','startedAtColumn' => 'prod_cleaning_started_at','byColumn' => 'prod_cleaning_by','color' => 'teal','titleAction' => 'Assign','showCheckbox' => 'true','loopIteration' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(($orders->currentPage() - 1) * $orders->perPage() + $loop->iteration)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($queueReview->isNotEmpty()): ?>
            <div class="mt-8 mb-8 bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden border-2 border-orange-400" x-show="activeTab === 'all' || activeTab.includes('review')">
                <div class="bg-gradient-to-r from-orange-500 to-red-500 p-4 text-white flex justify-between items-center">
                    ...
                    <span class="bg-white/20 px-3 py-1 rounded-full text-xs font-bold"><?php echo e($queueReview->count()); ?> Order</span>
                </div>
                ...
                <div class="overflow-x-auto -mx-4 sm:mx-0">
                    <table class="min-w-full w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $queueReview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr id="row-<?php echo e($order->spk_number); ?>" 
                                     ...
                                     <div class="flex flex-col gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_sol_completed_at): ?> 
                                            <div class="flex items-start gap-2 text-xs">
                                                ...
                                                <div>
                                                    <div class="font-medium text-gray-700"><?php echo e($order->prodSolBy->name ?? 'System'); ?></div>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_sol_started_at): ?>
                                                        <div class="text-[10px] text-gray-500">
                                                            <?php echo e($order->prod_sol_started_at->format('H:i')); ?> - <?php echo e($order->prod_sol_completed_at->format('H:i')); ?> 
                                                            <span class="font-bold text-teal-600">(<?php echo e($order->prod_sol_started_at->diffInMinutes($order->prod_sol_completed_at)); ?> mnt)</span>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            </div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_upper_completed_at): ?> 
                                            <div class="flex items-start gap-2 text-xs">
                                                ...
                                                <div>
                                                    <div class="font-medium text-gray-700"><?php echo e($order->prodUpperBy->name ?? 'System'); ?></div>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_upper_started_at): ?>
                                                        <div class="text-[10px] text-gray-500">
                                                            <?php echo e($order->prod_upper_started_at->format('H:i')); ?> - <?php echo e($order->prod_upper_completed_at->format('H:i')); ?> 
                                                            <span class="font-bold text-teal-600">(<?php echo e($order->prod_upper_started_at->diffInMinutes($order->prod_upper_completed_at)); ?> mnt)</span>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            </div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_cleaning_completed_at): ?> 
                                            <div class="flex items-start gap-2 text-xs">
                                                ...
                                                <div>
                                                    <div class="font-medium text-gray-700"><?php echo e($order->prodCleaningBy->name ?? 'System'); ?></div>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->prod_cleaning_started_at): ?>
                                                        <div class="text-[10px] text-gray-500">
                                                            <?php echo e($order->prod_cleaning_started_at->format('H:i')); ?> - <?php echo e($order->prod_cleaning_completed_at->format('H:i')); ?> 
                                                            <span class="font-bold text-teal-600">(<?php echo e($order->prod_cleaning_started_at->diffInMinutes($order->prod_cleaning_completed_at)); ?> mnt)</span>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            </div>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center items-center gap-2">
                                        <!-- Approve -->
                                        <form action="<?php echo e(route('production.approve', $order->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center gap-2">
                    <div class="relative group">
                        <select id="bulk-tech-select" class="appearance-none bg-white border border-gray-200 text-gray-700 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-48 pl-3 pr-8 py-2.5 font-bold shadow-sm cursor-pointer hover:border-blue-300 transition-colors">
                            ...
                            <optgroup label="Sol">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $techs['sol']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?> <option value="<?php echo e($t->id); ?>">Sol: <?php echo e($t->name); ?></option> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </optgroup>
                            <optgroup label="Upper">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $techs['upper']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?> <option value="<?php echo e($t->id); ?>">Upper: <?php echo e($t->name); ?></option> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </optgroup>
                            <optgroup label="Treatment/Repaint">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $techs['treatment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?> <option value="<?php echo e($t->id); ?>">Treat/Rep: <?php echo e($t->name); ?></option> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </optgroup>
                        </select>
...
<?php endif; ?>
    ...
    function bulkAction(action) {
        ...
        fetch('<?php echo e(route('production.bulk-update')); ?>', {
            method: 'POST',
            headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\production\index.blade.php ENDPATH**/ ?>