...
<head>
    ...
    <title>Shipping Label - <?php echo e($order->customer_name); ?></title>
        ...
        <div class="relative w-full h-full p-8 flex flex-col z-20">
            ...
            <div class="relative flex-1 w-full bg-white border-[2px] border-[#FFC232] rounded-[20px] rounded-br-[70px] overflow-hidden flex flex-col shadow-xl">
                ...
                <div class="flex-1 px-10 pt-10 flex flex-col justify-center">
                    <div class="mb-4">
                        <h2 class="text-5xl font-black text-slate-900 uppercase tracking-tighter leading-none mb-3"><?php echo e($order->customer_name); ?></h2>
                        <div class="space-y-0.5 border-l-[4px] border-[#22B086] pl-5 py-0.5">
                            ...
                            <p class="text-sm font-semibold text-slate-400 uppercase tracking-widest leading-none">
                                <?php echo e($order->customer?->district ?? '-'); ?> | <?php echo e($order->customer?->city ?? '-'); ?>

                            </p>
                            <p class="text-sm font-semibold text-slate-400 uppercase tracking-widest leading-none">
                                <?php echo e($order->customer?->province ?? '-'); ?> - <?php echo e($order->customer?->postal_code ?? '-'); ?>
                    ...
                    <div class="mt-2 flex items-center gap-3">
                        ...
                        <span class="text-3xl font-[1000] text-emerald-600 tracking-tighter font-mono"><?php echo e($order->customer_phone ?? $order->customer?->phone ?? '-'); ?></span>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\orders\shipping-label.blade.php ENDPATH**/ ?>