     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                ...
                <div class="text-xs font-medium opacity-90"><?php echo e($customer->name); ?></div>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="province" value="<?php echo e(old('province', $customer->province)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('notes', $customer->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <form id="delete-form" action="<?php echo e(route('admin.customers.destroy', $customer)); ?>" method="POST" class="hidden">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\customers\edit.blade.php ENDPATH**/ ?>