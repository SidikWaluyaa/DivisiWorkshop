<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lowStockMaterials && $lowStockMaterials->count() > 0): ?>
        ...
        <div class="bg-gradient-to-r from-red-500 to-orange-500 px-6 py-5 border-b border-red-200">
            <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center gap-2">
                            ...
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                <button @click.stop="open = !open" class="text-red-200 hover:text-white transition-colors cursor-pointer">
                ...
                <span class="px-3 py-1.5 bg-white/20 text-white rounded-lg text-xs font-bold backdrop-blur-sm">
                    <?php echo e($lowStockMaterials->count()); ?> item
                </span>
            </div>
        </div>
        <div class="p-5">
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between p-3 bg-white rounded-xl shadow-sm border border-red-100 hover:shadow-md transition-shadow">
                    <div>
                        <span class="font-bold text-gray-700 text-sm"><?php echo e($material->name); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($material->stock <= 0): ?>
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-xs text-gray-400">min: <?php echo e($material->min_stock); ?></span>
                        <span class="px-2.5 py-1 <?php echo e($material->stock <= 0 ? 'bg-red-600 text-white' : 'bg-red-100 text-red-700'); ?> rounded-lg font-bold text-xs">
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\workshop\widgets\material-alerts.blade.php ENDPATH**/ ?>