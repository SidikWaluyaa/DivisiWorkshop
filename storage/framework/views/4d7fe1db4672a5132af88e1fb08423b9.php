        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col xl:flex-row justify-between items-end gap-6">
                <div class="w-full xl:w-auto">
                    <div class="flex flex-wrap items-center gap-3 p-1.5 bg-gray-200/50 backdrop-blur-sm rounded-[1.5rem] border border-gray-200/50 w-fit">
                        ...
                        <a href="<?php echo e(route('production.late-info')); ?>" 
                           class="px-6 py-2.5 rounded-2xl text-[11px] font-black tracking-widest transition-all <?php echo e(!$currentStatus ? 'bg-white text-gray-900 shadow-xl scale-105 z-10' : 'text-gray-500 hover:text-gray-900'); ?>">
                            SEMUA DATA
                        </a>
                        <a href="<?php echo e(route('production.late-info', ['status' => 'LATE', 'search' => request('search')])); ?>" 
                           class="px-6 py-2.5 rounded-2xl text-[11px] font-black tracking-widest transition-all flex items-center gap-2 <?php echo e($currentStatus == 'LATE' ? 'bg-red-500 text-white shadow-lg shadow-red-200 scale-105 z-10' : 'text-gray-500 hover:text-red-500'); ?>">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($currentStatus == 'LATE' ? 'bg-white' : 'bg-red-500'); ?>"></span>
                            TERLAMBAT
                        </a>
                        <a href="<?php echo e(route('production.late-info', ['status' => 'WARNING', 'search' => request('search')])); ?>" 
                           class="px-6 py-2.5 rounded-2xl text-[11px] font-black tracking-widest transition-all flex items-center gap-2 <?php echo e($currentStatus == 'WARNING' ? 'bg-orange-500 text-white shadow-lg shadow-orange-200 scale-105 z-10' : 'text-gray-500 hover:text-orange-500'); ?>">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($currentStatus == 'WARNING' ? 'bg-white' : 'bg-orange-500'); ?>"></span>
                            WARNING (<= 5 HARI)
                        </a>
                        <a href="<?php echo e(route('production.late-info', ['status' => 'ON TRACK', 'search' => request('search')])); ?>" 
                           class="px-6 py-2.5 rounded-2xl text-[11px] font-black tracking-widest transition-all flex items-center gap-2 <?php echo e($currentStatus == 'ON TRACK' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-200 scale-105 z-10' : 'text-gray-500 hover:text-emerald-500'); ?>">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($currentStatus == 'ON TRACK' ? 'bg-white' : 'bg-emerald-500'); ?>"></span>
                            STABIL
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full xl:w-96">
                    <form action="<?php echo e(route('production.late-info')); ?>" method="GET" class="relative group">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search')): ?>
                            <a href="<?php echo e(route('production.late-info', ['status' => request('status')])); ?>" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-300 hover:text-red-500 transition-all active:scale-95">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="group hover:bg-white transition-all cursor-default" 
                                    x-data="lateRow(<?php echo e($order->id); ?>, '<?php echo e($order->late_description); ?>', '<?php echo e($order->new_estimation_date ? $order->new_estimation_date->format('Y-m-d') : ''); ?>', '<?php echo e($order->material_arrival_date ? $order->material_arrival_date->format('Y-m-d') : ''); ?>', '<?php echo e($order->material_photo_url); ?>', '<?php echo e(addslashes($order->material_name)); ?>')">
        ...
        function lateRow(id, desc, est, arrival, photo, materialName) {
            return {
                ...
                saveDescription() {
                    ...
                    this.postData('<?php echo e(route('production.late-info.update-description')); ?>', { id: this.id, description: this.description }, 'savingDesc');
                },

                saveNewEst() {
                    this.savingEst = true;
                    this.postData('<?php echo e(route('production.late-info.update-new-estimation')); ?>', { id: this.id, new_estimation_date: this.newEst }, 'savingEst');
                },

                saveArrivalDate() {
                    this.savingArrival = true;
                    this.postData('<?php echo e(route('production.late-info.update-material-arrival')); ?>', { id: this.id, material_arrival_date: this.arrivalDate }, 'savingArrival');
                },

                saveMaterialName() {
                    this.savingMaterialName = true;
                    this.postData('<?php echo e(route('production.late-info.update-material-name')); ?>', { id: this.id, material_name: this.materialName }, 'savingMaterialName');
                },
                ...
                uploadPhoto(event) {
                    ...
                    fetch('<?php echo e(route('production.late-info.upload-material-photo')); ?>', {
                        method: 'POST',
                        headers: {
                ...
                deletePhoto() {
                    ...
                    this.uploadingPhoto = true;
                    fetch('<?php echo e(route('production.late-info.delete-material-photo')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\production\late-info.blade.php ENDPATH**/ ?>