            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-black text-2xl text-gray-900 leading-tight tracking-tight uppercase">
                        <?php echo e(__('Follow-up Konsultasi')); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
                <div class="p-8 border-b border-gray-50 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <form action="<?php echo e(route('cs.leads.follow-up')); ?>" method="GET" class="flex-1 max-w-md relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Nama/HP..." class="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-orange-500 font-bold transition-all">
                            ...
                            <tr class="hover:bg-gray-50/50 transition group">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="<?php echo e(route('cs.leads.show', $lead->id)); ?>" class="p-2 bg-gray-50 text-gray-400 hover:bg-orange-50 hover:text-orange-600 rounded-xl transition shadow-sm">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\follow-up.blade.php ENDPATH**/ ?>