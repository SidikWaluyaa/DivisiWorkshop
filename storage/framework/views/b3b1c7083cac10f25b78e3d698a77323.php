    ...
    <div class="max-w-md">
        <div class="bg-white rounded-[2.5rem] p-10 shadow-2xl">
            ...
            <p class="text-slate-500 font-medium mb-8 leading-relaxed">
                Halo Kak <b><?php echo e($order->customer_name); ?></b>, tim workshop kami sedang memproses dokumentasi hasil akhir untuk nomor SPK <b><?php echo e($order->spk_number); ?></b>.
            </p>
            ...
            <div class="bg-amber-100/50 border border-amber-200 text-amber-700 p-5 rounded-2xl mb-8">
                ...
                <p class="text-lg font-black uppercase tracking-widest"><?php echo e($order->status->label()); ?></p>
            </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\customer\report-pending.blade.php ENDPATH**/ ?>