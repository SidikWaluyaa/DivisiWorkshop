...
<div class="bg-white overflow-hidden shadow-lg rounded-2xl border border-gray-100 mb-6 relative group transform transition-all hover:shadow-xl" 
     x-data="{ filterType: '<?php echo e(request()->has('month') ? 'month' : 'year'); ?>' }">
    ...
    <div class="bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-500 px-6 py-4 flex items-center justify-between">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($periodLabel)): ?>
    ...
    <div class="p-6">
        <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="flex flex-col md:flex-row gap-6 items-end">
            ...
            <div class="flex-1 w-full">
                ...
                <div class="bg-gray-100 p-1.5 rounded-xl inline-flex w-full md:w-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('month')): ?> <input type="hidden" name="month" value="<?php echo e(request('month')); ?>" :disabled="filterType !== 'month'"> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('year')): ?> <input type="hidden" name="year" value="<?php echo e(request('year')); ?>" :disabled="filterType !== 'year'"> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <div class="flex gap-3 w-full md:w-auto pt-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->has('month') || request()->has('year')): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2.5 bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 text-gray-600 rounded-xl transition-all font-semibold flex items-center justify-center gap-2" title="Reset Filter">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\components\period-filter.blade.php ENDPATH**/ ?>