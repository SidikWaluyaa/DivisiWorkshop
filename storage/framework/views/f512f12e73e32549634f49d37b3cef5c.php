...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['currentStage']));
...
foreach (array_filter((['currentStage']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
        ...
        function revisionModalData() {
            return {
                ...
                openModal(id, number) {
                    ...
                    this.formAction = `/<?php echo e(strtolower($currentStage)); ?>/${id}/reject`;
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\components\revision-modal.blade.php ENDPATH**/ ?>