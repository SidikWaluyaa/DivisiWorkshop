...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Warehouse Dashboard')); ?>
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-6 bg-white p-6 rounded-3xl shadow-xl border border-gray-100">
                ...
                <div class="w-full md:w-96 relative group">
                    <form action="<?php echo e(route('storage.dashboard')); ?>" method="GET">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full md:w-auto">
                        <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center shadow-sm hover:shadow-md transition-all group relative">
                            <div id="stat-pending-reception" class="text-3xl font-black text-[#22AF85]"><?php echo e($stats['pending_reception']); ?></div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center shadow-sm hover:shadow-md transition-all group relative">
                            <div id="stat-inventory-value" class="text-3xl font-black text-indigo-600">Rp <?php echo e(number_format($inventoryValue['total'] / 1000000, 1, ',', '.')); ?>jt</div>
                            <div class="flex items-center justify-center gap-1 mt-1">
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center shadow-sm hover:shadow-md transition-all group relative">
                            <div id="stat-stored-items" class="text-3xl font-black text-[#FFC232]"><?php echo e($stats['stored_items']); ?></div>
                            <div class="flex items-center justify-center gap-1 mt-1">
                        ...
                        <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center shadow-sm hover:shadow-md transition-all group relative">
                            <div id="stat-qc-reject" class="text-3xl font-black text-pink-600"><?php echo e($qcRejectTrends['total']); ?></div>
                            <div class="flex items-center justify-center gap-1 mt-1">
            ...
            <div x-show="activeTab === 'summary'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden stat-card">
                    <div class="p-6 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-[#22AF85]/5 to-white">
                        ...
                        <a href="<?php echo e(route('reception.index')); ?>" class="px-2 py-1 bg-[#22AF85]/10 text-brand-green rounded-lg text-xs font-black hover:bg-[#22AF85]/20 transition-colors">
                            <span id="queue-count-reception"><?php echo e($queues['reception']->count()); ?></span> <span class="ml-1 opacity-50">View All →</span>
                        </a>
                    </div>
                    <div class="p-4 space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['reception']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="p-3 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-green transition-all group">
                                <div class="flex justify-between items-start mb-1">
                                    <span class="font-mono text-sm font-black text-gray-900 group-hover:text-brand-green"><?php echo e($order->spk_number); ?></span>
                                    <span class="text-[10px] bg-white px-2 py-0.5 rounded-full border border-gray-200 text-gray-500 font-bold uppercase"><?php echo e($order->priority); ?></span>
                                </div>
                                <div class="text-xs text-gray-600 font-bold mb-2"><?php echo e($order->customer_name); ?></div>
                                <div class="flex justify-between items-center">
                                    <span class="text-[10px] text-gray-400"><?php echo e($order->created_at->diffForHumans()); ?></span>
                                    <a href="<?php echo e(route('reception.show', $order->id)); ?>" class="text-[10px] font-black text-brand-green hover:underline">Proses →</a>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden stat-card">
                    <div class="p-6 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-[#FFC232]/5 to-white">
                        ...
                        <a href="<?php echo e(route('reception.index')); ?>#received" class="px-2 py-1 bg-[#FFC232]/10 text-[#B8860B] rounded-lg text-xs font-black hover:bg-[#FFC232]/20 transition-colors">
                            <span id="queue-count-needs_qc"><?php echo e($queues['needs_qc']->count()); ?></span> <span class="ml-1 opacity-50">View All →</span>
                        </a>
                    </div>
                    <div class="p-4 space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['needs_qc']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="p-3 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-yellow transition-all group">
                                <div class="flex justify-between items-start mb-1">
                                    <span class="font-mono text-sm font-black text-gray-900 group-hover:text-brand-yellow"><?php echo e($order->spk_number); ?></span>
                                ...
                                <div class="text-xs text-gray-600 font-bold mb-2"><?php echo e($order->customer_name); ?></div>
                                <div class="flex justify-between items-center">
                                    <span class="text-[10px] text-gray-400"><?php echo e($order->updated_at->diffForHumans()); ?></span>
                                    <a href="<?php echo e(route('reception.show', $order->id)); ?>" class="text-[10px] font-black text-brand-yellow hover:underline">Cek QC →</a>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden stat-card">
                    <div class="p-6 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-[#22AF85]/5 to-white">
                        ...
                        <a href="<?php echo e(route('storage.index')); ?>" class="px-2 py-1 bg-[#22AF85]/10 text-brand-green rounded-lg text-xs font-black hover:bg-[#22AF85]/20 transition-colors">
                            <span id="queue-count-storage"><?php echo e($queues['storage']->count()); ?></span> <span class="ml-1 opacity-50">View All →</span>
                        </a>
                    </div>
                    <div class="p-4 space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['storage']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="p-3 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-green transition-all group">
                                <div class="flex justify-between items-start mb-1">
                                    <span class="font-mono text-sm font-black text-gray-900 group-hover:text-brand-green"><?php echo e($order->spk_number); ?></span>
                                    <span class="text-[10px] bg-white px-2 py-0.5 rounded-full border border-gray-200 text-gray-500 font-bold uppercase"><?php echo e($order->status->label()); ?></span>
                                </div>
                                <div class="text-xs text-gray-600 font-bold mb-2"><?php echo e($order->customer_name); ?></div>
                                <div class="flex justify-between items-center">
                                    <span class="text-[10px] text-gray-400"><?php echo e($order->updated_at->diffForHumans()); ?></span>
                                    <a href="<?php echo e(route('storage.index')); ?>?search=<?php echo e($order->spk_number); ?>" class="text-[10px] font-black text-brand-green hover:underline">Simpan →</a>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden stat-card">
                    <div class="p-6 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-pink-50/30 to-white">
                        ...
                        <a href="<?php echo e(route('storage.index', ['filter' => 'ready'])); ?>" class="px-2 py-1 bg-[#FFC232]/10 text-[#B8860B] rounded-lg text-xs font-black hover:bg-[#FFC232]/20 transition-colors">
                            <span id="queue-count-pickup"><?php echo e($queues['pickup']->count()); ?></span> <span class="ml-1 opacity-50">View All →</span>
                        </a>
                    </div>
                    <div class="p-4 space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues['pickup']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="p-3 bg-gray-50 rounded-2xl border border-gray-100 hover:border-brand-yellow transition-all group">
                                <div class="flex justify-between items-start mb-1">
                                    <span class="font-mono text-sm font-black text-gray-900 group-hover:text-brand-yellow"><?php echo e($order->spk_number); ?></span>
                                ...
                                <div class="text-xs text-gray-600 font-bold mb-1"><?php echo e($order->customer_name); ?></div>
                                <div class="text-[10px] text-brand-green font-black mb-2 flex items-center gap-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->storageAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <?php echo e($assignment->rack_code); ?><?php echo e(!$loop->last ? ',' : ''); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-[10px] text-gray-400">Selesai <?php echo e($order->updated_at->format('d/m H:i')); ?></span>
                                    <form action="<?php echo e(route('storage.retrieve', $order->storageAssignments->first()?->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
            ...
            <div x-show="activeTab === 'board'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['reception' => 'Penerimaan Baru', 'needs_qc' => 'Pengecekan Fisik', 'storage' => 'Perlu Disimpan', 'pickup' => 'Siap Diambil']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <div class="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10 rounded-t-3xl">
                            <h3 class="font-black text-gray-900 text-lg flex items-center gap-3">
                                <span class="w-10 h-10 rounded-2xl bg-gray-50 text-brand-green flex items-center justify-center text-xl border border-gray-100">
                                    <?php echo e($key === 'reception' ? '📥' : ($key === 'storage' ? '📦' : '🚀')); ?>

                                </span>
                                <?php echo e($title); ?>

                            </h3>
                            <span class="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-xs font-black"><?php echo e($queues[$key]->count()); ?></span>
                        </div>
                        
                        <div class="flex-1 overflow-y-auto p-6 space-y-4 sidebar-scroll">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $queues[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="p-5 bg-white rounded-2xl border-2 border-gray-50 hover:border-indigo-100 hover:shadow-xl transition-all group relative">
                                    <div class="flex justify-between items-start mb-3">
                                        <div class="flex flex-col">
                                            <span class="font-mono text-base font-black text-gray-900 group-hover:text-indigo-600"><?php echo e($order->spk_number); ?></span>
                                            <span class="text-xs text-gray-400 font-bold tracking-tight"><?php echo e($order->created_at->format('d M Y, H:i')); ?></span>
                                        </div>
                                        <span class="px-2 py-1 bg-gray-100 text-gray-600 rounded-lg text-[10px] font-black uppercase tracking-widest"><?php echo e($order->priority); ?></span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <span class="text-sm font-black text-gray-700"><?php echo e($order->customer_name); ?></span>
                                    </div>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key === 'pickup'): ?>
                                        <div class="bg-gray-50 p-3 rounded-xl mb-4 border border-gray-100">
                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->storageAssignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <span class="bg-white px-2 py-0.5 rounded-lg border border-gray-200 text-brand-green font-black text-xs shadow-sm"><?php echo e($assignment->rack_code); ?></span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="flex gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key === 'reception' || $key === 'needs_qc'): ?>
                                            <a href="<?php echo e(route('reception.show', $order->id)); ?>" class="flex-1 py-2.5 bg-brand-yellow hover:bg-[#E5AF2D] text-gray-900 rounded-xl text-center text-xs font-black shadow-lg shadow-brand-yellow/20 transition-all">
                                                <?php echo e($key === 'reception' ? 'Proses Sekarang →' : 'Cek QC Fisik →'); ?>

                                            </a>
                                        <?php elseif($key === 'storage'): ?>
                                            <a href="<?php echo e(route('storage.index')); ?>?search=<?php echo e($order->spk_number); ?>" class="flex-1 py-2.5 bg-brand-yellow hover:bg-[#E5AF2D] text-gray-900 rounded-xl text-center text-xs font-black shadow-lg shadow-brand-yellow/20 transition-all">Simpan ke Rak →</a>
                                        <?php elseif($key === 'pickup'): ?>
                                            <form action="<?php echo e(route('storage.retrieve', $order->storageAssignments->first()?->id)); ?>" method="POST" class="flex-1">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8 space-y-10">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['shoes' => 'Rak Sepatu', 'accessories' => 'Rak Aksesoris']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($racksByCategory[$key])): ?>
                                <div>
                                    <h4 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-4 flex items-center gap-2">
                                        <span class="w-2 h-2 rounded-full <?php echo e($key === 'shoes' ? 'bg-brand-green' : 'bg-brand-yellow'); ?>"></span>
                                        <?php echo e($label); ?>

                                    </h4>
                                    <div class="grid grid-cols-5 md:grid-cols-10 gap-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $racksByCategory[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <?php
                                                $util = $rack->getUtilizationPercentage();
                                                $color = $util >= 100 ? 'bg-red-500' : ($util >= 50 ? 'bg-orange-500' : 'bg-green-500');
                                            ?>
                                            <a href="<?php echo e(route('storage.index')); ?>?category=<?php echo e($rack->category); ?>&search=<?php echo e($rack->rack_code); ?>" class="group relative">
                                                <div class="aspect-square <?php echo e($color); ?> rounded-xl flex items-center justify-center text-white font-black text-xs group-hover:scale-110 transition-transform shadow-lg border-2 border-white/50">
                                                ...
                                                <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 text-white text-[10px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-20">
                                                    <?php echo e($rack->current_count); ?>/<?php echo e($rack->capacity); ?> Unit
                                                </div>
                                            </a>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </div>
                        ...
                        <div class="mt-8 grid grid-cols-3 gap-4">
                            <div class="p-4 bg-gray-50 rounded-2xl text-center">
                                <div id="rack-utilization" class="text-2xl font-black text-gray-800"><?php echo e($rackStats['utilization_percentage']); ?>%</div>
                                <div class="text-[10px] text-gray-500 font-bold uppercase">Avg. Utilitas</div>
                            </div>
                            <div class="p-4 bg-gray-50 rounded-2xl text-center">
                                <div id="rack-available" class="text-2xl font-black text-gray-800"><?php echo e($rackStats['total_available']); ?></div>
                                <div class="text-[10px] text-gray-500 font-bold uppercase">Slot Kosong</div>
                            </div>
                            <div class="p-4 bg-gray-50 rounded-2xl text-center">
                                <div id="rack-full" class="text-2xl font-black text-gray-800"><?php echo e($rackStats['full_racks']); ?></div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white rounded-3xl p-6 shadow-xl relative overflow-hidden border border-[#FFC232]/30">
                        ...
                        <div class="space-y-3 relative z-10">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lowStockMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-[#FFC232]/50 transition-all">
                                    <div>
                                        <div class="font-bold text-sm text-gray-800"><?php echo e($material->name); ?></div>
                                        <div class="text-[10px] text-gray-400 font-bold">Limit: <?php echo e($material->min_stock); ?> <?php echo e($material->unit); ?></div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-lg font-black text-[#FFC232]"><?php echo e($material->stock); ?></div>
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1 border-b border-gray-50 pb-4">
                                        <div class="flex justify-between items-start">
                                            <span class="text-xs font-black text-gray-900"><?php echo e($log->user->name); ?></span>
                                            <span class="text-[10px] text-gray-400"><?php echo e($log->created_at->diffForHumans()); ?></span>
                                        </div>
                                        <p class="text-[11px] text-gray-600 mt-1">
                                            <span class="font-bold text-brand-green"><?php echo e($log->workOrder->spk_number ?? 'N/A'); ?></span>: <?php echo e($log->description); ?>
    ...
    <script>
        (function() {
            ...
            const API_URL = '<?php echo e(route("storage.dashboard.api-stats")); ?>';
            ...
            initChart('qcTrendsChart', {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($qcRejectTrends['labels']); ?>,
                    datasets: [{
                        label: 'Reject Count',
                        data: <?php echo json_encode($qcRejectTrends['data']); ?>,
                        borderColor: '#DB2777',
            ...
            initChart('supplierSpendChart', {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($supplierAnalytics['bySpend']['labels']); ?>,
                    datasets: [{
                        data: <?php echo json_encode($supplierAnalytics['bySpend']['data']); ?>,
            ...
            initChart('supplierRatingChart', {
                type: 'radar',
                data: {
                    labels: <?php echo json_encode($supplierAnalytics['byRating']['labels']); ?>,
                    datasets: [{
                        data: <?php echo json_encode($supplierAnalytics['byRating']['data']); ?>,
            ...
            initChart('materialTrendsChart', {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($materialTrends['labels']); ?>,
                    datasets: [{
                        data: <?php echo json_encode($materialTrends['data']); ?>,
            ...
            initChart('qcReasonsChart', {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode($qcRejectReasons['labels']); ?>,
                    datasets: [{
                        data: <?php echo json_encode($qcRejectReasons['data']); ?>,
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\warehouse\dashboard\index.blade.php ENDPATH**/ ?>