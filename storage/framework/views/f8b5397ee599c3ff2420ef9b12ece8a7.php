                            ...
                            <div class="mb-10 p-8 bg-slate-50 rounded-[40px] border border-slate-100 shadow-inner">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div>
                                        ...
                                        <select wire:model.live="draftItems.<?php echo e($idx); ?>.service_category_filter" class="w-full bg-white border border-slate-100 rounded-2xl p-4 text-sm font-black focus:ring-4 focus:ring-emerald-500/10 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="text" wire:model.live.debounce.300ms="draftItems.<?php echo e($idx); ?>.service_search" placeholder="Cari nama jasa..." class="w-full bg-white border border-slate-100 rounded-2xl p-4 pl-12 text-sm font-black focus:ring-4 focus:ring-emerald-500/10 shadow-sm transition-all">
                                ...
                                <div class="bg-emerald-500 p-8 rounded-[40px] shadow-2xl shadow-emerald-500/30 space-y-6">
                                    ...
                                    <div class="flex justify-between items-center bg-white/10 p-6 rounded-3xl border border-white/10">
                                        <span class="text-sm font-black text-white uppercase tracking-widest">
                                            <?php echo e($spkData['payment_type'] === 'LUNAS_AWAL' ? 'Total Pelunasan' : 'Nominal DP'); ?>

                                        </span>
                                        <div class="relative w-1/2">
                                            <span class="absolute left-5 top-1/2 -translate-y-1/2 text-white/50 font-black text-sm">Rp</span>
                                            <input type="number" wire:model.live="spkData.dp_amount" class="w-full bg-white border-0 rounded-2xl py-4 pl-12 pr-5 text-right font-black text-emerald-700 focus:ring-4 focus:ring-white/20" <?php echo e($spkData['payment_type'] === 'LUNAS_AWAL' ? 'readonly' : ''); ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <label for="proofImage" class="flex items-center justify-center gap-4 w-full bg-white/10 hover:bg-white/20 border-2 border-dashed border-white/20 py-4 rounded-2xl cursor-pointer transition-all">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proofImage): ?>
                                                    <svg class="w-5 h-5 text-emerald-300" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L10 8.586 7.707 6.293a1 1 0 00-1.414 1.414L8.586 10l-2.293 2.293a1 1 0 001.414 1.414L10 11.414l2.293 2.293a1 1 0 001.414-1.414L11.414 10l2.293-2.293z" clip-rule="evenodd" /></svg>
                                                    <span class="text-[10px] font-black text-white uppercase tracking-widest truncate max-w-[200px]"><?php echo e($proofImage->getClientOriginalName()); ?></span>
                                                <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditProfileModal): ?>
        <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-xl">
            <div class="glass-panel bg-white/95 w-full max-w-2xl overflow-hidden shadow-2xl border-white">
                <div class="p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                ...
                <div class="p-8 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" wire:model="profileData.customer_name" class="w-full bg-slate-50 border-slate-100 rounded-2xl p-4 text-sm font-black focus:ring-4 focus:ring-emerald-500/10 transition-all <?php $__errorArgs = ['profileData.customer_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['profileData.customer_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-red-500 font-bold mt-1 px-2"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div>
                            ...
                            <input type="text" wire:model="profileData.customer_phone" class="w-full bg-slate-50 border-slate-100 rounded-2xl p-4 text-sm font-black focus:ring-4 focus:ring-emerald-500/10 transition-all <?php $__errorArgs = ['profileData.customer_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['profileData.customer_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-red-500 font-bold mt-1 px-2"><?php echo e($message); ?></p> <?php unset($message);
