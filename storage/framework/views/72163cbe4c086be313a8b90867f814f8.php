...
<body>
    ...
    <div class="main-card overflow-hidden fade-in-up">
        ...
        <div class="pt-10 pb-6 px-8 text-center bg-slate-50/50">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Shoe Workshop Logo" class="h-16 mx-auto mb-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$is_verified): ?>
        <div class="p-8 md:p-10" id="form-container">
            <form id="addressForm" class="space-y-6">
                <input type="hidden" name="token" id="token" value="<?php echo e(request()->segment(count(request()->segments()))); ?>">
        ...
        <div id="success-state" class="p-12 text-center bg-white" <?php if(!$is_verified): ?> style="display: none;" <?php endif; ?>>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\customer\verify-address.blade.php ENDPATH**/ ?>