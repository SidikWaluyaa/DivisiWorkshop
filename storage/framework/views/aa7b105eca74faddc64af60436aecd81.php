            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                ...
                <div class="flex gap-4">
                    <div class="relative group">
                        ...
                        <div class="relative bg-white px-6 py-4 rounded-2xl border border-gray-100 flex items-center gap-4 min-w-[180px]">
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative bg-white px-6 py-4 rounded-2xl border border-gray-100 flex items-center gap-4 min-w-[180px]">
                            <div class="w-12 h-12 rounded-xl bg-pink-50 flex items-center justify-center text-2xl">📅</div>
                            <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <div class="col-span-full py-32 bg-white rounded-[4rem] border border-dashed border-gray-200 text-center">
                    <div class="flex flex-col items-center justify-center space-y-6">
                        ...
                        <button wire:click="$set('search', '')" class="px-8 py-3 bg-gray-900 text-white rounded-full font-black text-sm hover:bg-teal-600 transition-all shadow-lg active:scale-95">
                            Reset Pencarian
                        </button>
                    </div>
                </div>
