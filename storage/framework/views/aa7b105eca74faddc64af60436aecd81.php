<div class="min-h-screen bg-[#f8fafc]">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                ...
                <div class="flex gap-4">
                    <button wire:click="filterByPreset('today')" class="relative group outline-none">
                        ...
                        <div class="relative bg-white px-6 py-4 rounded-2xl border <?php echo e($date_start == date('Y-m-d') && $date_end == date('Y-m-d') ? 'border-teal-500 ring-2 ring-teal-50' : 'border-gray-100'); ?> flex items-center gap-4 min-w-[180px] transition-all">
                            ...
                            <div class="text-left">
                                ...
                                <div class="text-2xl font-black text-gray-900"><?php echo e($stats['today']); ?></div>
                            </div>
                        </div>
                    </button>
                    <button wire:click="filterByPreset('week')" class="relative group outline-none">
                        ...
                        <div class="relative bg-white px-6 py-4 rounded-2xl border <?php echo e($date_start == \Carbon\Carbon::today()->startOfWeek()->toDateString() ? 'border-pink-500 ring-2 ring-pink-50' : 'border-gray-100'); ?> flex items-center gap-4 min-w-[180px] transition-all">
                            ...
                            <div class="text-left">
                                ...
                                <div class="text-2xl font-black text-gray-900"><?php echo e($stats['this_week']); ?></div>
                            </div>
                        </div>
                    </button>
                </div>
    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="space-y-12">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groupedShippings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="px-6 py-2 bg-gray-900 text-white rounded-full text-xs font-black uppercase tracking-[0.2em] shadow-lg shadow-gray-200">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($date == date('Y-m-d')): ?>
                                Hari Ini
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="group relative bg-white rounded-[3rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-teal-500/10 transition-all duration-500 overflow-hidden flex flex-col h-full">
                                ...
                                <div class="absolute top-6 right-6 z-10">
                                    <span class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter shadow-sm
                                        <?php echo e($shipping->kategori_pengiriman == 'Ekspedisi' ? 'bg-teal-500 text-white' : 
                                           ($shipping->kategori_pengiriman == 'Ojek Online' ? 'bg-pink-500 text-white' : 'bg-orange-500 text-white')); ?>">
                                        <?php echo e($shipping->kategori_pengiriman); ?>
                                ...
                                <div class="p-8 flex flex-col h-full">
                                    <div class="mb-6">
                                        <span class="inline-block px-3 py-1 bg-gray-100 rounded-lg text-[10px] font-black text-gray-400 tracking-widest mb-3">
                                            SPK: <?php echo e($shipping->spk_number); ?>

                                        </span>
                                        <h3 class="text-2xl font-black text-gray-900 group-hover:text-teal-600 transition-colors leading-tight line-clamp-1">
                                            <?php echo e($shipping->customer_name); ?>

                                        </h3>
                                        <p class="text-sm font-bold text-teal-500 mt-1"><?php echo e($shipping->customer_phone); ?></p>
                                    </div>

                                    <div class="space-y-5 flex-1">
                                        
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipping->workOrder): ?>
                                                ...
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div class="overflow-hidden">
                                                        ...
                                                        <div class="text-sm font-bold text-gray-800 truncate">
                                                            <?php echo e($shipping->workOrder->shoe_brand); ?>

                                                        </div>
                                                        <div class="text-[11px] text-gray-500 font-medium">Color: <?php echo e($shipping->workOrder->shoe_color); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipping->resi_pengiriman): ?>
                                            <div class="bg-teal-50/30 border border-teal-100/50 rounded-[2rem] p-5 flex items-center justify-between group/resi">
                                                <div class="overflow-hidden">
                                                    ...
                                                    <div class="text-lg font-black text-gray-900 tracking-wider truncate mr-2"><?php echo e($shipping->resi_pengiriman); ?></div>
                                                </div>
                                                <button onclick="copyToClipboard('<?php echo e($shipping->resi_pengiriman); ?>', this)" 
                                    ...
                                    <div class="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between">
                                        <div>
                                            ...
                                            <div class="text-sm font-black text-gray-800"><?php echo e($shipping->tanggal_pengiriman?->format('d M Y') ?: '-'); ?></div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <div class="text-right">
                                                <div class="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none">PIC</div>
                                                <div class="text-[11px] font-bold text-gray-700"><?php echo e($shipping->pic ?: 'Gudang'); ?></div>
                                            </div>
                                            <div class="w-10 h-10 rounded-full bg-teal-50 border-2 border-white shadow-sm flex items-center justify-center font-black text-teal-600 text-xs uppercase">
                                                <?php echo e(substr($shipping->pic ?: 'G', 0, 1)); ?>
                                    ...
                                    <div class="mt-6">
                                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $shipping->customer_phone)); ?>?text=Halo%20<?php echo e(urlencode($shipping->customer_name)); ?>,%20sepatu%20dengan%20SPK%20<?php echo e($shipping->spk_number); ?>%20sudah%20kami%20kirimkan%20ya.%0ANomor%20Resi:%20<?php echo e($shipping->resi_pengiriman); ?>" 
                                           target="_blank"
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/livewire/cx/shipping-monitoring.blade.php ENDPATH**/ ?>