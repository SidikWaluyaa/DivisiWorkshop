<div class="p-8 space-y-8 bg-[#FBFBFB] min-h-screen">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <a href="<?php echo e(route('storage.disbursement.create')); ?>" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center space-x-4">
            ...
            <div>
                <div class="text-2xl font-black text-gray-900"><?php echo e($disbursements->total()); ?></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center space-x-4">
            ...
            <div>
                <div class="text-2xl font-black text-gray-900"><?php echo e(\App\Models\WarehouseDisbursement::where('status', 'PENDING')->count()); ?></div>
        ...
        <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center space-x-4">
            ...
            <div>
                <div class="text-2xl font-black text-[#22AF85]">Rp <?php echo e(number_format(\App\Models\WarehouseDisbursement::where('status', 'COMPLETED')->sum('total_amount'), 0, ',', '.')); ?></div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $disbursements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disbursement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr class="group hover:bg-[#FBFBFB] transition-all">
                        <td class="px-8 py-6">
                            <div class="flex flex-col">
                                <span class="text-lg font-black text-gray-900 group-hover:text-rose-500 transition-colors tracking-tight"><?php echo e($disbursement->disbursement_number); ?></span>
                                <div class="flex items-center mt-1 space-x-2">
                                    <span class="text-xs font-bold text-gray-400"><?php echo e($disbursement->disbursement_date->format('d M Y')); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disbursement->external_reference): ?>
                                        <span class="px-2 py-0.5 bg-rose-50 rounded text-[10px] font-bold text-rose-500 uppercase tracking-widest">REF: <?php echo e($disbursement->external_reference); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex flex-col items-center justify-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disbursement->status == 'PENDING'): ?>
                        ...
                        <td class="px-8 py-6">
                            <div class="flex flex-wrap gap-1 max-w-[200px]">
                                <?php $spks = $disbursement->items->pluck('spk_number')->unique()->filter(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $spks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <span class="text-[10px] font-black text-gray-400 bg-gray-50 px-2 py-0.5 rounded border border-gray-100 group-hover:border-rose-200 transition-all"><?php echo e($spk); ?></span>
                        ...
                        <td class="px-8 py-6">
                            <div class="text-lg font-black text-gray-900 tracking-tight">Rp <?php echo e(number_format($disbursement->total_amount, 0, ',', '.')); ?></div>
                            <div class="text-[10px] font-bold text-gray-400 uppercase tracking-widest"><?php echo e($disbursement->items->count()); ?> Jenis Material</div>
                        </td>
                        <td class="px-8 py-6 text-right">
                            <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-all">
                                <a href="<?php echo e(route('storage.disbursement.show', $disbursement->id)); ?>" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disbursement->status !== 'COMPLETED'): ?>
                                    <button wire:click="completeDisbursement(<?php echo e($disbursement->id); ?>)" 
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <a href="<?php echo e(route('storage.disbursement.edit', $disbursement->id)); ?>" 
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/livewire/warehouse/disbursement/index.blade.php ENDPATH**/ ?>