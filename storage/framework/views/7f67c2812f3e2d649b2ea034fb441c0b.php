    ...
    <div class="container">
        ...
        <div class="details">
            <table>
                <tr>
                    <th>Nomor SPK</th>
                    <td style="font-weight: bold; color: #0f766e;"><?php echo e($order->spk_number); ?></td>
                </tr>
                <tr>
                    <th>Tanggal Masuk</th>
                ...
                <tr>
                    ...
                    <td><?php echo e($order->estimation_date->format('d M Y')); ?></td>
                </tr>
                <tr>
                    <th>Brand Sepatu</th>
        ...
        <div style="text-align: center;">
            <a href="<?php echo e(route('tracking.index')); ?>" class="btn">Cek Progress Pesanan</a>
        </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\emails\orders\received.blade.php ENDPATH**/ ?>