...
<div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 overflow-hidden border border-gray-100">
    ...
    <div class="p-8 max-h-[600px] overflow-y-auto custom-scrollbar">
        <div class="relative">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lead->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="relative pl-16 mb-10 last:mb-0 group/item">
                    ...
                    <div>
                        <div class="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                            <span class="font-black text-xs text-gray-900 uppercase tracking-widest"><?php echo e($activity->user->name ?? 'System'); ?></span>
                            <div class="hidden sm:block w-1 h-1 rounded-full bg-gray-200"></div>
                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.1em]"><?php echo e($activity->created_at->diffForHumans()); ?></span>
                        </div>
                        ...
                        <div class="p-5 bg-gray-50 rounded-2xl border-2 border-transparent transition-all duration-300 group-hover/item:bg-white group-hover/item:border-gray-100 group-hover/item:shadow-sm">
                            <p class="text-sm text-gray-700 font-medium leading-relaxed"><?php echo $activity->formatted_content; ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->channel): ?>
                                <div class="mt-3 pt-3 border-t border-gray-100/50 flex items-center gap-2">
                                    <span class="px-2 py-0.5 bg-gray-100 rounded text-[9px] font-black text-gray-400 uppercase tracking-widest">Via <?php echo e($activity->channel); ?></span>
                                </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\activity-timeline.blade.php ENDPATH**/ ?>