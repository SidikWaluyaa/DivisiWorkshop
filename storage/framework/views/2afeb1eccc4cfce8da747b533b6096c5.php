...
<head>
    ...
    <title>Kuitansi Protokol #<?php echo e($order->spk_number); ?></title>
    ...
    <div class="export-container">
        ...
        <div class="border-b-4 border-gray-900 pb-10 mb-12 flex justify-between items-end">
            ...
            <div class="text-right">
                ...
                <div class="text-sm font-black text-gray-900 italic leading-none tracking-tight"><?php echo e(now()->format('M d, Y / H:i')); ?></div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-12 mb-16 italic">
            <div class="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 flex flex-col gap-6">
                <div>
                    ...
                    <div class="text-2xl font-black text-gray-900 tracking-tighter"><?php echo e($order->spk_number); ?></div>
                    <div class="text-[10px] font-black text-[#22AF85] uppercase tracking-widest mt-1.5 opacity-80"><?php echo e(str_replace('_', ' ', $order->status->value)); ?> Sector</div>
                </div>
                <div>
                    <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Registrasi</h3>
                    <div class="text-sm font-black text-gray-900"><?php echo e($order->entry_date?->format('d M / Y') ?? '-'); ?></div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-[2rem] p-8 border border-gray-100 flex flex-col gap-6">
                <div>
                    ...
                    <div class="text-2xl font-black text-gray-900 tracking-tighter"><?php echo e($order->customer_name); ?></div>
                    <div class="text-[10px] font-black text-gray-400 mt-1.5"><?php echo e($order->customer_phone); ?></div>
                </div>
                <div>
                    <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Aset Objek</h3>
                    <div class="text-sm font-black text-gray-900 uppercase tracking-tight"><?php echo e($order->shoe_brand); ?> · <?php echo e($order->shoe_color); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-6 mb-16">
            <div class="bg-gray-900 text-white rounded-[2rem] p-8 shadow-xl relative overflow-hidden group">
                ...
                <div class="text-2xl font-black italic tracking-tighter tabular-nums">Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?></div>
            </div>
            <div class="bg-[#22AF85] text-white rounded-[2rem] p-8 shadow-xl relative overflow-hidden group">
                ...
                <div class="text-2xl font-black italic tracking-tighter tabular-nums">Rp <?php echo e(number_format($order->total_paid, 0, ',', '.')); ?></div>
            </div>
            <div class="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-lg group">
                ...
                <div class="text-2xl font-black italic tracking-tighter tabular-nums <?php echo e($order->sisa_tagihan > 0 ? 'text-rose-600' : 'text-gray-300'); ?>">Rp <?php echo e(number_format($order->sisa_tagihan, 0, ',', '.')); ?></div>
            </div>
        </div>
                        ...
                        <div class="bg-white rounded-[1.5rem] p-6 border border-gray-100 hover:border-[#22AF85]/30 transition-all group">
                            <div class="flex justify-between items-start">
                                <div>
                                    <div class="text-[9px] font-black text-[#22AF85] uppercase tracking-widest mb-1 italic">
                                        <?php echo e($payment->type === 'BEFORE' ? 'PEMBAYARAN AWAL / DP' : 'PELUNASAN AKHIR'); ?>

                                    </div>
                                    <div class="text-xl font-black text-gray-900 tracking-tighter uppercase"><?php echo e($payment->payment_method); ?></div>
                                    <div class="text-[10px] text-gray-400 font-black mt-1 uppercase tracking-wider"><?php echo e($payment->paid_at->format('M d, Y / H:i')); ?></div>
                                </div>
                                <div class="text-right">
                                    <div class="text-2xl font-black text-[#22AF85] tracking-tighter tabular-nums group-hover:scale-110 transition-transform origin-right">Rp <?php echo e(number_format($payment->amount_total, 0, ',', '.')); ?></div>
                                </div>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->notes): ?>
                                <div class="mt-4 p-4 bg-gray-50 rounded-xl border-l-2 border-gray-200">
                                    <p class="text-[10px] text-gray-500 font-medium leading-relaxed uppercase tracking-tight italic">"<?php echo e($payment->notes); ?>"</p>
                                </div>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-50 flex justify-between items-center text-[9px] font-black text-gray-300 uppercase tracking-widest italic group-hover:text-gray-400 transition-colors">
                                <span>PIC: <?php echo e($payment->pic->name ?? 'SYSTEM'); ?></span>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->sisa_tagihan <= 0 && $order->payments->count() > 0): ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\finance\payment-history-export.blade.php ENDPATH**/ ?>