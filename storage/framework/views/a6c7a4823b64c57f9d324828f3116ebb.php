...
<div id="handoverModal" class="hidden fixed inset-0 bg-gray-900/80 backdrop-blur-md overflow-y-auto h-full w-full z-[100] transition-all duration-300">
    <div class="relative top-10 mx-auto p-0 border-0 w-full max-w-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2.5rem] bg-white mb-20 overflow-hidden">
        ...
        <div class="p-10">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->spk && count($lead->spk->items ?? []) > 0): ?>
                <form action="<?php echo e(route('cs.spk.hand-to-workshop', $lead->spk->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-10">
                    <?php echo csrf_field(); ?>
                    <div class="p-6 bg-[#22AF85]/5 border-2 border-dashed border-[#22AF85]/20 rounded-3xl">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-[#22AF85] font-black uppercase tracking-widest">Converting <?php echo e(count($lead->spk->items ?? [])); ?> SPK Items into Work Orders</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bg-gray-50/50 rounded-[2.5rem] p-8 border-2 border-gray-100 group">
                                <div class="flex justify-between items-start mb-8 pb-6 border-b border-gray-100">
                                    <div class="flex items-center gap-5">
                                        <div class="text-4xl bg-white w-16 h-16 rounded-2xl flex items-center justify-center shadow-sm border border-gray-100"><?php echo e($spkItem->category_icon); ?></div>
                                        <div>
                                            <h5 class="text-xl font-black text-gray-900">Item #<?php echo e($spkItem->item_number); ?></h5>
                                            <p class="text-[10px] text-[#22AF85] font-black uppercase tracking-widest mt-1"><?php echo e($spkItem->category); ?> | <?php echo e($spkItem->shoe_brand ?: 'Generic'); ?></p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-[9px] text-gray-400 font-black uppercase tracking-widest mb-1">Item Value</p>
                                        <p class="text-lg font-black text-gray-900">Rp <?php echo e(number_format($spkItem->item_total_price, 0, ',', '.')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <input type="text" name="items[<?php echo e($spkItem->id); ?>][shoe_brand]" value="<?php echo e($spkItem->shoe_brand); ?>" placeholder="Merk"
                                            ...
                                            <input type="text" name="items[<?php echo e($spkItem->id); ?>][shoe_type]" value="<?php echo e($spkItem->shoe_type); ?>" placeholder="Tipe"
                                                   class="px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-bold text-gray-900 bg-white shadow-sm transition-all focus:bg-white">
                                            <input type="text" name="items[<?php echo e($spkItem->id); ?>][shoe_color]" value="<?php echo e($spkItem->shoe_color); ?>" placeholder="Warna"
                                                   class="px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-bold text-gray-900 bg-white shadow-sm transition-all focus:bg-white">
                                            <input type="text" name="items[<?php echo e($spkItem->id); ?>][shoe_size]" value="<?php echo e($spkItem->shoe_size); ?>" placeholder="Ukuran"
                                                   class="px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-bold text-gray-900 bg-white shadow-sm transition-all focus:bg-white">
                                        </div>
                                        <div class="pt-4" x-data="refPhotoUploader('handover_<?php echo e($spkItem->id); ?>')">
                                            ...
                                            <div class="border-2 border-dashed border-gray-200 rounded-2xl p-4 hover:border-[#22AF85]/40 transition-colors bg-gray-50/50"
                                                ...
                                                <input type="file" name="items[<?php echo e($spkItem->id); ?>][ref_photos][]" accept="image/*" multiple
                                                       x-ref="fileInput" @change="addFiles($event.target.files)"
                                                       class="hidden" :id="'ref-photos-' + id">
                                                <input type="hidden" :name="'items[' + <?php echo e($spkItem->id); ?> + '][cover_index]'" :value="coverIndex">
                                                <input type="hidden" :name="'items[' + <?php echo e($spkItem->id); ?> + '][ref_index]'" :value="refIndex">
                                    ...
                                    <div class="p-6 bg-white rounded-3xl border border-gray-100 shadow-sm space-y-4">
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            <span class="text-[9px] font-black text-[#22AF85] uppercase tracking-widest"><?php echo e(count($spkItem->services ?? [])); ?> Services</span>
                                        </div>
                                        <div class="space-y-3 max-h-[200px] overflow-y-auto custom-scrollbar">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($spkItem->services ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    ...
                                                    <div class="flex items-start justify-between gap-3">
                                                        <div class="flex-1">
                                                            <div class="flex items-center gap-2 mb-1">
                                                                ...
                                                                <span class="text-[11px] font-black text-gray-900 uppercase tracking-wide"><?php echo e($service['name']); ?></span>
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($service['is_custom'])): ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($service['manual_detail']) || !empty($service['description'])): ?>
                                                                <p class="text-[10px] text-gray-500 font-medium pl-3.5 italic leading-relaxed">
                                                                    "<?php echo e($service['manual_detail'] ?? $service['description'] ?? ''); ?>"
                                                                </p>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </div>
                                                        <div class="text-right flex-shrink-0">
                                                            <span class="text-xs font-black text-[#22AF85]">Rp <?php echo e(number_format($service['price'] ?? 0, 0, ',', '.')); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="pt-4 border-t border-dashed border-gray-200 flex justify-between items-center">
                                            ...
                                            <span class="text-sm font-black text-gray-900">Rp <?php echo e(number_format($serviceSubtotal, 0, ',', '.')); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="items[<?php echo e($spkItem->id); ?>][item_type]" value="<?php echo e($spkItem->category_prefix); ?>">
                                <input type="hidden" name="items[<?php echo e($spkItem->id); ?>][spk_item_id]" value="<?php echo e($spkItem->id); ?>">
                            </div>
                        ...
                        <div class="p-8 bg-gray-900 rounded-[2.5rem] shadow-2xl text-white">
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <h4 class="text-3xl font-black tracking-tighter">Rp <?php echo e(number_format($lead->spk->total_price, 0, ',', '.')); ?></h4>
                                </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\modals\handover.blade.php ENDPATH**/ ?>