        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('Customer Service Greeting')); ?>
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('cs.greeting.template')); ?>" 
    ...
    <div class="py-12" x-data="greetingManager()">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 dark:border-gray-700 mb-6">
                <form action="<?php echo e(route('cs.greeting.index')); ?>" method="GET" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Cari Nomor</label>
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="812..." 
                        ...
                        <div>
                            ...
                            <select name="cs_id" class="w-full rounded-xl border-gray-200 focus:border-red-400 focus:ring-red-400 text-sm">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $csUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($user->id); ?>" <?php echo e(request('cs_id') == $user->id ? 'selected' : ''); ?>>
                    ...
                    <div class="mt-4 flex flex-col md:flex-row md:items-center justify-between space-y-3 md:space-y-0">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="<?php echo e(route('cs.greeting.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-xl font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Reset
                            </a>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search', 'cs_id', 'start_date', 'end_date'])): ?>
                            <button type="button" @click="confirmDeleteFiltered" 
                                ...
                                Hapus Semua Hasil Filter (<?php echo e($greetings->count()); ?>)
                            </button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </form>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $greetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $greeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                                        <td class="py-4 px-4">
                                            <input type="checkbox" 
                                                   value="<?php echo e($greeting->id); ?>" 
                                                   x-model="selectedIds"
                                                   class="rounded border-gray-300 text-red-600 focus:ring-red-500">
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex flex-col">
                                                <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">
                                                    <?php echo e($greeting->first_contact_at->format('d M Y')); ?>

                                                </span>
                                                <span class="text-xs text-gray-400">
                                                    <?php echo e($greeting->first_contact_at->format('H:i')); ?>
                                        ...
                                        <td class="py-4 px-4">
                                            <span class="text-sm font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-gray-600 dark:text-gray-400">
                                                <?php echo e($greeting->customer_phone); ?>

                                            </span>
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex items-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($greeting->cs): ?>
                                                    <div class="flex-shrink-0 h-8 w-8 rounded-full bg-red-100 flex items-center justify-center mr-3">
                                                        <span class="text-red-600 font-bold text-xs"><?php echo e(substr($greeting->cs->name, 0, 1)); ?></span>
                                                    </div>
                                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                        <?php echo e($greeting->cs->name); ?>
                                        ...
                                        <td class="py-4 px-4">
                                            <span class="px-3 py-1 text-xs font-bold rounded-full <?php echo e($greeting->status_badge_class); ?>">
                                                <?php echo e($greeting->status); ?>

                                            </span>
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex items-center justify-end space-x-3">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$greeting->cs_id): ?>
                                                    <button @click="claimLead(<?php echo e($greeting->id); ?>)" 
                                                ...
                                                <?php else: ?>
                                                    <a href="<?php echo e($greeting->wa_greeting_link); ?>" target="_blank" class="p-2 text-green-600 hover:bg-green-50 rounded-xl transition duration-150" title="Kirim WA">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'import-modal','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'import-modal','focusable' => true]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

            <form action="<?php echo e(route('cs.greeting.import')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['class' => 'ml-3 !bg-red-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-3 !bg-red-600']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        function greetingManager() {
            return {
                ...
                async confirmBulkDelete() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('cs.greeting.bulk-delete')); ?>', {
                            method: 'DELETE',
                            headers: {
                ...
                async confirmDeleteFiltered() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('cs.greeting.bulk-delete-filtered')); ?>', {
                            method: 'DELETE',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                        ...
                        if (result.success) {
                            window.location.href = '<?php echo e(route('cs.greeting.index')); ?>';
                        } else {
                            alert(result.message || 'Gagal menghapus data.');
                        }
                    } catch (error) {
                ...
                async claimLead(id) {
                    ...
                    try {
                        let url = '<?php echo e(route('cs.greeting.claim', ['lead' => ':id'])); ?>';
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\cs\greeting\index.blade.php ENDPATH**/ ?>