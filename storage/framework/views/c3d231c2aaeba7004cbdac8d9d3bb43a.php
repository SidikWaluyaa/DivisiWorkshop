    ...
    <div class="page-container shadow-2xl">
        ...
        <header class="h-24 bg-teal-700 flex items-center justify-between px-[20mm] relative shrink-0">
            <div class="flex items-center gap-3">
                ...
                <img src="<?php echo e(asset('images/logo-white.png')); ?>" class="h-10 w-auto" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'">
            ...
            <div class="grid grid-cols-12 gap-6 shrink-0">
                ...
                <div class="col-span-5">
                    <div class="aspect-[4/5] bg-gray-100 rounded-xl overflow-hidden border-2 border-gray-200 relative">
                         <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->photos->where('step', 'WAREHOUSE_BEFORE')->count() > 0): ?>
                            <img src="<?php echo e($order->photos->where('step', 'WAREHOUSE_BEFORE')->first()->photo_url); ?>" class="w-full h-full object-cover">
                        <?php elseif($order->photos->count() > 0): ?>
                            <img src="<?php echo e($order->photos->first()->photo_url); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                        ...
                        <div class="absolute bottom-3 right-3 bg-white border-2 border-teal-600 rounded flex flex-col items-center justify-center w-10 h-10 shadow-lg">
                            ...
                            <span class="text-lg font-black text-gray-900 leading-none"><?php echo e($order->shoe_size); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-4 space-y-2">
                    <div class="bg-gray-50 px-2.5 py-2 rounded border border-gray-100">
                        ...
                        <p class="text-xs font-bold text-gray-900"><?php echo e($order->spk_number); ?></p>
                    </div>
                    <div class="bg-gray-50 px-2.5 py-2 rounded border border-gray-100">
                        <p class="text-[9px] font-bold text-gray-400 uppercase">Nama Customer</p>
                        <p class="text-xs font-bold text-gray-900"><?php echo e($order->customer_name); ?></p>
                    </div>
                    ...
                    <div class="bg-gray-50 px-2.5 py-2 rounded border border-gray-100 flex justify-between items-center">
                        ...
                        <span class="text-[10px] font-black <?php echo e($order->csLead->channel === 'ONLINE' ? 'text-blue-600 bg-blue-50' : 'text-emerald-600 bg-emerald-50'); ?> px-2 py-0.5 rounded border border-current">
                ...
                <div class="col-span-3 pt-1">
                     ...
                     <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-3.5 h-3.5 border border-gray-400 rounded-sm flex items-center justify-center <?php echo e(in_array($acc->accessories_insole, ['Simpan', 'S']) ? 'bg-teal-600 border-teal-600' : 'bg-white'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($acc->accessories_insole, ['Simpan', 'S'])): ?> <svg class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[9px] font-bold text-gray-600">Insole (Simpan)</span>
                        </div>
                        
                        <div class="flex items-center gap-2">
                            <div class="w-3.5 h-3.5 border border-gray-400 rounded-sm flex items-center justify-center <?php echo e(in_array($acc->accessories_insole, ['Nempel', 'N']) ? 'bg-teal-600 border-teal-600' : 'bg-white'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($acc->accessories_insole, ['Nempel', 'N'])): ?> <svg class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[9px] font-bold text-gray-600">Insole (Nempel)</span>
                        </div>
                        
                        <div class="flex items-center gap-2">
                            <div class="w-3.5 h-3.5 border border-gray-400 rounded-sm flex items-center justify-center <?php echo e(in_array($acc->accessories_tali, ['Simpan', 'S']) ? 'bg-teal-600 border-teal-600' : 'bg-white'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($acc->accessories_tali, ['Simpan', 'S'])): ?> <svg class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[9px] font-bold text-gray-600">Tali (Simpan)</span>
                        </div>
                        
                        <div class="flex items-center gap-2">
                            <div class="w-3.5 h-3.5 border border-gray-400 rounded-sm flex items-center justify-center <?php echo e(in_array($acc->accessories_box, ['Simpan', 'S']) ? 'bg-teal-600 border-teal-600' : 'bg-white'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($acc->accessories_box, ['Simpan', 'S'])): ?> <svg class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[9px] font-bold text-gray-600">Box Sepatu</span>
                        </div>
                         
                         <div class="flex items-center gap-2">
                             <div class="w-3.5 h-3.5 border border-gray-400 rounded-sm flex items-center justify-center <?php echo e(($acc->accessories_other && $acc->accessories_other != 'Tidak Ada') ? 'bg-teal-600 border-teal-600' : 'bg-white'); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($acc->accessories_other && $acc->accessories_other != 'Tidak Ada'): ?> <svg class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                             </div>
                             <span class="text-[9px] font-bold text-gray-600 border-b border-gray-300 w-16 pb-px leading-none truncate block h-3">
                                <?php echo e(($acc->accessories_other && $acc->accessories_other != 'Tidak Ada') ? $acc->accessories_other : ''); ?>
                             ...
                             <div class="flex-1">
                                 ...
                                 <p class="font-medium text-gray-800 leading-snug">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($service->service_details)): ?>
                                        <?php echo e(implode(', ', array_map(function($k, $v) { return "$k: $v"; }, array_keys($service->service_details), $service->service_details))); ?>
                    ...
                    <div class="w-[40%] flex flex-col">
                        <div class="bg-gray-50 rounded p-2 border border-gray-200 flex-1 relative">
                            ...
                            <p class="text-[10px] font-bold text-gray-900 leading-snug mt-1">
                                <?php echo e($order->technician_notes ?? $order->notes ?? '-'); ?>

                            </p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->priority == 'High'): ?>
                    ...
                    <div class="w-[30%] flex flex-col gap-2">
                        <div class="border border-gray-200 rounded p-1.5 space-y-1 bg-gray-50">
                            <div class="flex justify-between items-center text-[9px]">
                                ...
                                <span class="font-black text-gray-900"><?php echo e($order->created_at->format('d/m/y')); ?></span>
                            </div>
                             <div class="flex justify-between items-center text-[9px] border-t border-gray-200 pt-1">
                                ...
                                <span class="font-black text-gray-900"><?php echo e($order->estimation_date ? \Carbon\Carbon::parse($order->estimation_date)->format('d/m/y') : '-'); ?></span>
                            </div>
                             <div class="flex justify-between items-center text-[9px] border-t border-gray-200 pt-1">
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\assessment\print-spk-a4.blade.php ENDPATH**/ ?>