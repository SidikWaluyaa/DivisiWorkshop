...
<div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 overflow-hidden border border-gray-100">
    ...
    <div class="p-8 space-y-5">
        <div class="group">
            ...
            <p class="text-gray-900 font-bold text-lg leading-tight"><?php echo e($lead->customer_name ?? '-'); ?></p>
        </div>
        <div class="group">
            <label class="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1 block">Kontak Telepon</label>
            <div class="flex items-center gap-3">
                <p class="text-gray-900 font-bold text-lg leading-tight"><?php echo e($lead->customer_phone); ?></p>
                <a href="<?php echo e($lead->wa_greeting_link); ?>" target="_blank" class="text-[#22AF85] hover:bg-[#22AF85] hover:text-white font-black text-[10px] uppercase tracking-widest flex items-center gap-2 border-2 border-[#22AF85]/20 bg-[#22AF85]/5 px-4 py-1.5 rounded-xl transition">
                    WhatsApp
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="group">
                ...
                <p class="text-gray-900 font-bold">📱 <?php echo e($lead->source); ?></p>
            </div>
            <div class="group">
                <label class="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1 block">Tipe Channel</label>
                <span class="inline-block px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest <?php echo e($lead->channel === 'ONLINE' ? 'bg-[#22AF85]/10 text-[#22AF85]' : 'bg-[#FFC232]/10 text-[#FFC232]'); ?>">
                    <?php echo e($lead->channel); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\customer-info.blade.php ENDPATH**/ ?>