        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                <h2 class="font-bold text-xl leading-tight tracking-wide">
                    <?php echo e(__('Material Validation')); ?>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-8">
                ...
                <div class="dashboard-card-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo e($order->customer_name); ?></p>
                        </div>
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">No. Telepon</label>
                            <p class="text-lg font-mono font-bold text-teal-600"><?php echo e($order->customer_phone ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">Email</label>
                            <p class="text-sm font-medium text-gray-700"><?php echo e($order->customer_email ?? '-'); ?></p>
                        </div>
                        <div class="md:col-span-2">
                            <label class="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">Alamat</label>
                            <p class="text-sm text-gray-700"><?php echo e($order->customer_address ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">Sepatu</label>
                            <p class="text-sm font-bold text-gray-800"><?php echo e($order->shoe_brand); ?> - <?php echo e($order->shoe_type); ?></p>
                            <p class="text-xs text-gray-500">Warna: <?php echo e($order->shoe_color); ?> | Size: <?php echo e($order->shoe_size ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1">Prioritas</label>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold 
                                <?php echo e($order->priority === 'urgent' ? 'bg-red-100 text-red-800' : ''); ?>

                                <?php echo e($order->priority === 'high' ? 'bg-orange-100 text-orange-800' : ''); ?>

                                <?php echo e($order->priority === 'normal' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                <?php echo e($order->priority === 'low' ? 'bg-gray-100 text-gray-800' : ''); ?>">
                                <?php echo e(strtoupper($order->priority ?? 'NORMAL')); ?>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $order->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border-2 
                                        <?php echo e(stripos($service->category, 'Sol') !== false ? 'bg-orange-50 text-orange-700 border-orange-200' : ''); ?>

                                        <?php echo e(stripos($service->category, 'Upper') !== false ? 'bg-purple-50 text-purple-700 border-purple-200' : ''); ?>

                                        <?php echo e(stripos($service->category, 'Repaint') !== false ? 'bg-pink-50 text-pink-700 border-pink-200' : ''); ?>

                                        <?php echo e(stripos($service->category, 'Cleaning') !== false || stripos($service->category, 'Treatment') !== false ? 'bg-teal-50 text-teal-700 border-teal-200' : ''); ?>

                                        <?php echo e(!stripos($service->category, 'Sol') && !stripos($service->category, 'Upper') && !stripos($service->category, 'Repaint') && !stripos($service->category, 'Cleaning') && !stripos($service->category, 'Treatment') ? 'bg-blue-50 text-blue-700 border-blue-200' : ''); ?>">
                                        <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <?php echo e($service->name); ?>

                                        <span class="ml-2 opacity-60 text-[10px]">(<?php echo e($service->category); ?>)</span>
                                    </span>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->photos && $order->photos->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 space-y-6" x-data="sortirMaterialCart()">
                    ...
                    <form action="<?php echo e(route('sortir.update-materials', $order->id)); ?>" method="POST" id="materialForm">
                        <?php echo csrf_field(); ?>
                        <div class="dashboard-card overflow-hidden">
                            ...
                            <div class="dashboard-card-body p-0">
                                <div x-show="selectedMaterials.length === 0" class="p-8 text-center bg-gray-50/50">
                                    ...
                                    <a href="<?php echo e(route('materials.selection.create', $order->id)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-premium-green text-premium-green rounded-xl text-xs font-bold hover:bg-green-50 transition-all">
                ...
                <script>
                    function sortirMaterialCart() {
                        return {
                            selectedMaterials: [
                                <?php $__currentLoopData = $order->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                {
                                    material_id: <?php echo e($m->id); ?>,
                                    name: '<?php echo e($m->name); ?>',
                                    sub_category: '<?php echo e($m->sub_category ?? $m->type); ?>',
                                    quantity: <?php echo e($m->pivot->quantity); ?>,
                                    status: '<?php echo e($m->pivot->status); ?>',
                                    stock_available: <?php echo e($m->stock); ?>

                                },
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ],
                            upperMaterials: <?php echo json_encode($upperOptions, 15, 512) ?>,
                            solMaterials: <?php echo json_encode($solOptions, 15, 512) ?>,
                            otherMaterials: <?php echo json_encode($otherOptions, 15, 512) ?>,
                            searchUpper: '',
                            searchSol: '',
                            searchOther: '',
                            showModal: false,
                            ...
                            activeTab: '<?php echo e($suggestedTab); ?>',
                            form: {
                                upperId: '',
                                upperQty: 1,
                                solId: '',
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6 p-1 bg-gray-50 rounded-2xl border border-gray-100">
                                <button type="button" 
                                    ...
                                    Upper (<?php echo e(count($upperOptions)); ?>)
                                </button>
                                <button type="button" 
                                    @click="activeTab = 'sol'" 
                                    ...
                                    class="flex-1 min-w-[120px] py-3 px-4 rounded-xl text-sm font-bold transition-all border-2 flex items-center justify-center gap-2">
                                    Sol (<?php echo e(count($solOptions)); ?>)
                                </button>
                                <button type="button" 
                                    ...
                                    class="flex-1 min-w-[120px] py-3 px-4 rounded-xl text-sm font-bold transition-all border-2 flex items-center justify-center gap-2">
                                    Lainnya (<?php echo e(count($otherOptions)); ?>)
                                </button>
                            </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden h-full">
                        ...
                        <div class="p-4 bg-gray-50 h-[400px] overflow-y-auto custom-scrollbar">
                            <div class="space-y-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $upperMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-100 hover:border-teal-200 transition-colors shadow-sm group">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-medium text-gray-700 group-hover:text-teal-700 transition-colors"><?php echo e($stock->name); ?></span>
                                        </div>
                                        <span class="text-xs font-mono font-bold px-2 py-1 rounded <?php echo e($stock->stock > 0 ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'); ?>">
                                            <?php echo e($stock->stock); ?> <?php echo e($stock->unit); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $solMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-100 hover:border-teal-200 transition-colors shadow-sm group">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-medium text-gray-700 group-hover:text-teal-700 transition-colors"><?php echo e($stock->name); ?></span>
                                            <span class="text-[10px] text-gray-400"><?php echo e($stock->size ? 'Size: '.$stock->size : $stock->sub_category); ?></span>
                                        </div>
                                        <span class="text-xs font-mono font-bold px-2 py-1 rounded <?php echo e($stock->stock > 0 ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'); ?>">
            ...
            <div class="mt-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->materials->where('pivot.status', 'REQUESTED')->count() > 0): ?>
                ...
                <?php else: ?>
                    ...
                    <form id="sortir-finish-form" action="<?php echo e(route('sortir.finish', $order->id)); ?>" method="POST" class="w-full">
                        <?php echo csrf_field(); ?>
                        <div class="dashboard-card overflow-hidden">
                            ...
                            <div class="dashboard-card-body p-6 sm:p-8">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSol || $hasUpper): ?>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSol): ?>
                                        <div class="space-y-3">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasUpper): ?>
                                        <div class="space-y-3">
                                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest pl-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array(auth()->user()->role, ['admin', 'owner', 'production_manager'])): ?>
                            <form id="bypass-form-hidden" action="<?php echo e(route('sortir.skip-production', $order->id)); ?>" method="POST" class="hidden">
                                <?php echo csrf_field(); ?>
                            </form>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex justify-start border-t border-gray-200 pt-6 mt-8" x-data="{ openUpsell: false, isSubmitting: false }">
                ...
                <div x-show="openUpsell" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm" style="display: none;">
                    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 relative" @click.away="openUpsell = false">
                        ...
                        <form action="<?php echo e(route('sortir.add-service', $order->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-5" x-data="{ 
                                selectedServiceId: '', 
                                customCategory: '',
                                services: <?php echo e(\App\Models\Service::orderBy('name')->get()->map(fn($s) => ['id' => $s->id, 'price' => $s->price, 'category' => $s->category])); ?>,
                                categories: <?php echo e(\App\Models\Service::select('category')->distinct()->orderBy('category')->pluck('category')); ?>
                                ...
                                <label class="block text-sm font-bold text-gray-700 mb-2">Pilih Layanan Tambahan</label>
                                    <select x-model="selectedServiceId" class="block w-full rounded-xl border-gray-200 shadow-sm focus:border-premium-green focus:ring-0 py-2.5" required>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Service::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <option value="<?php echo e($service->id); ?>"><?php echo e($service->name); ?> (<?php echo e($service->category); ?>)</option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\sortir\show.blade.php ENDPATH**/ ?>