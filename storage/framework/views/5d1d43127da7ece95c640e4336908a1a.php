    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-6 bg-gradient-to-r from-teal-500 via-teal-600 to-orange-500 text-white flex justify-between items-center">
                    <h3 class="text-xl font-black flex items-center gap-2">
                        ...
                        Detail Keluhan #<?php echo e($complaint->id); ?>

                    </h3>
                    <a href="<?php echo e(route('admin.complaints.index')); ?>" class="px-3 py-1.5 bg-white/20 hover:bg-white/30 text-white text-xs font-bold rounded-lg transition-colors flex items-center gap-1">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        ?>
                        <div class="bg-gradient-to-br <?php echo e($catConfig['bg']); ?> p-4 rounded-xl text-white shadow-lg">
                            ...
                            <p class="font-black text-lg flex items-center gap-2">
                                <span class="text-2xl"><?php echo e($catConfig['icon']); ?></span>
                                <?php echo e($catConfig['label']); ?>
                        ...
                        <div class="bg-gradient-to-br from-teal-400 to-teal-500 p-4 rounded-xl text-white shadow-lg">
                            ...
                            <p class="font-black text-lg"><?php echo e($complaint->created_at->format('d M Y')); ?></p>
                            <p class="text-xs opacity-90"><?php echo e($complaint->created_at->format('H:i:s')); ?></p>
                        </div>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complaint->photos): ?>
                        <div>
                            <p class="text-xs text-gray-500 font-bold uppercase tracking-wider mb-3">Bukti Foto</p>
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $complaint->photo_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <a href="<?php echo e($photoUrl); ?>" target="_blank" class="block group relative rounded-xl overflow-hidden border-2 border-gray-200 aspect-square hover:border-teal-500 transition-all hover:shadow-lg">
                                        <img src="<?php echo e($photoUrl); ?>" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" alt="Bukti Foto">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-6 bg-gradient-to-r from-teal-500 to-orange-500 text-white">
                    <h3 class="text-xl font-black flex items-center gap-2">
                        ...
                        Info Pesanan: <?php echo e($complaint->workOrder->spk_number); ?>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                        <div class="bg-gray-50 p-3 rounded-lg">
                            ...
                            <p class="font-bold text-gray-900"><?php echo e($complaint->workOrder->customer_name); ?></p>
                            <p class="text-xs text-gray-500 mt-1"><?php echo e($complaint->customer_phone); ?></p>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <p class="text-gray-500 text-xs font-bold uppercase mb-1">Sepatu</p>
                            <p class="font-bold text-gray-900"><?php echo e($complaint->workOrder->shoe_brand); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($complaint->workOrder->shoe_color); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $complaint->workOrder->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        ...
                        <div class="space-y-2">
                             ...
                             <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complaint->workOrder->technicianProduction): ?>
                                <div class="flex items-center bg-gradient-to-r from-orange-50 to-orange-100 p-2 rounded-lg border border-orange-200">
                                    <div class="h-8 w-8 rounded-full bg-orange-500 flex items-center justify-center text-white font-black text-xs mr-3 shadow-sm">
                                        <?php echo e(substr($complaint->workOrder->technicianProduction->name, 0, 2)); ?>

                                    </div>
                                    <div>
                                        <p class="text-xs text-orange-700 font-bold uppercase">Teknisi Utama</p>
                                        <p class="text-sm font-bold text-orange-900"><?php echo e($complaint->workOrder->technicianProduction->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complaint->workOrder->prodSolBy): ?>
                                <div class="flex items-center bg-gray-50 p-2 rounded-lg border border-gray-200">
                                    <div class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center text-white font-bold text-xs mr-3">
                                        <?php echo e(substr($complaint->workOrder->prodSolBy->name, 0, 2)); ?>

                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-bold uppercase">Sol</p>
                                        <p class="text-sm font-medium text-gray-700"><?php echo e($complaint->workOrder->prodSolBy->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complaint->workOrder->prodUpperBy): ?>
                                <div class="flex items-center bg-gray-50 p-2 rounded-lg border border-gray-200">
                                    <div class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center text-white font-bold text-xs mr-3">
                                        <?php echo e(substr($complaint->workOrder->prodUpperBy->name, 0, 2)); ?>

                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-bold uppercase">Upper</p>
                                        <p class="text-sm font-medium text-gray-700"><?php echo e($complaint->workOrder->prodUpperBy->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($complaint->workOrder->prodCleaningBy): ?>
                                <div class="flex items-center bg-gray-50 p-2 rounded-lg border border-gray-200">
                                    <div class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center text-white font-bold text-xs mr-3">
                                        <?php echo e(substr($complaint->workOrder->prodCleaningBy->name, 0, 2)); ?>

                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-bold uppercase">Cleaning/Treatment</p>
                                        <p class="text-sm font-medium text-gray-700"><?php echo e($complaint->workOrder->prodCleaningBy->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$complaint->workOrder->technicianProduction && !$complaint->workOrder->prodSolBy && !$complaint->workOrder->prodUpperBy && !$complaint->workOrder->prodCleaningBy): ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                ...
                <form action="<?php echo e(route('admin.complaints.update', $complaint)); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statusStyles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <label class="cursor-pointer relative">
                                <input type="radio" name="status" value="<?php echo e($status); ?>" class="peer sr-only" <?php echo e($complaint->status == $status ? 'checked' : ''); ?>>
                                <div class="px-3 py-2.5 rounded-xl border-2 <?php echo e($style['bg']); ?> <?php echo e($style['text']); ?> <?php echo e($style['border']); ?> text-xs font-bold text-center peer-checked:ring-2 peer-checked:ring-offset-2 peer-checked:<?php echo e($style['ring']); ?> transition-all opacity-60 peer-checked:opacity-100 hover:opacity-80 peer-checked:shadow-md flex items-center justify-center gap-1.5">
                                    <span><?php echo e($style['icon']); ?></span>
                                    <?php echo e($status); ?>
                    ...
                    <div>
                        ...
                        <textarea name="admin_notes" rows="3" class="w-full text-sm border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-gray-50" placeholder="Tambahkan catatan internal..."><?php echo e($complaint->admin_notes); ?></textarea>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-100">
                    <form action="<?php echo e(route('admin.complaints.destroy', $complaint)); ?>" method="POST" onsubmit="return confirmDelete(event)">
                        <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.complaints.api_reply', $complaint)); ?>" method="POST" id="reply_form" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white/80 rounded-2xl p-4 border border-gray-100 shadow-inner min-h-[100px] relative overflow-hidden flex flex-col justify-end">
                            <div id="chat_preview_bubble" class="self-start bg-gray-100 rounded-2xl rounded-bl-none p-3 max-w-[85%] transform transition-all duration-300 translate-y-2 opacity-0">
                                ...
                                <p class="text-xs text-gray-600 leading-relaxed font-medium"><?php echo e($complaint->description); ?></p>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <a id="wa_primary_btn" href="https://wa.me/<?php echo e($phone); ?>" target="_blank" class="col-span-2 flex items-center justify-center py-3 px-4 rounded-2xl text-sm font-black text-white bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 shadow-lg hover:shadow-xl transition-all group border-b-4 border-teal-700 active:border-b-0 active:translate-y-1">
                ...
                function updatePreview() {
                    ...
                    let baseWaUrl = "https://wa.me/<?php echo e($phone); ?>?text=";
                    ...
                    if (input.trim() !== "") {
                        ...
                        waBtn.href = "https://wa.me/<?php echo e($phone); ?>";
                    }
                }
                ...
                function setReply(type) {
                    ...
                    let text = "";
                    let name = "<?php echo e($complaint->customer_name); ?>";
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\complaints\show.blade.php ENDPATH**/ ?>