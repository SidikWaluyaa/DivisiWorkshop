            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="font-black text-2xl text-gray-900 leading-tight tracking-tight uppercase">
                        <?php echo e(__('Lost Leads')); ?>

                    </h2>
                    <p class="text-xs font-bold text-gray-500 tracking-widest uppercase opacity-70">Data Lead Gagal Closing</p>
                </div>
            </div>
            <a href="<?php echo e(route('cs.dashboard')); ?>" class="bg-gray-100 text-gray-600 px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest shadow-sm hover:bg-gray-200 transition">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
                <div class="p-8 border-b border-gray-50 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <form action="<?php echo e(route('cs.leads.lost')); ?>" method="GET" class="flex-1 max-w-md relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari Nama/HP..." class="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-red-500 font-bold transition-all">
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        <div class="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-red-500 font-black text-xs">
                                            <?php echo e(substr($lead->customer_name ?? 'C', 0, 1)); ?>

                                        </div>
                                        <div>
                                            <div class="font-black text-gray-900"><?php echo e($lead->customer_name ?? 'No Name'); ?></div>
                                            <div class="text-[10px] font-bold text-gray-400"><?php echo e($lead->customer_phone); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="text-sm font-bold text-red-600 italic">"<?php echo e($lead->lost_reason ?? 'Tidak ada alasan dicatat'); ?>"</div>
                                    <div class="text-[9px] text-gray-400 mt-1 uppercase font-black">Source: <?php echo e($lead->source); ?></div>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="text-sm font-bold text-gray-700"><?php echo e($lead->cs->name ?? 'System'); ?></div>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="text-sm font-bold text-gray-900"><?php echo e($lead->updated_at->format('d M Y')); ?></div>
                                    <div class="text-[10px] text-gray-400 font-bold"><?php echo e($lead->updated_at->diffForHumans()); ?></div>
                                </td>
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="<?php echo e(route('cs.leads.show', $lead->id)); ?>" class="p-2 bg-gray-50 text-gray-400 hover:bg-red-50 hover:text-red-500 rounded-xl transition shadow-sm">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                        </a>
                                        <form action="<?php echo e(route('cs.leads.destroy', $lead->id)); ?>" method="POST" onsubmit="return confirm('Hapus lead ini secara permanen?')">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\lost.blade.php ENDPATH**/ ?>