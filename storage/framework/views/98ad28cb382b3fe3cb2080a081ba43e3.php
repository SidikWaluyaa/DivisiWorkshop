    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-[600px]">
            <div class="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 sm:rounded-2xl sm:px-10 border border-slate-100">
                ...
                <form class="space-y-6" action="<?php echo e(route('complaints.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <select id="category" name="category" required 
                                ...
                                <option value="QUALITY" <?php echo e(old('category') == 'QUALITY' ? 'selected' : ''); ?>>Kualitas Pengerjaan (Kurang Bersih/Rapi/Kuat)</option>
                                <option value="DAMAGE" <?php echo e(old('category') == 'DAMAGE' ? 'selected' : ''); ?>>Kerusakan Barang (Sepatu Rusak/Luntur/Hilang)</option>
                                <option value="LATE" <?php echo e(old('category') == 'LATE' ? 'selected' : ''); ?>>Keterlambatan (Lewat Estimasi)</option>
                                <option value="SERVICE" <?php echo e(old('category') == 'SERVICE' ? 'selected' : ''); ?>>Pelayanan (Admin/Teknisi)</option>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="4" required 
                                class="block w-full appearance-none rounded-lg border border-slate-300 px-3 py-2 placeholder-slate-400 shadow-sm focus:border-teal-500 focus:outline-none focus:ring-teal-500 sm:text-sm transition-all duration-200"
                                placeholder="Jelaskan masalah secara detail agar kami bisa segera membantu..."><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
            ...
            <p class="mt-6 text-center text-xs text-slate-500">
                &copy; <?php echo e(date('Y')); ?> Solv Shoe Workshop. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\complaints\index.blade.php ENDPATH**/ ?>