...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="min-h-screen bg-white">
            ...
            <div class="max-w-7xl mx-auto px-6 py-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('finance.donations')); ?>" class="group relative inline-flex items-center gap-2.5 px-5 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-900 rounded-2xl font-bold shadow-sm border border-gray-200 transition-all hover:-translate-y-1">
                        ...
                        <form action="<?php echo e(route('finance.index')); ?>" method="GET" class="flex flex-wrap items-center gap-3">
                            <input type="hidden" name="tab" value="<?php echo e(request('tab', 'waiting_dp')); ?>">
                            ...
                            <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-2xl px-3 py-1 text-sm shadow-sm group hover:border-[#22AF85]/30 transition-all">
                                <div class="flex items-center gap-2">
                                    ...
                                    <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="bg-transparent border-none focus:ring-0 p-0 text-xs font-bold text-gray-700 w-28">
                                </div>
                                <div class="w-px h-4 bg-gray-200 mx-1"></div>
                                <div class="flex items-center gap-2">
                                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest italic pt-0.5">To</label>
                                    <input type="date" name="date_to" value="<?php echo e(request('date_to')); ?>" class="bg-transparent border-none focus:ring-0 p-0 text-xs font-bold text-gray-700 w-28">
                                </div>
                            </div>
                        ...
                        <div class="flex items-center gap-2 bg-white/50 p-1 rounded-2xl border border-gray-100 shadow-inner">
                            ...
                            ?>
                            <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => $today, 'date_to' => $today])); ?>" 
                               class="px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e(request('date_from') == $today && request('date_to') == $today ? 'bg-[#22AF85] text-white shadow-md' : 'text-gray-400 hover:bg-gray-100'); ?>">
                                Today
                            </a>
                            <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => $startOfWeek, 'date_to' => $today])); ?>" 
                               class="px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e(request('date_from') == $startOfWeek && request('date_to') == $today ? 'bg-[#22AF85] text-white shadow-md' : 'text-gray-400 hover:bg-gray-100'); ?>">
                                This Week
                            </a>
                            <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => $startOfMonth, 'date_to' => $today])); ?>" 
                               class="px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e(request('date_from') == $startOfMonth && request('date_to') == $today ? 'bg-[#22AF85] text-white shadow-md' : 'text-gray-400 hover:bg-gray-100'); ?>">
                                This Month
                            </a>
                            <a href="<?php echo e(route('finance.index', ['tab' => request('tab', 'waiting_dp')])); ?>" 
                        ...
                        <a href="<?php echo e(route('finance.invoices.create')); ?>" 
                           class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold shadow-lg shadow-blue-200 hover:shadow-blue-300 transition-all hover:-translate-y-1">
                        ...
                        <a href="<?php echo e(route('finance.export-excel', [
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-100/50 group hover:border-[#22AF85]/30 transition-all duration-500">
                    ...
                    <div class="flex items-baseline gap-2">
                        <div class="text-4xl font-black text-gray-900 tracking-tighter italic tabular-nums"><?php echo e($stats['total_today'] ?? 0); ?></div>
                ...
                <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-100/50 group hover:border-[#FFC232]/30 transition-all duration-500">
                    ...
                    <div class="flex items-baseline gap-2">
                        <div class="text-4xl font-black text-gray-900 tracking-tighter italic tabular-nums"><?php echo e($stats['pending_dp'] ?? 0); ?></div>
                ...
                <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-xl shadow-gray-100/50 group hover:border-blue-300 transition-all duration-500">
                    ...
                    <div class="flex items-baseline gap-2">
                        <div class="text-4xl font-black text-gray-900 tracking-tighter italic tabular-nums"><?php echo e($stats['ready_pickup'] ?? 0); ?></div>
                ...
                <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-6 shadow-2xl shadow-gray-900/20 group hover:scale-[1.02] transition-all duration-500 overflow-hidden relative">
                    ...
                    <div class="text-2xl font-black text-white tracking-tighter italic tabular-nums relative z-10">Rp <?php echo e(number_format($stats['revenue_today'] ?? 0, 0, ',', '.')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 -mt-8 relative z-40">
            <div class="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl p-2.5 flex gap-2.5 overflow-x-auto border border-white/20" x-data="{ activeTab: '<?php echo e(request('tab', 'waiting_dp')); ?>' }">

                <a href="<?php echo e(route('finance.index', ['tab' => 'waiting_dp'])); ?>" 
                ...
                <a href="<?php echo e(route('finance.index', ['tab' => 'in_progress'])); ?>" 
                ...
                <a href="<?php echo e(route('finance.index', ['tab' => 'ready_pickup'])); ?>" 
                ...
                <a href="<?php echo e(route('finance.index', ['tab' => 'completed'])); ?>" 
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                            ...
                            <div class="p-8 border-b border-gray-50 relative z-10 flex justify-between items-center">
                                <div>
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-2xl font-black text-gray-900 group-hover:tracking-wider transition-all leading-none tracking-tighter italic"><?php echo e($order->spk_number); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->invoice_id && $order->invoice): ?>
                                            <span class="text-[8px] font-black text-blue-600 uppercase tracking-widest mt-1 italic">Linked to: <?php echo e($order->invoice->invoice_number); ?></span>
                                ...
                                <div class="px-4 py-2 bg-white rounded-2xl border border-gray-100 shadow-sm text-[9px] font-black text-gray-400 uppercase tracking-widest italic group-hover:border-[#22AF85]/30 transition-all">
                                    <?php echo e($order->finance_entry_at ? $order->finance_entry_at->format('d M') : $order->created_at->format('d M')); ?>
                            ...
                            <div class="p-8 space-y-8 relative z-10">
                                <div class="flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xl font-black text-gray-900 leading-tight italic"><?php echo e($order->customer_name); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="p-5 bg-gray-50/80 rounded-3xl border border-gray-100 shadow-inner group-hover:bg-white transition-colors">
                                        ...
                                        <div class="inline-flex items-center gap-2.5 px-3 py-1.5 bg-white rounded-full border border-gray-100 shadow-sm">
                                            <span class="w-2 h-2 rounded-full <?php echo e($order->status === \App\Enums\WorkOrderStatus::SELESAI ? 'bg-[#22AF85] shadow-[0_0_8px_rgba(34,175,133,0.5)]' : 'bg-blue-500 animate-pulse'); ?>"></span>
                                            <span class="text-[9px] font-black uppercase text-gray-700 tracking-tight leading-none"><?php echo e(str_replace('_', ' ', $order->status->value)); ?></span>
                                        </div>
                                    </div>
                                    <div class="p-5 bg-gray-50/80 rounded-3xl border border-gray-100 text-right shadow-inner group-hover:bg-white transition-colors">
                                        ...
                                        <div class="text-lg font-black text-gray-900 tracking-tighter italic">Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            <span class="w-2 h-2 rounded-full" style="background-color: <?php echo e($statusColor); ?>"></span>
                                            <span class="text-[10px] font-black uppercase tracking-[0.2em] italic" style="color: <?php echo e($statusColor); ?>">
                                                <?php echo e($percent >= 100 ? 'PROTOCOL CLOSED' : ($percent > 0 ? 'DIBAYAR '.round($percent).'%' : 'WAITING DP')); ?>

                                            </span>
                                        </div>
                                        <span class="text-xs font-black text-gray-900 italic">Rp <?php echo e(number_format($order->total_paid, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="h-3 w-full bg-gray-100 rounded-full overflow-hidden shadow-inner p-[1.5px] border border-gray-50">
                                        <div class="h-full rounded-full transition-all duration-1000 ease-out shadow-sm relative overflow-hidden" 
                                             style="width: <?php echo e($percent); ?>%; background-color: <?php echo e($statusColor); ?>">
                                ...
                                <div class="flex gap-4 pt-4">
                                    <a href="<?php echo e(route('finance.show', $order->id)); ?>" 
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manageFinance', $order)): ?>
                                    <form action="<?php echo e(route('finance.destroy', $order->id)); ?>" method="POST" onsubmit="return confirm('Hapus data finance ini?');" class="shrink-0">
                                        <?php echo csrf_field(); ?>
                                ...
                                <tr class="hover:bg-gray-50/80 transition-all duration-500 group relative">
                                    ...
                                    <td class="px-4 py-6">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div class="font-black text-gray-500 group-hover:text-gray-900 transition-colors uppercase tracking-tight text-[11px] leading-none italic"><?php echo e($order->customer_name); ?></div>
                                            </div>
                                            <div class="text-[9px] text-gray-400 font-black uppercase tracking-widest flex items-center gap-1.5 italic opacity-60">
                                                ...
                                                <?php echo e($order->finance_entry_at ? $order->finance_entry_at->format('M d, Y - H:i') : $order->created_at->format('M d, Y - H:i')); ?>
                                    ...
                                    <td class="px-4 py-6">
                                        <div class="space-y-1 max-w-[200px]">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->workOrderServices->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ws): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <div class="text-[10px] font-bold text-gray-700 leading-tight truncate">
                                                    • <?php echo e($ws->custom_service_name ?? ($ws->service ? $ws->service->name : 'Layanan')); ?>

                                                </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->workOrderServices->count() > 2): ?>
                                                <div class="text-[9px] font-black text-[#22AF85] uppercase tracking-widest italic pt-1">
                                                    +<?php echo e($order->workOrderServices->count() - 2); ?> More Services
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-6 text-center">
                                        <div class="inline-flex items-center gap-2.5 px-4 py-2.5 bg-white rounded-2xl border border-gray-100 shadow-sm transition-all group-hover:scale-105 group-hover:border-[#22AF85]/20 group-hover:shadow-md">
                                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($order->status === \App\Enums\WorkOrderStatus::SELESAI ? 'bg-[#22AF85] shadow-[0_0_10px_rgba(34,175,133,0.5)]' : 'bg-blue-500 animate-pulse shadow-[0_0_10px_rgba(59,130,246,0.3)]'); ?>"></span>
                                            <span class="text-[9px] font-black uppercase text-gray-600 tracking-[0.15em] leading-none"><?php echo e(str_replace('_', ' ', $order->status->value)); ?></span>
                                        </div>
                                    </td>

                                    <td class="px-4 py-6 text-right">
                                        <div class="font-black text-gray-900 text-lg tracking-tighter group-hover:text-[#22AF85] transition-colors italic">Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?></div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->discount > 0): ?>
                                            <div class="inline-flex items-center gap-1 px-2 py-0.5 bg-rose-50 text-rose-500 rounded-lg text-[8px] font-black mt-1.5 uppercase tracking-widest border border-rose-100 italic">
                                                Disc -Rp <?php echo e(number_format($order->discount, 0, ',', '.')); ?>
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-1.5">
                                                    <span class="w-1.5 h-1.5 rounded-full" style="background-color: <?php echo e($statusColor); ?>"></span>
                                                    <span class="text-[9px] font-black uppercase tracking-widest italic" style="color: <?php echo e($statusColor); ?>">
                                                        <?php echo e($percent >= 100 ? 'SETTLED' : ($percent > 0 ? 'LIQUIDITY '.round($percent).'%' : 'WAITING DP')); ?>

                                                    </span>
                                                </div>
                                                <span class="text-[10px] font-black text-gray-400 group-hover:text-gray-900 transition-colors tabular-nums italic">Rp <?php echo e(number_format($order->total_paid, 0, ',', '.')); ?></span>
                                            </div>
                                    ...
                                    <td class="px-4 py-6 text-right">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->sisa_tagihan > 0): ?>
                                            <div class="flex flex-col items-end gap-1.5 group-hover:-translate-x-1 transition-transform">
                                                <span class="font-black text-[#FFC232] text-xl leading-none tracking-tighter italic">Rp <?php echo e(number_format($order->sisa_tagihan, 0, ',', '.')); ?></span>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($orders) && $orders instanceof \Illuminate\Pagination\LengthAwarePaginator && $orders->hasPages()): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\finance\index.blade.php ENDPATH**/ ?>