<script>
    ...
    function submitEditOrder(event) {
        ...
        fetch(`/reception/${orderId}/update-order`, {
            method: 'POST',
            headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'X-HTTP-Method-Override': 'PATCH', 'Accept': 'application/json' },
            body: formData
        })
        .then(response => response.json())
        .then(data => {
    ...
    function bulkDirectToPrep() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('<?php echo e(route('reception.bulk-skip-assessment')); ?>', {
                    method: 'POST',
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\reception\partials\scripts.blade.php ENDPATH**/ ?>