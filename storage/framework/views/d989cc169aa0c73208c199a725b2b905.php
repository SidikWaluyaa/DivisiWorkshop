...
<head>
    ...
    <title>Laporan Hasil - <?php echo e($workOrder->spk_number); ?> | ShoeWorkshop</title>
    <meta name="description" content="Laporan hasil pengerjaan sepatu untuk SPK <?php echo e($workOrder->spk_number); ?>">
    ...
    <main class="main-container" 
        ...
        <div class="spk-card animate-in delay-1">
            <div>
                ...
                <p class="spk-number"><?php echo e($workOrder->spk_number); ?></p>
            </div>
            <span class="status-badge"><?php echo e($workOrder->status->label()); ?></span>
        </div>
        ...
        <div class="info-card animate-in delay-2">
            ...
            <div class="info-row">
                ...
                <div>
                    ...
                    <p class="info-value"><?php echo e($workOrder->customer_name); ?></p>
                </div>
            </div>
            ...
            <div class="info-row">
                ...
                <div>
                    ...
                    <p class="info-value"><?php echo e($workOrder->shoe_brand ?: '-'); ?></p>
                </div>
            </div>
            ...
            <div class="info-row">
                ...
                <div style="flex:1;">
                    ...
                    <div class="service-tags">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $workOrder->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <span class="service-tag">
                                <?php echo e($service->custom_service_name ?? ($service->service->name ?? '-')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photos->count() > 0): ?>
                <div class="photo-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        ?>
                        <div class="photo-card" @click="open(<?php echo e($loop->index); ?>)">
                            <span class="photo-number"><?php echo e($loop->iteration); ?></span>
                            <div class="photo-wrapper">
                                <img src="<?php echo e($imgSrc); ?>" 
                                     alt="Foto Finish #<?php echo e($loop->iteration); ?>" 
                                     loading="lazy">
        ...
        <div class="cta-section animate-in delay-4">
            ...
            <a href="https://wa.me/62895339939800?text=<?php echo e(urlencode('Halo Admin ShoeWorkshop, saya ingin bertanya tentang SPK ' . $workOrder->spk_number)); ?>" 
               target="_blank" 
               class="wa-cta-btn">
        ...
        function photoLightbox() {
            return {
                ...
                photos: [
                    ...
                    {
                        src: "<?php echo e(str_starts_with($photo->file_path, 'http') ? $photo->file_path : asset('storage/' . $photo->file_path)); ?>",
                        alt: "Foto Finish #<?php echo e($loop->iteration); ?>",
                        caption: "<?php echo e($photo->caption ?: 'Dokumentasi Workshop'); ?>",
                        date: "<?php echo e($photo->created_at->format('d M Y • H:i')); ?>"
                    },
                ...
                getWhatsAppLink() {
                    ...
                    const spk = "<?php echo e($workOrder->spk_number); ?>";
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\customer\customer-report.blade.php ENDPATH**/ ?>