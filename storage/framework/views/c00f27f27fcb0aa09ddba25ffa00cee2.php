    ...
    <div class="min-h-screen bg-white pb-12">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div class="flex gap-3">
                        <div class="bg-[#22AF85]/5 border border-[#22AF85]/15 p-5 rounded-2xl min-w-[130px] text-center">
                            ...
                            <div class="text-3xl font-black text-gray-900"><?php echo e($issues->total()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-gray-100/80 border border-gray-100 p-5 mb-6 relative z-10">
                <form action="<?php echo e(route('cx.history')); ?>" method="GET" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        <div class="hidden lg:flex lg:col-span-4 xl:col-span-3 justify-end pointer-events-auto">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search', 'category', 'start_date', 'end_date'])): ?>
                                <a href="<?php echo e(route('cx.history')); ?>" class="px-5 py-3 bg-gray-50 hover:bg-gray-100 text-gray-400 font-bold rounded-xl transition-all flex items-center justify-center gap-2 border border-gray-100 group" title="Reset Filter">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4 pt-4 border-t border-gray-50">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['search', 'category', 'start_date', 'end_date'])): ?>
                            <div class="lg:hidden text-center pt-2">
                                <a href="<?php echo e(route('cx.history')); ?>" class="text-[10px] font-black text-gray-300 uppercase tracking-widest hover:text-red-400 transition-colors underline decoration-dotted">Hapus Filter</a>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </form>
            ...
            <div class="bg-white rounded-2xl shadow-lg shadow-gray-100/80 border border-gray-100 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $issues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    ...
                                    <td class="px-6 py-5 align-top">
                                        <div class="flex flex-col gap-1.5">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-[#22AF85]/10 text-[#22AF85] text-[10px] font-black border border-[#22AF85]/15 w-fit tracking-wide">
                                                <?php echo e($issue->workOrder->spk_number ?? $issue->spk_number); ?>

                                            </span>
                                            <div class="font-bold text-gray-800 text-sm capitalize leading-tight"><?php echo e($issue->workOrder->customer_name ?? $issue->customer_name); ?></div>
                                            <div class="text-[10px] text-gray-400 font-bold tracking-wider"><?php echo e($issue->workOrder->customer_phone ?? $issue->customer_phone); ?></div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5 align-top">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex items-center gap-2 mt-0.5">
                                                ...
                                                <span class="text-[9px] font-bold text-gray-500 bg-gray-50 px-2 py-0.5 rounded-md border border-gray-100"><?php echo e($issue->source); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-5 align-top">
                                        <div class="p-4 bg-[#22AF85]/[0.04] rounded-xl border border-[#22AF85]/10 relative overflow-hidden group-hover:bg-[#22AF85]/[0.07] transition-all">
                                            ...
                                            <div class="mb-3 flex flex-wrap gap-2">
                                                ...
                                                ?>
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[9px] font-black text-white uppercase tracking-widest <?php echo e($typeColor); ?> shadow-sm">
                                                    <?php echo e($typeLabel); ?>

                                                </span>
                                            </div>
                                            <p class="text-xs font-medium text-gray-700 leading-relaxed"><?php echo e($issue->resolution_notes ?: 'Tidak ada catatan resolusi detail.'); ?></p>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex flex-col gap-3">
                                            <div class="flex items-center gap-3">
                                                <div class="w-9 h-9 rounded-xl bg-[#22AF85]/10 flex items-center justify-center text-[11px] font-black text-[#22AF85] border border-[#22AF85]/15">
                                                    <?php echo e($issue->resolver ? substr($issue->resolver->name, 0, 1) : '?'); ?>

                                                </div>
                                                <div class="flex flex-col">
                                                    <span class="text-[9px] text-gray-400 uppercase font-bold tracking-widest leading-none mb-1">Resolved By</span>
                                                    <span class="text-xs font-black text-gray-800 uppercase tracking-tight"><?php echo e($issue->resolver->name ?? 'System'); ?></span>
                                                </div>
                                            </div>
                                            <div class="flex flex-col bg-gray-50 p-3 rounded-xl border border-gray-100">
                                                ...
                                                <span class="text-[11px] font-black text-gray-700 tracking-tight"><?php echo e($issue->resolved_at ? $issue->resolved_at->format('d M Y • H:i') : '-'); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($issues->hasPages()): ?>
            ...
            <div class="mt-8 p-6 bg-white rounded-2xl border border-gray-100 shadow-lg shadow-gray-100/80 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-3 bg-gray-50 p-3 rounded-xl border border-gray-100 flex-shrink-0">
                    <div class="flex -space-x-2">
                        <?php $resolvers = $issues->whereNotNull('resolved_by')->unique('resolved_by')->take(5); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $resolvers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="w-8 h-8 rounded-xl bg-[#22AF85]/10 border-2 border-white flex items-center justify-center text-[10px] font-black text-[#22AF85]">
                                <?php echo e(substr($iss->resolver->name, 0, 1)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cx\history.blade.php ENDPATH**/ ?>