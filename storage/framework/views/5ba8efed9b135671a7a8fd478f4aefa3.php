...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['order', 'step', 'readOnly' => false, 'title' => null]));
...
foreach (array_filter((['order', 'step', 'readOnly' => false, 'title' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data='{
    ...
    photos: <?php echo json_encode($order->photos->where('step', $step)->map(fn($p) => ['id' => $p->id, 'url' => $p->photo_url])->values()) ?>,
    uploading: false,
    ...
    <div class="flex justify-between items-center mb-3">
        <h4 class="text-sm font-bold text-gray-700 flex items-center gap-2">
            ...
            <?php echo e($title ?? 'Dokumentasi ' . ucwords(strtolower(str_replace('_', ' ', $step)))); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/components/photo-uploader.blade.php ENDPATH**/ ?>