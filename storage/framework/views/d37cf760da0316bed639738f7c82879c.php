            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full md:w-auto">
                    <div class="bg-white/[0.03] backdrop-blur-xl rounded-2xl p-4 border border-white/10 shadow-2xl">
                        ...
                        <div class="text-2xl font-black text-white"><?php echo e($stats['pending'] + $stats['contacted']); ?> <span class="text-[10px] font-medium text-gray-500 italic">ORDERS</span></div>
                    </div>
                    ...
                    <div class="bg-white/[0.03] backdrop-blur-xl rounded-2xl p-4 border border-white/10 shadow-2xl">
                        ...
                        <div class="text-2xl font-black text-green-400"><?php echo e($stats['closing_rate']); ?><span class="text-sm font-black">%</span></div>
                    </div>
                    ...
                    <div class="bg-white/[0.03] backdrop-blur-xl rounded-2xl p-4 border border-white/10 shadow-2xl">
                        ...
                        <div class="text-lg font-black text-white">Rp <?php echo e(number_format($stats['total_potential'] / 1000, 0)); ?>k</div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-4 border border-white/20 shadow-2xl">
                        ...
                        <div class="text-lg font-black text-white">Rp <?php echo e(number_format($stats['total_achieved'] / 1000, 0)); ?>k</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-10">
            <a href="<?php echo e(route('cx.oto.index', ['filter' => 'all'])); ?>" 
               class="px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all <?php echo e($filter === 'all' ? 'bg-[#0f172a] text-white shadow-xl shadow-gray-300' : 'bg-white text-gray-500 hover:bg-gray-100 border border-gray-100'); ?>">
                Active Leads
            </a>
            <a href="<?php echo e(route('cx.oto.index', ['filter' => 'pending'])); ?>" 
               class="px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all <?php echo e($filter === 'pending' ? 'bg-[#0f172a] text-white shadow-xl shadow-gray-300' : 'bg-white text-gray-500 hover:bg-gray-100 border border-gray-100'); ?>">
                New Leads
            </a>
            <a href="<?php echo e(route('cx.oto.index', ['filter' => 'contacted'])); ?>" 
               class="px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all <?php echo e($filter === 'contacted' ? 'bg-[#0f172a] text-white shadow-xl shadow-gray-300' : 'bg-white text-gray-500 hover:bg-gray-100 border border-gray-100'); ?>">
                Follow Up
            </a>
            <a href="<?php echo e(route('cx.oto.index', ['filter' => 'accepted'])); ?>" 
               class="px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all <?php echo e($filter === 'accepted' ? 'bg-green-600 text-white shadow-xl shadow-green-100' : 'bg-white text-gray-500 hover:bg-gray-100 border border-gray-100'); ?>">
                Success
            </a>
            <a href="<?php echo e(route('cx.oto.index', ['filter' => 'cancelled'])); ?>" 
               class="px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all <?php echo e($filter === 'cancelled' ? 'bg-red-600 text-white shadow-xl shadow-red-100' : 'bg-white text-gray-500 hover:bg-gray-100 border border-gray-100'); ?>">
                Rejected
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            ?>
            <div class="group relative bg-white rounded-3xl shadow-xl border-2 <?php echo e($isUrgent ? 'border-red-100 animate-pulse-subtle' : 'border-gray-50'); ?> hover:border-orange-200 transition-all duration-300 overflow-hidden">
                <div class="p-8">
                    <!-- Header -->
                    <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-6">
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2 mb-3">
                                <span class="font-mono text-[11px] font-black px-3 py-1 rounded-lg bg-gray-900 text-white shadow-lg">
                                    <?php echo e($oto->workOrder->spk_number); ?>

                                </span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($normalizedStatus === 'PENDING_CX'): ?>
                                    <span class="px-3 py-1 rounded-lg bg-yellow-400 text-gray-900 text-[10px] font-black uppercase tracking-widest shadow-sm">
                                        New Lead
                                    </span>
                                <?php elseif($normalizedStatus === 'CONTACTED'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isUrgent && in_array($normalizedStatus, ['PENDING_CX', 'CONTACTED'])): ?>
                                    <span class="px-3 py-1 rounded-lg bg-red-600 text-white text-[10px] font-black uppercase tracking-widest animate-pulse">
                                        Hot Lead
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <h3 class="text-xl font-black text-gray-900 mb-1 group-hover:text-orange-600 transition-colors"><?php echo e($oto->workOrder->customer_name); ?></h3>
                            <div class="flex items-center gap-2 text-xs text-gray-500 font-bold">
                                ...
                                <?php echo e($oto->workOrder->customer_phone); ?>

                            </div>
                        </div>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($normalizedStatus, ['PENDING_CX', 'CONTACTED'])): ?>
                        <div class="text-right bg-gray-50 p-3 rounded-2xl border border-gray-100 min-w-[120px]">
                            ...
                            <div class="text-sm font-black <?php echo e($isUrgent ? 'text-red-600 animate-pulse' : 'text-gray-800'); ?>">
                                <?php echo e(Carbon\Carbon::parse($oto->valid_until)->diffForHumans()); ?>

                            </div>
                            <div class="text-[10px] text-gray-400 font-bold"><?php echo e(Carbon\Carbon::parse($oto->valid_until)->format('d M Y')); ?></div>
                        </div>
                        <?php else: ?>
                        <div class="text-right bg-gray-50 p-3 rounded-2xl border border-gray-100 min-w-[120px]">
                            ...
                            <div class="text-sm font-black text-gray-800">
                                <?php echo e($oto->customer_responded_at ? $oto->customer_responded_at->format('d M Y') : $oto->updated_at->format('d M Y')); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-4 border-t border-orange-200/50 flex justify-between items-end">
                                <div>
                                    ...
                                    <div class="font-black text-orange-700 text-2xl tracking-tighter"><?php echo e($oto->total_oto_price); ?></div>
                                </div>
                                <div class="text-right">
                                    <span class="text-[10px] font-black bg-green-500 text-white px-3 py-1 rounded-full shadow-lg">
                                        SAVE <?php echo e($oto->total_discount); ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3" x-data="{ openContact: false }">
                                    ...
                                    <form action="<?php echo e(route('cx.oto.contact', $oto->id)); ?>" method="POST">
                                        ...
                                        <div class="bg-white p-6">
                                            ...
                                            <div class="bg-slate-50 p-4 rounded-xl mb-6 border border-slate-100 relative group">
                                                ...
                                                <p class="text-[11px] text-slate-600 font-bold italic leading-relaxed">"Halo Kak <?php echo e($oto->workOrder->customer_name); ?>, sepatu <?php echo e($oto->workOrder->shoe_brand); ?> Anda hampir selesai! Ada promo OTO <?php echo e($oto->proposed_services); ?> cuma <?php echo e($oto->total_oto_price); ?>. Minat?"</p>
                                            </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($normalizedStatus === 'ACCEPTED'): ?>
                        ...
                        <?php elseif(in_array($normalizedStatus, ['CANCELLED', 'REJECTED', 'EXPIRED'])): ?>
                            <div class="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex-1">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-[9px] font-black bg-red-100 text-red-600 px-2 py-0.5 rounded-lg uppercase"><?php echo e($oto->rejection_reason ?: $normalizedStatus); ?></span>
                                </div>
                                <p class="text-xs font-bold text-red-700 italic">"<?php echo e($oto->rejection_notes ?: 'Tidak ada catatan tambahan'); ?>"</p>
                            </div>
                        <?php else: ?>
                            <div class="flex flex-1 gap-3">
                                ...
                                <form action="<?php echo e(route('cx.oto.accept', $oto->id)); ?>" method="POST" onsubmit="return confirm('Konfirmasi: Customer SETUJU dengan OTO ini?')" class="flex-1">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div x-show="openReject" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;" x-cloak>
                                        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                            ...
                                            <div class="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                <form action="<?php echo e(route('cx.oto.cancel', $oto->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="bg-white p-8">
