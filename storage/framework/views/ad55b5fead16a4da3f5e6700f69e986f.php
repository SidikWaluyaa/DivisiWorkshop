<div class="min-h-screen bg-[#f8fafc] pb-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-[#1a3b34] rounded-[2.5rem] p-8 text-white shadow-xl shadow-teal-900/10 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-baseline gap-2">
                        <h2 class="text-4xl font-black tabular-nums"><?php echo e(number_format($stats['total'])); ?></h2>
            ...
            <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col justify-between relative group hover:shadow-lg transition-all">
                <div>
                    ...
                    <h2 class="text-4xl font-black text-[#1a3b34] tabular-nums"><?php echo e(number_format($stats['open'])); ?></h2>
                </div>
                <div class="mt-4">
            ...
            <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col justify-between relative group hover:shadow-lg transition-all">
                <div>
                    ...
                    <h2 class="text-4xl font-black text-[#1a3b34] tabular-nums"><?php echo e(number_format($stats['finished'])); ?></h2>
                </div>
                <div class="mt-4">
            ...
            <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col justify-between relative group hover:shadow-lg transition-all">
                <div>
                    ...
                    <h2 class="text-2xl font-black text-[#1a3b34] truncate uppercase tracking-tighter"><?php echo e($stats['topCategory']); ?></h2>
                </div>
                <div class="mt-4">
            ...
            <div class="flex flex-col lg:flex-row items-end gap-6">
                ...
                <div class="w-full lg:w-auto flex-1 space-y-2">
                    ...
                    <select wire:model.live="filterPic" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availablePics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <div class="w-full lg:w-auto flex-1 space-y-2">
                    ...
                    <select wire:model.live="filterCategory" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <div class="bg-white rounded-[2.5rem] p-4 shadow-sm border border-gray-100 mb-10 flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div class="flex p-1.5 bg-gray-50 rounded-2xl w-full lg:w-auto">
                <button wire:click="switchTab('active')" 
                        class="flex-1 lg:flex-none px-8 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all duration-300 <?php echo e($activeTab === 'active' ? 'bg-white text-[#22AF85] shadow-md' : 'text-gray-400 hover:text-gray-600'); ?>">
                    Garansi Aktif
                </button>
                <button wire:click="switchTab('history')" 
                        class="flex-1 lg:flex-none px-8 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all duration-300 <?php echo e($activeTab === 'history' ? 'bg-white text-[#22AF85] shadow-md' : 'text-gray-400 hover:text-gray-600'); ?>">
                    Riwayat Selesai
                </button>
            </div>
        ...
        <div class="relative min-h-[400px]">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" 
                    ...
                    <p class="text-sm font-black uppercase tracking-wider"><?php echo e(session('success')); ?></p>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="grid grid-cols-1 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $warranties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warranty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="bg-white rounded-[2.5rem] p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 group border border-gray-50 flex flex-col lg:flex-row gap-10">
                        ...
                        <div class="lg:w-1/4 space-y-4">
                            <div class="flex flex-col">
                                ...
                                <h3 class="text-2xl font-black text-[#1a3b34] tracking-tight group-hover:text-[#22AF85] transition-colors uppercase">
                                    <?php echo e($warranty->garansi_spk_number); ?>
                                ...
                                <div class="mt-2 inline-flex items-center gap-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-50 px-3 py-1.5 rounded-xl border border-gray-100">
                                    ...
                                    Asli: <?php echo e($warranty->workOrder->spk_number); ?>

                                </div>
                            </div>
                            
                            <div class="pt-4 border-t border-gray-50">
                                <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-2"><?php echo e($activeTab === 'active' ? 'Created At' : 'Finished At'); ?></span>
                                <p class="text-xs font-black text-gray-700">
                                    <?php echo e(($activeTab === 'active' ? $warranty->created_at : $warranty->finished_at)->format('d M Y')); ?>

                                    <span class="text-gray-300 mx-1">•</span>
                                    <?php echo e(($activeTab === 'active' ? $warranty->created_at : $warranty->finished_at)->format('H:i')); ?>
                        ...
                        <div class="flex-1 space-y-6">
                            <div class="flex flex-col md:flex-row justify-between gap-6">
                                <div>
                                    ...
                                    <div class="flex flex-col">
                                        <p class="text-lg font-black text-[#1a3b34] uppercase tracking-tight"><?php echo e($warranty->workOrder->customer_name); ?></p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($warranty->workOrder->customer_phone): ?>
                                            <p class="text-[11px] font-bold text-gray-500 mt-0.5 tracking-wider"><?php echo e($warranty->workOrder->customer_phone); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <p class="text-xs font-bold text-[#22AF85] mt-1"><?php echo e($warranty->workOrder->shoe_brand); ?> <span class="text-gray-300 mx-1">/</span> <?php echo e($warranty->workOrder->shoe_type); ?></p>
                                </div>
                            ...
                            <div class="bg-gray-50/80 rounded-3xl p-6 border border-gray-100 relative group/notes overflow-hidden">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-200/50 flex items-center justify-between">
                                    <div class="flex items-center gap-2 opacity-60">
                                        <div class="w-6 h-6 rounded-full bg-[#22AF85] text-white flex items-center justify-center text-[10px] font-black">
                                            <?php echo e(substr($warranty->creator->name ?? '?', 0, 1)); ?>

                                        </div>
                                        <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">By <?php echo e($warranty->creator->name ?? 'System'); ?></span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'history' && $warranty->finisher): ?>
                                        <div class="flex items-center gap-2 opacity-60">
                                            <span class="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Finalized By <?php echo e($warranty->finisher->name); ?></span>
                                            <div class="w-6 h-6 rounded-full bg-gray-700 text-white flex items-center justify-center text-[10px] font-black">
                                                <?php echo e(substr($warranty->finisher->name, 0, 1)); ?>
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-200/30 space-y-2">
                                    ...
                                    <?php $prepTechs = $warranty->workOrder->prep_technicians; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prepTechs->count() > 0): ?>
                                        <div class="flex items-center gap-2">
                                            <span class="w-8 text-[7px] font-black text-gray-400 uppercase tracking-tighter">Prep</span>
                                            <div class="flex -space-x-1.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $prepTechs->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <div class="w-5 h-5 rounded-full bg-white border border-gray-100 flex items-center justify-center text-[7px] font-black text-blue-500 shadow-sm overflow-hidden" title="Prep: <?php echo e($tech->name); ?>">
                                                        <?php echo e(substr($tech->name, 0, 1)); ?>

                                                    </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                            <span class="text-[8px] font-bold text-gray-600 truncate tracking-tight"><?php echo e($prepTechs->pluck('name')->implode(', ')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                    
                                    <?php $prodTechs = $warranty->workOrder->prod_technicians; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prodTechs->count() > 0): ?>
                                        <div class="flex items-center gap-2">
                                            <span class="w-8 text-[7px] font-black text-gray-400 uppercase tracking-tighter">Prod</span>
                                            <div class="flex -space-x-1.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $prodTechs->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <div class="w-5 h-5 rounded-full bg-white border border-gray-100 flex items-center justify-center text-[7px] font-black text-orange-500 shadow-sm overflow-hidden" title="Prod: <?php echo e($tech->name); ?>">
                                                        <?php echo e(substr($tech->name, 0, 1)); ?>

                                                    </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                            <span class="text-[8px] font-bold text-gray-600 truncate tracking-tight"><?php echo e($prodTechs->pluck('name')->implode(', ')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                    
                                    <?php $qcTechs = $warranty->workOrder->qc_technicians; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qcTechs->count() > 0): ?>
                                        <div class="flex items-center gap-2">
                                            <span class="w-8 text-[7px] font-black text-gray-400 uppercase tracking-tighter">QC</span>
                                            <div class="flex -space-x-1.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $qcTechs->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <div class="w-5 h-5 rounded-full bg-white border border-gray-100 flex items-center justify-center text-[7px] font-black text-purple-500 shadow-sm overflow-hidden" title="QC: <?php echo e($tech->name); ?>">
                                                        <?php echo e(substr($tech->name, 0, 1)); ?>

                                                    </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                            <span class="text-[8px] font-bold text-gray-600 truncate tracking-tight"><?php echo e($qcTechs->pluck('name')->implode(', ')); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="lg:w-[180px] flex flex-col justify-center gap-3">
                            <a href="<?php echo e(route('garansi.print', $warranty->id)); ?>" target="_blank"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'active'): ?>
                                <button wire:click="finishWarranty(<?php echo e($warranty->id); ?>)" 
                            ...
                            <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($warranty->reworkWorkOrder): ?>
                                    <button wire:click="syncToFinish(<?php echo e($warranty->id); ?>)" 
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <div class="py-24 flex flex-col items-center justify-center bg-white rounded-[4rem] border-2 border-dashed border-gray-100 italic">
                        ...
                        <p class="text-[11px] font-bold text-gray-400">Tidak ada pengerjaan garansi yang <?php echo e($activeTab === 'active' ? 'tertunda' : 'ditemukan'); ?>.</p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <div 
        x-data="{ show: <?php if ((object) ('showCreateModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showCreateModal'->value()); ?>')<?php echo e('showCreateModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showCreateModal'); ?>')<?php endif; ?> }"
        x-show="show"
            ...
            <div x-show="show" x-transition:enter="ease-out duration-500" x-transition:enter-start="opacity-0 translate-y-12 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                ...
                <div class="px-10 pt-10 pb-8">
                    <div class="flex justify-between items-start mb-10">
                        <div class="space-y-1">
                            <span class="text-[10px] font-black text-[#22AF85] uppercase tracking-widest text-[#22AF85]">Langkah <?php echo e($step); ?> dari 2</span>
                            <h3 class="text-3xl font-black text-[#1a3b34] tracking-tighter">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 1): ?> Cari <span class="text-[#22AF85]">Data Asli</span> <?php else: ?> Deskripsi <span class="text-[#22AF85]">Masalah</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </h3>
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 1): ?>
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $searchSource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div wire:click.prevent="selectWorkOrder(<?php echo e($wo->id); ?>)" 
                                        ...
                                        <div class="w-16 h-16 rounded-2xl overflow-hidden bg-gray-200 shrink-0 border border-white shadow-sm">
                                            ...
                                            ?>
                                            <img src="<?php echo e($pUrl); ?>" class="w-full h-full object-cover group-hover/item:scale-110 transition-transform duration-500">
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <div class="flex justify-between items-start mb-0.5">
                                                <div class="flex flex-col gap-1">
                                                    <span class="font-black text-[#1a3b34] text-xs group-hover/item:text-[#22AF85] transition-colors uppercase tracking-tight"><?php echo e($wo->spk_number); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->warranties->count() > 0): ?>
                                                        <span class="inline-flex items-center gap-1 text-[8px] font-black text-[#FFC232] bg-yellow-50 px-2 py-0.5 rounded-md border border-yellow-100 uppercase tracking-tighter">
                                                            ⚠️ Pernah Garansi (<?php echo e($wo->warranties->count()); ?>x)
                                                        </span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <span class="text-[9px] font-black text-[#22AF85] bg-teal-50 px-2 py-1 rounded-lg border border-teal-100 uppercase tracking-widest">
                                                    AMBIL: <?php echo e($wo->taken_date ? $wo->taken_date->format('d/m/y') : '-'); ?>

                                                </span>
                                            </div>
                                            <h4 class="text-sm font-extrabold text-gray-700 truncate capitalize leading-none"><?php echo e(strtolower($wo->customer_name)); ?></h4>
                                            <p class="text-[10px] font-bold text-gray-400 mt-1 truncate uppercase tracking-widest"><?php echo e($wo->shoe_brand); ?> • <?php echo e($wo->shoe_type); ?></p>
                                        </div>
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                ...
                                <div class="bg-[#1a3b34] rounded-[2.5rem] p-6 shadow-xl text-white flex gap-6 relative overflow-hidden">
                                    ...
                                    <div class="w-24 h-24 rounded-2xl overflow-hidden bg-white/5 shrink-0 border border-white/10">
                                        <?php
                                            ...
                                            $pUrl = $photo ? $photo->photo_url : 'https://placehold.co/400x400?text=No+Photo';
                                        ?>
                                        <img src="<?php echo e($pUrl); ?>" class="w-full h-full object-cover">
                                    </div>
                                    <div class="flex-1">
                                        <h4 class="text-xl font-black tracking-tight mb-1"><?php echo e($this->selectedWorkOrder->spk_number); ?></h4>
                                        <p class="text-xs font-bold text-[#FFC232] uppercase tracking-widest mb-3"><?php echo e($this->selectedWorkOrder->customer_name); ?></p>
                                        <div class="flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->selectedWorkOrder->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <span class="text-[9px] font-black bg-white/10 px-2 py-1 rounded-lg border border-white/5 uppercase tracking-tighter">
                                                    <?php echo e($svc->custom_service_name ?? ($svc->service->name ?? '-')); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/livewire/warranty/index.blade.php ENDPATH**/ ?>