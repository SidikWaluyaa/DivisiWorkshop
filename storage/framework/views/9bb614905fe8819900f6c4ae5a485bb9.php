<div>
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center gap-2">
                            ...
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                <button @click.stop="open = !open" class="text-gray-300 hover:text-orange-500 transition-colors cursor-pointer">
        ...
        <div class="p-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logs && $logs->count() > 0): ?>
            <div class="space-y-2 max-h-[350px] overflow-y-auto custom-scrollbar">
                ...
                <div class="flex gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all border border-gray-100 hover:border-gray-200">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-[10px] text-gray-400 font-medium"><?php echo e($log->created_at->diffForHumans()); ?></div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\workshop\widgets\recent-activity-feed.blade.php ENDPATH**/ ?>