            ...
            <div class="summary-section mt-8 flex flex-col lg:flex-row justify-between items-stretch lg:items-end gap-8">
                ...
                <div class="flex-1 flex flex-col gap-6 sm:gap-8">
                    <div class="totals-grid grid grid-cols-2 gap-y-4 gap-x-8 px-2 sm:px-0">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSpecialRequest): ?>
                        <div class="text-right col-span-2 pt-2 border-t border-gray-50 flex justify-end gap-10">
                            <div>
                                <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1 italic">Nominal <?php echo e($isDP ? 'DP 70%' : 'Sisa'); ?></p>
                                <p class="text-xs font-black text-gray-800 italic tabular-nums leading-none">Rp. <?php echo e(number_format($isDP ? $invoice->target_dp_amount : $remainingTotal, 0, ',', '.')); ?></p>
                            </div>
                            <div>
                                <p class="text-[9px] font-black text-[#22AF85] uppercase tracking-[0.2em] mb-1 italic">Kode Unik</p>
                                <p class="text-xs font-black text-[#22AF85] italic tabular-nums leading-none">+ Rp. <?php echo e(number_format($uniqueCode, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-end px-2 sm:px-0">
                        <div class="text-right py-3 border-y border-gray-100 min-w-[150px]">
                            ...
                            <p class="text-lg sm:text-xl font-black text-gray-900 italic tabular-nums leading-none tracking-tighter">Rp. <?php echo e(number_format($grandTotal, 0, ',', '.')); ?></p>
                        </div>
                    </div>

                    <div class="flex flex-col sm:flex-row items-center justify-end gap-4 sm:gap-8 relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remainingTotal <= 0 && $subtotal > 0): ?>
                        ...
                        <p class="text-[10px] font-black text-gray-900 uppercase tracking-[0.2em] italic"><?php echo e($displayLabel); ?></p>
                        <div class="bg-[#22AF85] px-8 sm:px-12 py-4 rounded-2xl sm:rounded-[1.5rem] shadow-2xl w-full sm:w-auto text-center min-w-[240px]">
                            <p class="text-white font-black italic text-xl sm:text-2xl tabular-nums tracking-tighter leading-none">
                                Rp. <?php echo e(number_format($displayAmount, 0, ',', '.')); ?>
