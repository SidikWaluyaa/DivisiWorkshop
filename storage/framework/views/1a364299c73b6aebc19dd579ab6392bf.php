...
<head>
    ...
    ?>
    <title>Resi Pengiriman - <?php echo e($displayNumber); ?></title>
    <style>
        @page {
            size: a4 portrait;
            margin: 0;
        ...
        <div class="airmail-resi">
            <div class="envelope-body clearfix">
                ...
                <div class="id-strip">
                    ...
                    <div class="spk-id"><?php echo e($displayNumber); ?></div>
                </div>

                
                <div class="recipient-block">
                    <div class="section-title">Nama Penerima:</div>
                    <div class="entity-name"><?php echo e($workshopName); ?></div>
                    <div class="entity-address"><?php echo e($workshopAddress); ?></div>
                    <div class="entity-phone">Nomor Telepon/WA: <?php echo e($workshopPhone); ?></div>
                </div>

                
                <div class="sender-block">
                    <div class="section-title">Nama Pengirim:</div>
                    <div class="entity-name"><?php echo e($customerName); ?></div>
                    <div class="entity-address"><?php echo e($customerFullAddress); ?></div>
                    <div class="entity-phone">Nomor Telepon/WA: <?php echo e($customerPhone); ?></div>
                </div>

                
                <div class="logo-footer">SHOEWORKSHOP</div>
                <div class="timestamp">Dicetak: <?php echo e(now()->translatedFormat('d F Y H:i')); ?> WIB</div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\pdf\shipping-label.blade.php ENDPATH**/ ?>