...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="min-h-screen bg-[#F8FAFC] pb-24">
            ...
            <div class="max-w-7xl mx-auto px-6 py-5">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-6">
                        <a href="<?php echo e(route('finance.index')); ?>" class="group flex items-center justify-center w-12 h-12 bg-white rounded-2xl shadow-lg border border-gray-100 hover:border-[#22AF85]/30 hover:shadow-emerald-100 transition-all active:scale-95 print:hidden">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-0.5">
                                ...
                                <h1 class="text-2xl font-black text-gray-900 tracking-tight italic"><?php echo e($order->spk_number); ?></h1>
                            </div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="hidden md:flex flex-col items-end mr-4">
                            ...
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-full border border-gray-100">
                                <span class="w-2 h-2 rounded-full <?php echo e($order->status === \App\Enums\WorkOrderStatus::SELESAI ? 'bg-emerald-500 shadow-[0_0_8px_rgba(34,175,133,0.5)]' : 'bg-blue-500 animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.5)]'); ?>"></span>
                                <span class="text-[10px] font-black uppercase text-gray-700 tracking-wider"><?php echo e(str_replace('_', ' ', $order->status->value)); ?></span>
                            </div>
                        </div>

                        <a href="<?php echo e(route('finance.print-invoice', $order->id)); ?>" target="_blank"
        ...
        <div class="max-w-7xl mx-auto px-6 mt-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->invoice_id && $order->invoice): ?>
                <div class="mb-8 bg-blue-50 border border-blue-100 rounded-[2rem] p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-blue-500/5 relative overflow-hidden group">
                    ...
                    <div class="flex items-center gap-5 relative z-10">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <h3 class="text-lg font-black text-gray-900 tracking-tight italic"><?php echo e($order->invoice->invoice_number); ?></h3>
                            </div>
                    ...
                    <a href="<?php echo e(route('finance.invoices.show', $order->invoice_id)); ?>" class="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-blue-200 transition-all hover:-translate-y-1 active:scale-95 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="group relative bg-white rounded-[2.5rem] p-8 shadow-2xl border border-gray-100 overflow-hidden hover:shadow-[#22AF85]/10 transition-all duration-500">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-4xl font-black text-gray-900 tracking-tighter mb-4 group-hover:text-[#22AF85] transition-colors leading-none italic">
                            Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?>
                        ...
                        <div class="pt-6 border-t border-gray-50 flex flex-col gap-1.5">
                            ...
                            <div class="flex items-center gap-2 group/date">
                                <input type="date" 
                                       value="<?php echo e($order->payment_due_date ? $order->payment_due_date->format('Y-m-d') : ''); ?>"
                ...
                <div class="group relative bg-[#22AF85] rounded-[2.5rem] p-8 shadow-2xl shadow-emerald-100 overflow-hidden hover:shadow-emerald-200 transition-all duration-500 border border-[#22AF85]">
                    ...
                    <div class="relative z-10 text-white">
                        ...
                        <h3 class="text-4xl font-black text-white tracking-tighter mb-4 leading-none italic">
                            Rp <?php echo e(number_format($order->total_paid, 0, ',', '.')); ?>

                        </h3>
                        <div class="pt-6 border-t border-white/20 flex items-center justify-between">
                            <span class="text-[10px] font-black text-white/60 uppercase tracking-widest"><?php echo e($order->payments->count()); ?> Transaksi</span>
                ...
                <div class="group relative <?php echo e($order->sisa_tagihan > 0 ? 'bg-white shadow-[#FFC232]/10' : 'bg-gray-50'); ?> rounded-[2.5rem] p-8 shadow-2xl border <?php echo e($order->sisa_tagihan > 0 ? 'border-amber-100' : 'border-gray-100'); ?> overflow-hidden transition-all duration-500">
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-12 h-12 <?php echo e($order->sisa_tagihan > 0 ? 'bg-amber-50 shadow-amber-100 border-amber-100' : 'bg-gray-200 shadow-inner'); ?> rounded-2xl flex items-center justify-center shadow-inner border group-hover:scale-110 transition-transform duration-500">
                                <svg class="w-6 h-6 <?php echo e($order->sisa_tagihan > 0 ? 'text-[#FFC232]' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <span class="text-[11px] font-black text-gray-400 uppercase tracking-[0.2em]">Sisa Tagihan</span>
                        </div>
                        <h3 class="text-4xl font-black <?php echo e($order->sisa_tagihan > 0 ? 'text-[#FFC232]' : 'text-gray-300'); ?> tracking-tighter mb-4 leading-none italic">
                            Rp <?php echo e(number_format($order->sisa_tagihan, 0, ',', '.')); ?>

                        </h3>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->sisa_tagihan > 0): ?>
                            <div class="pt-6 border-t border-gray-50">
                                <form action="<?php echo e(route('finance.donations.force', $order->id)); ?>" method="POST" onsubmit="return confirm('Pindahkan data ke list DONASI? Data ini akan diparkir selamanya.');">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div class="space-y-6">
                            <div>
                                ...
                                <p class="text-2xl font-black text-gray-900 leading-none tracking-tight italic"><?php echo e($order->customer_name); ?></p>
                                <p class="text-xs text-[#22AF85] font-black mt-2 bg-emerald-50 inline-block px-3 py-1 rounded-lg border border-emerald-100 shadow-sm"><?php echo e($order->customer_phone); ?></p>
                            </div>
                            <div class="pt-6 border-t border-gray-50">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-black text-gray-900 leading-none"><?php echo e($order->shoe_brand); ?> [<?php echo e($order->shoe_size); ?>]</p>
                                        <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase tracking-wider"><?php echo e($order->shoe_color); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="bg-[#F8FAFC] border border-gray-100 rounded-[2rem] p-6 shadow-inner relative group/address transition-all hover:bg-white hover:shadow-xl duration-500">
                                <div class="text-gray-900 font-black text-base leading-relaxed italic mb-4">
                                    <?php echo e($order->customer->address ?? ($order->customer_address ?? '-')); ?>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="p-3 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        ...
                                        <span class="text-[10px] font-black text-gray-900 truncate block"><?php echo e($order->customer->village ?? '-'); ?></span>
                                    </div>
                                    <div class="p-3 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        <span class="text-[8px] font-black text-gray-400 uppercase block mb-1">Kecamatan</span>
                                        <span class="text-[10px] font-black text-gray-900 truncate block"><?php echo e($order->customer->district ?? '-'); ?></span>
                                    </div>
                                    <div class="p-3 bg-white rounded-2xl border border-gray-100 shadow-sm border-b-2 border-b-[#22AF85]/30">
                                        ...
                                        <span class="text-[10px] font-black text-[#22AF85] truncate block italic"><?php echo e($order->customer->city ?? '-'); ?></span>
                                    </div>
                                    <div class="p-3 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                        <span class="text-[8px] font-black text-gray-400 uppercase block mb-1">Kode Pos</span>
                                        <span class="text-[10px] font-black text-gray-900 truncate block"><?php echo e($order->customer->postal_code ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <table class="w-full">
                                <tbody class="divide-y divide-gray-50">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <tr class="group">
                                            <td class="py-4 text-xs font-black text-gray-700 uppercase tracking-tight group-hover:text-[#22AF85] transition-colors leading-none">
                                                <?php echo e($detail->custom_service_name ?? ($detail->service ? $detail->service->name : 'Layanan Hapus')); ?>

                                            </td>
                                            <td class="py-4 text-right font-black text-gray-900 tracking-tighter italic">Rp <?php echo e(number_format($detail->cost, 0, ',', '.')); ?></td>
                                        </tr>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->cost_oto + $order->cost_add_service > 0): ?>
                                    <tr>
                                        <td class="py-4 text-xs font-black text-gray-400 uppercase tracking-tight">Biaya OTO / Additional</td>
                                        <td class="py-4 text-right font-black text-gray-900 tracking-tighter italic">Rp <?php echo e(number_format($order->cost_oto + $order->cost_add_service, 0, ',', '.')); ?></td>
                                    </tr>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <tr class="group">
                                        <td class="py-4 text-gray-700 flex flex-col">
                                            ...
                                            <div class="text-[9px] text-[#22AF85] font-black uppercase tracking-widest mt-1 italic" id="display-shipping-zone">
                                                <?php echo e($order->shipping_zone ? ($order->shipping_zone . ' (' . ($order->shipping_type ?? 'Ekspedisi') . ')') : ''); ?>

                                            </div>
                                        </td>
                                        <td class="py-4 text-right font-black text-gray-900 tracking-tighter italic" id="display-shipping">Rp <?php echo e(number_format($order->shipping_cost, 0, ',', '.')); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-4 text-right font-black text-rose-500 tracking-tighter italic">- Rp <?php echo e(number_format($order->discount, 0, ',', '.')); ?></td>
                                    </tr>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->unique_code > 0): ?>
                                    <tr class="bg-emerald-50/30">
                                        ...
                                        <td class="py-4 px-4 text-right font-black text-[#22AF85] tracking-tighter italic">+ Rp <?php echo e(number_format($order->unique_code, 0, ',', '.')); ?></td>
                                    </tr>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </tbody>
                                <tfoot class="border-t-[3px] border-gray-900">
                                    <tr>
                                        ...
                                        <td class="py-6 text-right font-black text-[#22AF85] text-3xl tracking-tighter italic" id="display-total-transaksi">Rp <?php echo e(number_format($order->total_transaksi, 0, ',', '.')); ?></td>
                                    </tr>
                                </tfoot>
                            </table>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === \App\Enums\WorkOrderStatus::WAITING_PAYMENT): ?>
                                <div class="mt-8 pt-8 border-t border-gray-50">
                                    <button onclick="confirmMove('<?php echo e($order->id); ?>')" class="w-full bg-[#FFC232] hover:bg-[#FFD666] text-gray-900 font-black py-4 px-8 rounded-2xl shadow-xl shadow-amber-100 hover:shadow-amber-200 transition-all active:scale-95 uppercase tracking-widest text-xs flex items-center justify-center gap-3">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 group">
                        ...
                        <form action="<?php echo e(route('finance.payment.store', $order->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8" onsubmit="return validatePayment(event)">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-6 relative">
                                ...
                                <div class="relative group/input">
                                    ...
                                    <input type="number" 
                                           name="amount_total" 
                                           id="payment_amount"
                                           max="<?php echo e($order->sisa_tagihan); ?>"
                                           required 
                                ...
                                <div class="flex justify-between items-center mt-2 px-1">
                                    <p class="text-[9px] text-gray-400 font-black uppercase tracking-widest italic">Max: Rp <?php echo e(number_format($order->sisa_tagihan, 0, ',', '.')); ?></p>
                                    <button type="button" onclick="document.getElementById('payment_amount').value = '<?php echo e($order->sisa_tagihan); ?>'" class="text-[9px] text-[#22AF85] font-black uppercase tracking-widest hover:underline cursor-pointer">Set Maximum</button>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <input type="datetime-local" name="paid_at" value="<?php echo e(date('Y-m-d\TH:i')); ?>" class="w-full border-gray-100 bg-gray-50 rounded-xl focus:ring-[#22AF85] focus:border-[#22AF85] text-xs font-black uppercase tracking-tight py-3 px-4 shadow-inner">
                                </div>
                                <div>
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100">
                        ...
                        <div class="p-8">
                            <?php $paidAccumulated = 0; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $order->payments->sortBy('paid_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <?php $paidAccumulated += $payment->amount_total; ?>
                                <div class="flex gap-8 <?php echo e(!$loop->last ? 'pb-10 mb-10' : ''); ?> group/item">
                                        ...
                                        <div class="relative z-10">
                                            <div class="flex items-start justify-between mb-4">
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-3 mb-2">
                                                        ...
                                                        <span class="text-[10px] font-black text-gray-300 uppercase tracking-widest leading-none">TRX-<?php echo e($payment->id); ?></span>
                                                    </div>
                                                    <h5 class="font-black text-gray-900 text-xl tracking-tight italic leading-none mb-2">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->type === 'BEFORE'): ?>
                                                            Uang Muka (DP)
                                                        <?php elseif($payment->type === 'TAMBAH_JASA'): ?>
                                                            Tambah Jasa
                                                        <?php elseif($payment->type === 'LUNAS_AWAL'): ?>
                                                            Lunas Awal
                                                        <?php elseif($paidAccumulated < $order->total_transaksi): ?>
                                                            Angsuran / Cicilan
                                                        <?php else: ?>
                                                            Pelunasan Akhir
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    ...
                                                    <p class="text-[9px] text-gray-400 font-black uppercase tracking-[0.2em] flex items-center gap-2">
                                                        ...
                                                        <?php echo e($payment->paid_at->format('H:i')); ?>

                                                    </p>
                                                </div>
                                                <div class="text-right">
                                                    <p class="font-black text-gray-900 text-2xl tracking-tighter italic leading-none mb-1">Rp <?php echo e(number_format($payment->amount_total, 0, ',', '.')); ?></p>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->is_verified): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->notes): ?>
                                                <div class="bg-[#F8FAFC] p-4 rounded-2xl border border-gray-50 mb-4 shadow-inner">
                                                    <p class="text-xs text-gray-500 font-medium italic">"<?php echo e($payment->notes); ?>"</p>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            
                                            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                                                <div class="flex items-center gap-4">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payment->proof_image): ?>
                                                        <button onclick="showProofLightbox('<?php echo e(asset($payment->proof_image)); ?>')" 
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$payment->is_verified): ?>
                                                        <form action="<?php echo e(route('finance.verify-order-payment', $payment->id)); ?>" method="POST" onsubmit="return confirm('Konfirmasi verifikasi uang masuk ini?')">
                                                            <?php echo csrf_field(); ?>
                                                ...
                                                <div class="flex flex-col items-end">
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <p class="text-[10px] font-black text-gray-900 uppercase tracking-tight italic"><?php echo e($payment->pic->name ?? '-'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payments->count() > 0): ?>
                        <div class="bg-gray-900 px-8 py-8 flex justify-between items-center relative overflow-hidden">
                            ...
                            <span class="relative z-10 font-black text-[#22AF85] text-4xl tracking-tighter italic">Rp <?php echo e(number_format($order->payments->sum('amount_total'), 0, ',', '.')); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
    ...
    <div x-data="{ 
            ...
            type: '<?php echo e($order->shipping_type ?? 'Ekspedisi'); ?>',
            zone: '<?php echo e($order->shipping_zone ?? 'Custom'); ?>',
            cost: <?php echo e($order->shipping_cost ?? 0); ?>,
            weight: 1000,
            searchQuery: '',
            searchResults: [],
            ...
            zones: {
                ...
                'Custom': <?php echo e($order->shipping_cost ?? 0); ?>
            ...
            searchLocation() {
                ...
                fetch(`<?php echo e(route('finance.shipping.search')); ?>?q=${this.searchQuery}`, {
                    method: 'POST',
            ...
            checkRates() {
                ...
                fetch(`<?php echo e(route('finance.shipping.rates')); ?>`, {
                    method: 'POST',
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div x-show="tab === 'check'" class="space-y-4">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->customer && $order->customer->city_id): ?>
                                <div class="mb-4 p-3 bg-[#22AF85]/10 border border-[#22AF85]/30 rounded-lg flex items-center justify-between">
                                    <div class="text-xs text-gray-700">
                                        ...
                                        <?php echo e($order->customer->city); ?>

                                    </div>
                                    <button @click="useCustomerLocation(<?php echo e($order->customer->city_id); ?>, '<?php echo e($order->customer->city); ?>')" 
    ...
    <script>
        ...
        function updateDueDate(date) {
            ...
            fetch('<?php echo e(route('finance.update-due-date', $order->id)); ?>', {
                method: 'POST',
                headers: {
        ...
        function validatePayment(event) {
            ...
            const maxAmount = <?php echo e($order->sisa_tagihan); ?>;
        ...
        function saveShipping(amount, type, zone) {
            ...
            fetch("<?php echo e(route('finance.shipping.update', $order->id)); ?>", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/finance/show.blade.php ENDPATH**/ ?>