...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Station: Barang Selesai & Pickup')); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between gap-4">
                    <form method="GET" action="<?php echo e(route('finish.index')); ?>" class="w-full sm:w-1/2">
                        <div class="relative">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari SPK, Nama, atau No HP..." class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-800 dark:text-gray-200 shadow-sm text-sm">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($readyNotStored->isNotEmpty()): ?>
            <div class="mb-8 p-6 bg-gradient-to-r from-orange-500 to-amber-500 dark:from-gray-800 dark:to-gray-900 shadow-lg sm:rounded-xl text-white">
                <header class="mb-6 flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 bg-white/20 backdrop-blur-md text-white border border-white/30 rounded-full text-xs font-bold"><?php echo e($readyNotStored->count()); ?> Order</span>
                </header>

                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $readyNotStored; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        ?>
                        <div id="spk-finish-readyNotStored-<?php echo e($order->spk_number); ?>"
                             x-data="{ 
                                isHighlighted: false,
                                init() {
                            ...
                            <div class="p-3">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="min-w-0">
                                        <a href="<?php echo e(route('finish.show', $order->id)); ?>" class="font-bold text-base text-gray-800 dark:text-gray-100 hover:text-orange-500 transition-colors truncate block">
                                        ...
                                        <div class="font-medium text-xs text-gray-600 dark:text-gray-300 truncate"><?php echo e($order->shoe_brand); ?> - <?php echo e($order->shoe_color); ?></div>
                                    </div>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-md p-2 mb-3 border border-gray-100 dark:border-gray-600">
                                    ...
                                    <p class="font-semibold text-xs text-gray-900 dark:text-gray-100 truncate"><?php echo e($order->customer_name); ?></p>
                                    <p class="text-[10px] text-gray-500 truncate"><?php echo e($order->customer_phone); ?></p>
                                </div>

                                
                                <button type="button" 
                                        @click="$dispatch('storage-modal', { 
                                            workOrderId: <?php echo e($order->id); ?>,
                                            accessories: {
                                                tali: '<?php echo e($order->accessories_tali); ?>',
                                                insole: '<?php echo e($order->accessories_insole); ?>',
                                                box: '<?php echo e($order->accessories_box); ?>',
                                                other: '<?php echo e(addslashes($order->accessories_other)); ?>'
                                            }
                                        })"
                                ...
                                <button type="button" 
                                        <?php if($isLunas): ?> @click="$dispatch('shipping-modal', { workOrderId: <?php echo e($order->id); ?> })" <?php endif; ?>
                                        class="w-full <?php echo e($isLunas ? 'bg-blue-50 dark:bg-blue-900/20 border border-blue-200 text-blue-700 dark:text-blue-400 hover:bg-blue-100' : 'bg-gray-100 dark:bg-gray-800 border-gray-200 text-gray-400 cursor-not-allowed opacity-60'); ?> py-2 rounded-md shadow-sm font-bold text-[10px] uppercase tracking-wider transition-all flex items-center justify-center gap-1"
                                        <?php echo e($isLunas ? '' : 'disabled title="Harus lunas terlebih dahulu"'); ?>>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLunas): ?>
                                    <button type="button" 
                                            @click="$dispatch('shipping-modal', { workOrderId: <?php echo e($order->id); ?>, isBypass: true })"
            ...
            <div class="p-6 bg-gradient-to-r from-teal-600 to-green-600 dark:from-gray-800 dark:to-gray-900 shadow-lg sm:rounded-xl text-white">
                <header class="mb-6 flex justify-between items-center">
                    ...
                    <span class="px-3 py-1 bg-white/20 backdrop-blur-md text-white border border-white/30 rounded-full text-xs font-bold"><?php echo e($readyStored->count()); ?> Order</span>
                </header>

                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $readyStored; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_null($order->taken_date)): ?>
                        <?php
                            $isLunas = ($order->invoice && $order->invoice->status === 'Lunas') || (!$order->invoice && in_array($order->status_pembayaran, ['L', 'Lunas']));
                        ?>
                        <div id="spk-finish-readyStored-<?php echo e($order->spk_number); ?>"
                             x-data="{ 
                                isHighlighted: false,
                                init() {
                                    const urlParams = new URLSearchParams(window.location.search);
                            ...
                            <div class="p-3">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="min-w-0">
                                        <a href="<?php echo e(route('finish.show', $order->id)); ?>" class="font-bold text-base text-gray-800 dark:text-gray-100 hover:text-teal-500 transition-colors truncate block">
                                            <?php echo e($order->spk_number); ?>
                                    ...
                                    <div class="bg-teal-50 dark:bg-teal-900/20 p-3 rounded-lg border border-teal-100 dark:border-teal-800 flex flex-col gap-2">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="text-xs font-bold bg-teal-100 text-teal-700 px-2 py-0.5 rounded border border-teal-200 shadow-sm">
                                                📦 <?php echo e($order->storage_rack_code); ?>
                                        ...
                                        <div class="flex flex-col gap-2 mt-1">
                                            <div class="grid grid-cols-2 gap-2">
                                                <a href="<?php echo e(route('storage.label', ['id' => $order->id])); ?>" target="_blank" 
                                                ...
                                                <a href="<?php echo e(route('storage.shipping-label', ['id' => $order->id])); ?>" target="_blank" 
                                            ...
                                            <form action="<?php echo e(route('storage.unassign', $order->id)); ?>" method="POST" onsubmit="return confirm('Lepas tag rak? Item akan kembali ke status Menunggu Disimpan.');" class="w-full">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
                                ...
                                <form action="<?php echo e(route('storage.retrieve', isset($order->storageAssignment) ? $order->storageAssignment->id : 0)); ?>" method="POST"> 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assignment): ?>
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <button formaction="<?php echo e(route('storage.retrieve', $assignment->id)); ?>" 
                                                class="w-full <?php echo e($isLunas ? 'bg-teal-600 hover:bg-teal-700 text-white shadow hover:shadow-md' : 'bg-gray-300 text-gray-500 cursor-not-allowed'); ?> py-2 rounded-md font-bold text-[10px] uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all"
                                                <?php echo e($isLunas ? '' : 'disabled title="Harus lunas terlebih dahulu"'); ?>>
                                ...
                                <button type="button" onclick="openReportModal(<?php echo e($order->id); ?>)" class="w-full mt-2 text-amber-600 hover:text-amber-800 text-[10px] font-bold hover:bg-amber-50 py-1.5 rounded transition-colors flex items-center justify-center gap-1">
            ...
            <div id="history-section" 
                 x-data="{ 
                    ...
                    selectAll: false,
                    toggleAll() {
                        this.selectedIds = this.selectAll ? <?php echo e(Js::from($history->pluck('id'))); ?> : [];
                    },
                    updateSelectAll() {
                        this.selectAll = this.selectedIds.length === <?php echo e($history->count()); ?> && <?php echo e($history->count()); ?> > 0;
                    }
                 }"
                ...
                <div x-show="selectedIds.length > 0" 
                    ...
                    <form action="<?php echo e(route('finish.bulk-delete-selection')); ?>" method="POST" @submit.prevent="if(confirm('Hapus ' + selectedIds.length + ' riwayat terpilih?')) $el.submit()">
                        <?php echo csrf_field(); ?>
                ...
                <header class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <!-- Trash Link -->
                        <a href="<?php echo e(route('finish.trash')); ?>" class="text-xs px-3 py-1.5 bg-red-50 text-red-600 hover:bg-red-100 rounded-lg font-bold border border-red-200 transition-colors flex items-center gap-1">
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Bulk Delete Form -->
                        <form action="<?php echo e(route('finish.bulk-destroy')); ?>" method="POST" class="flex items-center gap-2" onsubmit="return confirm('PERINGATAN: Semua data pada tanggal yang dipilih akan DIHAPUS PERMANEN. Anda yakin?');">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                ...
                <div class="overflow-x-auto -mx-4 sm:mx-0">
                    <table class="min-w-full w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr id="spk-finish-history-<?php echo e($order->spk_number); ?>"
                                x-data="{ 
                                    isHighlighted: false,
                                    init() {
                                        const urlParams = new URLSearchParams(window.location.search);
                                ...
                                :class="{
                                    'bg-teal-50 dark:bg-teal-900/10': selectedIds.includes(<?php echo e($order->id); ?>),
                                ...
                                <td class="px-6 py-4">
                                    <a href="<?php echo e(route('finish.show', $order->id)); ?>" class="font-bold text-teal-600 hover:underline block">
                                        <?php echo e($order->spk_number); ?>

                                    </a>
                                    <div class="mt-1 mb-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($order->invoice && $order->invoice->status === 'Lunas') || (!$order->invoice && in_array($order->status_pembayaran, ['L', 'Lunas']))): ?>
                                    ...
                                    <div class="text-xs text-gray-500 font-medium"><?php echo e($order->customer_name); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->customer_phone): ?>
                                        <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', preg_replace('/[^0-9]/', '', $order->customer_phone))); ?>" target="_blank" class="inline-flex items-center gap-1 mt-1 text-[10px] font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-full hover:bg-green-100 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                     <div class="font-medium text-gray-900 dark:text-gray-200"><?php echo e($order->shoe_brand); ?></div>
                                     <div class="text-xs text-gray-400"><?php echo e($order->shoe_color); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="space-y-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <div class="text-xs flex justify-between gap-4 text-gray-600 dark:text-gray-400">
                                                <span><?php echo e($wos->custom_service_name ?? ($wos->service->name ?? 'Jasa Tidak Diketahui')); ?></span>
                                                <span class="font-mono"><?php echo e(number_format($wos->cost, 0, ',', '.')); ?></span>
                                            </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        <div class="border-t border-gray-200 dark:border-gray-600 pt-1 mt-1 flex justify-between gap-4 font-bold text-xs text-gray-800 dark:text-gray-200">
                                            <span>Total</span>
                                            <span>Rp <?php echo e(number_format($order->total_service_price, 0, ',', '.')); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <?php echo e($order->taken_date->format('d M Y, H:i')); ?>

                                        
                                        <!-- Cancel Pickup Action -->
                                        <form action="<?php echo e(route('finish.cancel-pickup', $order->id)); ?>" method="POST" class="inline-block ml-2">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <!-- Safe Delete Action -->
                                        <form action="<?php echo e(route('finish.destroy', $order->id)); ?>" method="POST" class="inline-block ml-1">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
    ...
    <?php echo $__env->make('storage.partials.assign-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-[400px] max-w-[90vw] text-left transform transition-all"
            ...
            <form :action="`/finish/${workOrderId}/pickup-delivery`" method="POST" onsubmit="return confirm(isBypass ? 'Konfirmasi Bypass Pengiriman?' : 'Konfirmasi proses pengiriman?')">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="tanggal_masuk" required value="<?php echo e(date('Y-m-d')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/finish/index.blade.php ENDPATH**/ ?>