                            ...
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <div class="text-2xl font-black text-gray-900 italic tracking-tighter tabular-nums">
                                        Rp <?php echo e(number_format($invoice->target_dp_amount + ($invoice->dp_unique_code ?? 0), 0, ',', '.')); ?>
                        ...
                        <div class="p-6 bg-slate-50 rounded-[2rem] border border-gray-100 transition-all hover:bg-white hover:shadow-xl group/fp" x-data="{ copied: false }">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <div class="text-2xl font-black text-gray-900 italic tracking-tighter tabular-nums">
                                        Rp <?php echo e(number_format($invoice->remaining_balance + ($invoice->final_unique_code ?? 0), 0, ',', '.')); ?>
                        ...
                        <div class="p-6 bg-slate-50 rounded-[2rem] border border-gray-100 transition-all hover:bg-white hover:shadow-xl group/full" x-data="{ copied: false }">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <div class="text-2xl font-black text-gray-900 italic tracking-tighter tabular-nums">
                                        Rp <?php echo e(number_format($invoice->total_amount + $invoice->shipping_cost + ($invoice->final_unique_code ?? 0), 0, ',', '.')); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2867143261-0', $__key);
