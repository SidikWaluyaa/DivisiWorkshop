...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Detail Barang Manual')); ?>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gray-50 px-8 py-6 border-b flex justify-between items-center">
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->status === 'stored'): ?>
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-900 text-right"><?php echo e($item->rack_code); ?></div>
                    </div>
                </div>
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->image_path): ?>
                                <img src="<?php echo e($item->image_url); ?>" alt="<?php echo e($item->item_name); ?>" class="w-full rounded-xl shadow-md border cursor-pointer" onclick="window.open(this.src, '_blank')">
                            <?php else: ?>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="text-xl font-bold text-gray-900"><?php echo e($item->spk_number ?? 'No SPK'); ?></div>
                                <p class="text-gray-600 text-lg"><?php echo e($item->item_name); ?></p>
                            </div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                ...
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    ?>
                                    <span class="px-2 py-0.5 rounded text-xs font-bold border <?php echo e($color); ?> uppercase">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $item->payment_status))); ?>
                                ...
                                <div class="space-y-2">
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-medium">Rp <?php echo e(number_format($item->total_price, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-500">Sudah Dibayar</span>
                                        <span class="font-medium text-green-600">Rp <?php echo e(number_format($item->paid_amount, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="border-t border-gray-200 my-2 pt-2 flex justify-between items-center">
                                        ...
                                        <?php $remaining = $item->total_price - $item->paid_amount; ?>
                                        <span class="font-bold text-lg <?php echo e($remaining > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-gray-600"><?php echo e($item->quantity); ?> Unit</p>
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="font-medium"><?php echo e($item->storer->name ?? 'Unknown'); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e($item->in_date->format('d M Y H:i')); ?></p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->out_date): ?>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase tracking-wider mb-1">Diambil Oleh</p>
                                    <p class="font-medium"><?php echo e($item->retriever->name ?? 'Unknown'); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e($item->out_date->format('d M Y H:i')); ?></p>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 pt-6 border-t flex justify-between items-center">
                        <form action="<?php echo e(route('storage.manual.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus data ini permanen?');">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="flex space-x-3">
                             <a href="<?php echo e(route('storage.manual.edit', $item->id)); ?>" class="px-5 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium transition">
                                Edit
                            </a>
                            <form action="<?php echo e(route('storage.manual.release', $item->id)); ?>" method="POST" onsubmit="return confirm('Keluarkan item ini dari gudang?');">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\manual-storage\show.blade.php ENDPATH**/ ?>