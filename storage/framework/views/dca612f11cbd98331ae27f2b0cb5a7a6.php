        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-900"><?php echo e($lead->spk->spk_number); ?></p>
                </div>
                <div>
                    <label class="text-xs text-gray-500 font-semibold">Status</label>
                    <p><span class="px-2 py-1 rounded text-xs font-semibold <?php echo e($lead->spk->status_badge_class); ?>"><?php echo e($lead->spk->label); ?></span></p>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-[1.5rem] p-5 mb-4">
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-bold">Rp <?php echo e(number_format($lead->spk->total_price, 0, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between mb-2">
                    <span class="text-gray-600">DP Amount:</span>
                    <span class="font-semibold text-yellow-600">Rp <?php echo e(number_format($lead->spk->dp_amount, 0, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Remaining:</span>
                    <span class="font-semibold text-red-600">Rp <?php echo e(number_format($lead->spk->remaining_payment, 0, ',', '.')); ?></span>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="mt-1">
                    <span class="px-3 py-1 rounded-lg text-xs font-black uppercase tracking-widest <?php echo e($lead->spk->dp_status_badge_class); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->spk->status === 'WAITING_DP'): ?>
            ...
            <?php elseif($lead->spk->status === 'WAITING_VERIFICATION'): ?>
            ...
            <?php elseif($lead->spk->status === 'HANDED_TO_WORKSHOP'): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\spk-detail.blade.php ENDPATH**/ ?>