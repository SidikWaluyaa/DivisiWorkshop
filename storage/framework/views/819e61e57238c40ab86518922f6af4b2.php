        ...
        <div class="bg-gradient-to-r from-teal-50 to-orange-50 px-6 py-5 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <span class="px-3 py-1.5 bg-gradient-to-r from-teal-100 to-orange-100 text-gray-700 rounded-lg text-xs font-black">
                    Total: <?php echo e($matrixData['total_spk'] ?? 0); ?> SPK
                </span>
            </div>
        </div>
        <div class="p-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($matrixData['groups'])): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $matrixData['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php $colors = $groupColors[$groupName] ?? $groupColors['Persiapan']; ?>
                <div class="rounded-xl border <?php echo e($colors['border']); ?> <?php echo e($colors['bgLight']); ?> overflow-hidden flex flex-col h-full">
                    
                    <div class="bg-gradient-to-r <?php echo e($colors['bg']); ?> px-4 py-3 flex items-center justify-between">
                        <span class="text-white font-black text-sm tracking-tight uppercase"><?php echo e($groupName); ?></span>
                        <div class="flex items-center gap-1.5">
                            <span class="bg-white/20 backdrop-blur-sm px-2.5 py-1 rounded-lg text-white text-[10px] font-black">
                                <?php echo e($group['total']); ?> SPK
                            </span>
                        </div>
                    </div>
                    
                    <div class="p-3 space-y-2 flex-grow">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subName => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($subName, ['total', 'total_followup', 'bottleneck'])): ?>
                            <?php 
                                $isBottleneck = ($subName === $group['bottleneck'] && $data['count'] > 0);
                            ?>
                            <div class="flex flex-col px-3 py-2.5 rounded-xl transition-all duration-300 <?php echo e($isBottleneck ? 'bg-red-50 border-2 border-red-200 shadow-sm animate-pulse' : ($data['count'] > 0 ? 'bg-white shadow-sm' : 'bg-transparent opacity-60')); ?>">
                                <div class="flex items-center justify-between mb-0.5">
                                    <span class="text-[11px] font-bold <?php echo e($isBottleneck ? 'text-red-700' : ($data['count'] > 0 ? $colors['text'] : 'text-gray-400')); ?>">
                                        <?php echo e($subName); ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isBottleneck): ?>
                                    ...
                                    <span class="text-xs font-black <?php echo e($isBottleneck ? 'text-red-800' : ($data['count'] > 0 ? 'text-gray-800' : 'text-gray-300')); ?>">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-[10px] <?php echo e($isBottleneck ? 'text-red-600 font-bold' : 'text-gray-500'); ?>">
                                        <?php echo e($data['avg_hours']); ?>h
                                    </span>
                                </div>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\workshop\widgets\spk-matrix.blade.php ENDPATH**/ ?>