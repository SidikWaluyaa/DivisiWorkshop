    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center justify-between group hover:border-[#22AF85]/30 transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($manifests->where('status', 'SENT')->count()); ?></p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center justify-between group hover:border-[#22AF85]/30 transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($manifests->where('status', 'RECEIVED')->count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center justify-between group hover:border-[#22AF85]/30 transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="text-2xl font-black text-gray-900 mt-1"><?php echo e($manifests->sum('work_orders_count')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
            <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-white/50 backdrop-blur-sm">
                ...
                <div class="text-xs font-bold text-gray-400">Total: <?php echo e($manifests->total()); ?> Records</div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $manifests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manifest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="hover:bg-[#22AF85]/[0.02] transition-colors group">
                            <td class="px-8 py-6 whitespace-nowrap">
                                <span class="text-sm font-black text-[#22AF85] tracking-tight"><?php echo e($manifest->manifest_number); ?></span>
                            ...
                            <td class="px-6 py-6 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 font-bold text-xs">
                                        <?php echo e(strtoupper(substr($manifest->dispatcher->name, 0, 1))); ?>

                                    </div>
                                    <div class="ml-3">
                                        <p class="text-sm font-bold text-gray-800"><?php echo e($manifest->dispatcher->name); ?></p>
                                        <p class="text-[11px] text-gray-400 mt-0.5"><?php echo e($manifest->dispatched_at->format('d M Y • H:i')); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-6 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-gray-100 text-gray-700 text-xs font-black">
                                    <?php echo e($manifest->work_orders_count); ?> Pasang
                                </span>
                            </td>
                            <td class="px-6 py-6 whitespace-nowrap text-center">
                            ...
                            <td class="px-8 py-6 whitespace-nowrap text-right">
                                <a href="<?php echo e(route('manifest.show', $manifest->id)); ?>" class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white border border-gray-200 text-gray-400 hover:text-[#22AF85] hover:border-[#22AF85] transition-all group-hover:shadow-md">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manifests->hasPages()): ?>
            <div class="px-8 py-6 bg-gray-50/50 border-t border-gray-100">
                <?php echo e($manifests->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\manifest\index.blade.php ENDPATH**/ ?>