...
<div id="quotationModal" class="hidden fixed inset-0 bg-gray-900/80 backdrop-blur-md overflow-y-auto h-full w-full z-[100] transition-all duration-300">
    <div class="relative top-10 mx-auto p-0 border-0 w-full max-w-4xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2.5rem] bg-white mb-20 overflow-hidden" 
        ...
        <div class="p-10">
            <form action="<?php echo e(route('cs.quotations.store', $lead->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-10">
                <?php echo csrf_field(); ?>
                <div class="space-y-6">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\modals\quotation.blade.php ENDPATH**/ ?>