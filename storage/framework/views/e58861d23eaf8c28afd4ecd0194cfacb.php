...
<head>
    ...
    <title>Print Tag - <?php echo e($order->spk_number); ?></title>
    <style>
...
<body>
    <div class="header">
        <div class="spk"><?php echo e($order->spk_number); ?></div>
        <div class="date"><?php echo e($order->entry_date->format('d/m/Y H:i')); ?></div>
    </div>
    
    <div class="customer"><?php echo e($order->customer_name); ?></div>
    <div class="item"><?php echo e($order->shoe_brand); ?> - <?php echo e($order->shoe_type); ?> <br> (<?php echo e($order->shoe_color); ?> / <?php echo e($order->shoe_size); ?>)</div>

    <div class="barcode">
        <?php echo $barcode; ?>

    </div>
    <div style="font-size: 10px; margin-top: 2px; font-family: monospace;"><?php echo e($order->spk_number); ?></div>
    
    <button class="btn-print" onclick="window.print()">PRINT TAG</button>
</body>
</html>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\reception\print-tag.blade.php ENDPATH**/ ?>