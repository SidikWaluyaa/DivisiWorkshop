        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                <h2 class="font-bold text-xl leading-tight tracking-wide">
                    <?php echo e(__('Sortir & Material Station')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="{ activeTab: 'ready' }">
            ...
            <div class="flex items-center gap-1 mb-6 bg-gray-200/50 p-1 rounded-2xl w-fit mx-auto shadow-inner">
                <button @click="activeTab = 'ready'" 
                    ...
                    Siap Produksi
                    <span class="bg-teal-100 text-teal-700 px-2 py-0.5 rounded-md text-[10px]"><?php echo e($readyOrders->total()); ?></span>
                </button>
                <button @click="activeTab = 'waiting'" 
                    ...
                    Waiting List
                    <span class="bg-orange-100 text-orange-700 px-2 py-0.5 rounded-md text-[10px]"><?php echo e($waitingOrders->total()); ?></span>
                </button>
            </div>
            ...
            <div class="dashboard-card overflow-hidden">
                <div class="dashboard-card-header flex flex-col md:flex-row justify-between md:items-center gap-3">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                         ...
                         <form method="GET" action="<?php echo e(route('sortir.index')); ?>" class="relative">
                            <input type="text" 
                                   name="search" 
                ...
                <div class="dashboard-card-body p-0">
                    ...
                    <div x-show="activeTab === 'ready'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50 text-[10px] font-black text-gray-500 uppercase tracking-wider text-left">
                                    <tr>
                                        <th class="px-6 py-3 text-center w-12">
                                            <input type="checkbox" 
                                                   @click="toggleGroup(<?php echo e($readyOrders->pluck('id')); ?>)"
                                                   :checked="isGroupSelected(<?php echo e($readyOrders->pluck('id')); ?>)"
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-teal-50/30 transition-colors" :class="selectedItems.includes('<?php echo e($order->id); ?>') ? 'bg-teal-50' : ''">
                                        <td class="px-6 py-4 text-center">
                                            <input type="checkbox" value="<?php echo e($order->id); ?>" x-model="selectedItems" class="rounded border-gray-300 text-teal-600 focus:ring-teal-500">
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="font-mono font-bold text-gray-800 text-sm mb-1"><?php echo e($order->spk_number); ?></div>
                                            <?php echo $__env->make('sortir.partials.priority-badge', ['priority' => $order->priority], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-bold text-gray-900 leading-none"><?php echo e($order->customer_name); ?></div>
                                            <div class="text-[10px] text-gray-500 mt-1 uppercase font-medium"><?php echo e($order->shoe_brand); ?> - <?php echo e($order->shoe_color); ?> (<?php echo e($order->shoe_size); ?>)</div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex flex-wrap gap-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->services->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <span class="px-2 py-0.5 rounded text-[9px] bg-gray-100 text-gray-600 border border-gray-200 font-bold uppercase">
                                                        <?php echo e($s->name === 'Custom Service' && $s->pivot->custom_name ? $s->pivot->custom_name : $s->name); ?>

                                                    </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->services->count() > 3): ?>
                                                    <span class="text-[9px] text-gray-400 font-bold">+<?php echo e($order->services->count() - 3); ?></span>
                                            ...
                                            <div class="flex flex-col gap-1.5 min-w-[140px]">
                                                <div class="flex items-center justify-between gap-2">
                                                    <div class="flex-grow h-1 bg-gray-100 rounded-full overflow-hidden">
                                                        <div class="h-full <?php echo e($isReady ? 'bg-[#22AF85]' : 'bg-[#FFC232]'); ?> transition-all duration-500" 
                                                             style="width: <?php echo e($totalMat > 0 ? ($allocatedMat / $totalMat * 100) : 100); ?>%"></div>
                                                    </div>
                                                    <span class="text-[9px] font-black <?php echo e($isReady ? 'text-[#22AF85]' : 'text-[#FFC232]'); ?> uppercase tracking-widest">
                                                        <?php echo e($isReady ? 'READY' : 'PARTIAL'); ?>

                                                    </span>
                                                </div>
                                                <div class="text-[9px] text-gray-400 font-bold uppercase tracking-tight">
                                                    <?php echo e($allocatedMat); ?>/<?php echo e($totalMat ?: 0); ?> Material Tersedia
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                                            <div class="flex justify-end gap-2.5">
                                                ...
                                                <a href="<?php echo e(route('sortir.show', $order->id)); ?>" 
                                                   title="Cek Material"
                                                ...
                                                <form action="<?php echo e(route('sortir.skip-production', $order->id)); ?>" method="POST" onsubmit="return confirm('Bypass Sortir (Legacy Data)? SPK akan langsung masuk Production.')">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($readyOrders->hasPages()): ?>
                        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                            <?php echo e($readyOrders->links()); ?>
                    ...
                    <div x-show="activeTab === 'waiting'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-orange-50/30 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="font-mono font-bold text-gray-800 text-sm mb-1 opacity-70"><?php echo e($order->spk_number); ?></div>
                                            <?php echo $__env->make('sortir.partials.priority-badge', ['priority' => $order->priority], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-bold text-gray-900 leading-none"><?php echo e($order->customer_name); ?></div>
                                            <div class="text-[10px] text-gray-500 mt-1 uppercase font-medium"><?php echo e($order->shoe_brand); ?></div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="flex flex-wrap gap-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->services->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="flex flex-col gap-1.5 min-w-[140px]">
                                                <div class="flex items-center justify-between gap-2">
                                                    <div class="flex-grow h-1 bg-gray-100 rounded-full overflow-hidden">
                                                        <div class="h-full bg-[#FFC232] transition-all duration-500" 
                                                             style="width: <?php echo e($totalMat > 0 ? ($allocatedMat / $totalMat * 100) : 0); ?>%"></div>
                                                    </div>
                                                ...
                                                <div class="text-[9px] text-red-400 font-bold uppercase tracking-tight">
                                                    <?php echo e($totalMat - $allocatedMat); ?> Material Belum Siap
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right">
                         ...
                         <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($waitingOrders->hasPages()): ?>
                        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                            <?php echo e($waitingOrders->links()); ?>
    ...
    <script>
        ...
        function bulkFinishSortir() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('<?php echo e(route('sortir.bulk-update')); ?>', {
                        method: 'POST',
                        headers: {
        ...
        function bulkSkipToProduction() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('<?php echo e(route('sortir.bulk-skip-production')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\sortir\index.blade.php ENDPATH**/ ?>