            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden group hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1">
                    ...
                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                        <img src="<?php echo e(Storage::url($photo->file_path)); ?>" 
                             alt="After Photo" 
                        ...
                        <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
                            <a href="<?php echo e(Storage::url($photo->file_path)); ?>" download="<?php echo e($photo->workOrder->spk_number); ?>_after.jpg" 
                            ...
                            <button onclick="copyImage('<?php echo e(Storage::url($photo->file_path)); ?>')" 
                        ...
                        <div class="absolute top-3 left-3 flex flex-wrap gap-1 max-w-[80%]">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $photo->workOrder->workOrderServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start mb-2">
                            <div class="min-w-0">
                                <h3 class="font-bold text-teal-600 text-xs truncate"><?php echo e($photo->workOrder->spk_number); ?></h3>
                                <p class="font-black text-gray-900 dark:text-white text-sm truncate uppercase"><?php echo e($photo->workOrder->customer_name); ?></p>
                            </div>
                            <span class="text-[9px] font-bold text-gray-400 shrink-0"><?php echo e($photo->created_at->format('d M Y')); ?></span>
                        </div>
