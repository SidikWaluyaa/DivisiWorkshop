...
<head>
    ...
    <title>Preview Manifest Pengiriman - <?php echo e($date_start); ?></title>
...
<body class="p-4 md:p-8">
    ...
    <div class="max-w-4xl mx-auto mb-6 flex justify-between items-center no-print">
        <a href="<?php echo e(route('shipping.index')); ?>" class="flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-gray-700 transition-colors">
        ...
        <div class="flex gap-3">
            ...
            <a href="<?php echo e(route('shipping.manifest.download', request()->all())); ?>" class="bg-gray-800 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-gray-900 transition-all flex items-center gap-2">
    ...
    <div class="max-w-[210mm] mx-auto bg-white shadow-2xl rounded-sm border border-gray-100 p-10 print-container overflow-hidden">
        ...
        <div class="flex justify-between items-start mb-10 pb-10 border-b-2 border-gray-50">
            ...
            <div class="text-right">
                ...
                <div class="text-sm font-bold text-gray-900"><?php echo e($printed_at->translatedFormat('d F Y H:i')); ?></div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-8 mb-12">
            ...
            <div>
                ...
                <div class="inline-flex items-center px-3 py-1 bg-[#FFC232] text-black rounded-lg text-xs font-bold uppercase tracking-wider">
                    <?php echo e($category ?: 'Semua Kategori'); ?>
            ...
            <div class="text-right">
                ...
                <div class="text-sm font-extrabold text-gray-900 underline decoration-[#FFC232] decoration-4 underline-offset-4">
                    <?php echo e($prepared_by ?: 'Bagian Shipping'); ?>
        ...
        <table class="w-full mb-8 border border-gray-100 rounded-lg overflow-hidden manifest-table">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td class="px-4 py-5 text-center text-xs font-bold text-gray-400"><?php echo e($index + 1); ?></td>
                    ...
                    <td class="px-4 py-5">
                        <div class="text-sm font-bold text-gray-900"><?php echo e($item->workOrder->customer_name ?? 'N/A'); ?></div>
                        <div class="text-[10px] font-bold text-gray-400 uppercase tracking-wider"><?php echo e($item->workOrder->customer_phone ?? ''); ?></div>
                    </td>
                    <td class="px-4 py-5">
                        <span class="text-[10px] font-bold text-black bg-[#FFC232]/20 px-2 py-1 rounded">
                            <?php echo e($item->kategori_pengiriman ?: '-'); ?>
                    ...
                    <td class="px-4 py-5 font-medium text-xs text-gray-600">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->resi_pengiriman): ?>
                            <div class="font-bold text-[#22AF85] spk-badge"><?php echo e($item->resi_pengiriman); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->pic): ?>
                            <div class="text-[10px] font-bold uppercase tracking-widest text-gray-400 mt-1">PIC: <?php echo e($item->pic); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
        ...
        <div class="mt-8 flex justify-end">
            <div class="inline-flex gap-8 px-8 py-4 border-2 border-[#22AF85]/10 rounded-2xl bg-gray-50/50">
                <div class="text-right">
                    ...
                    <p class="text-2xl font-black text-gray-900 leading-none"><?php echo e(count($shippings)); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Pasang</p>
                    <p class="text-2xl font-black text-[#22AF85] leading-none"><?php echo e(count($shippings)); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\shipping\manifest_preview.blade.php ENDPATH**/ ?>