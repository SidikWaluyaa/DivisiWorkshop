...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 flex-1 justify-end max-w-xl">
                <form id="navbar-tracking-form" action="<?php echo e(route('tracking.track')); ?>" method="POST" class="w-full relative transform translate-y-1">
                    <?php echo csrf_field(); ?>
                    <div class="relative">
            ...
            <script>
                ...
                function performSearch(query) {
                    ...
                    fetch('<?php echo e(route("tracking.track")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                     ...
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-all focus:outline-none">
                            ...
                            <span class="text-white text-sm font-medium hidden md:block"><?php echo e(Auth::user()->name); ?></span>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <div class="px-4 py-2 border-b border-gray-200">
                            <div class="text-sm font-bold text-gray-900"><?php echo e(Auth::user()->name); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e(Auth::user()->role); ?></div>
                        </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'onclick' => 'event.preventDefault(); this.closest(\'form\').submit();','class' => 'flex items-center gap-2 text-red-600 hover:bg-red-50']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>