                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="p-5 bg-gray-50 rounded-2xl border border-gray-100 hover:border-[#22AF85]/30 transition-all group overflow-hidden">
                            ...
                            <div class="flex items-center gap-3">
                                <input type="number" name="hk_days" value="<?php echo e($order->hk_days ?? 0); ?>" 
                        ...
                        <div class="p-5 bg-gray-50 rounded-2xl border border-gray-100 hover:border-[#22AF85]/30 transition-all group overflow-hidden flex flex-col justify-center">
                            ...
                            <div class="flex justify-center">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="is_warranty" value="1" <?php echo e($order->is_warranty ? 'checked' : ''); ?> class="sr-only peer">
                                            ...
                                            <div class="mt-auto space-y-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($service->service_details['manual_detail']) && !empty($service->service_details['manual_detail'])): ?>
                                                    <div class="p-2 bg-yellow-50 border border-yellow-100 rounded-lg text-[10px] text-yellow-800 font-bold italic">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($service->service_details['manual_detail'])): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $service->service_details['manual_detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                                <div style="margin-bottom: 1px;">• <?php echo e($line); ?></div>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                        <?php else: ?>
