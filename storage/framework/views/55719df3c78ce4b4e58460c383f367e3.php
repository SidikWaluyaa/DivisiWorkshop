...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1"><?php echo e($materialRequest->request_number); ?></p>
        </div>

        <a href="<?php echo e(route('material-requests.index')); ?>" class="px-4 py-2 border-2 rounded-lg font-medium transition-all duration-200 hover:shadow-md" style="border-color: #22AF85; color: #22AF85;">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-bold text-lg" style="color: #22AF85;"><?php echo e($materialRequest->request_number); ?></p>
                    </div>

                    <div>
                        <p class="text-sm text-gray-600 mb-1">Tipe</p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->type === 'SHOPPING'): ?>
                    ...
                    <div>
                        ...
                        <span class="inline-block px-3 py-1 rounded-full text-sm font-medium
                            <?php if($materialRequest->status === 'PENDING'): ?> bg-yellow-100 text-yellow-800
                            <?php elseif($materialRequest->status === 'APPROVED'): ?> bg-green-100 text-green-800
                            <?php elseif($materialRequest->status === 'REJECTED'): ?> bg-red-100 text-red-800
                            <?php elseif($materialRequest->status === 'PURCHASED'): ?> bg-blue-100 text-blue-800
                    ...
                    <div>
                        ...
                        <p class="font-medium"><?php echo e($materialRequest->created_at->format('d M Y H:i')); ?></p>
                    </div>

                    <div>
                        <p class="text-sm text-gray-600 mb-1">Diminta Oleh</p>
                        <p class="font-medium"><?php echo e($materialRequest->requestedBy->name ?? 'N/A'); ?></p>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->work_order_id): ?>
                        <div>
                            ...
                            <p class="font-medium"><?php echo e($materialRequest->workOrder->spk_number ?? 'N/A'); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->oto_id): ?>
                        <div>
                            <p class="text-sm text-gray-600 mb-1">OTO</p>
                            <p class="font-medium"><?php echo e($materialRequest->oto->oto_number ?? 'N/A'); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->approved_by): ?>
                        <div>
                            ...
                            <p class="font-medium"><?php echo e($materialRequest->approvedBy->name ?? 'N/A'); ?></p>
                        </div>

                        <div>
                            <p class="text-sm text-gray-600 mb-1">Tanggal Approval</p>
                            <p class="font-medium"><?php echo e($materialRequest->approved_at->format('d M Y H:i')); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->notes): ?>
                    <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-gray-800"><?php echo e($materialRequest->notes); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $materialRequest->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="border-b border-gray-200 hover:bg-gray-50">
                                    <td class="py-3 px-2 text-gray-600"><?php echo e($index + 1); ?></td>
                                    <td class="py-3 px-2 text-xs font-black text-gray-600 uppercase">
                                        <?php echo e($item->workOrder->spk_number ?? 'N/A'); ?>

                                    </td>
                                    <td class="py-3 px-2">
                                        <p class="font-medium text-gray-800"><?php echo e($item->material_name); ?></p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->isCustomMaterial()): ?>
                                            <span class="text-xs px-2 py-1 bg-gray-100 text-gray-600 rounded">Custom</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="py-3 px-2 text-gray-600 text-sm"><?php echo e($item->specification ?? '-'); ?></td>
                                    <td class="py-3 px-2 text-right font-medium"><?php echo e($item->quantity); ?> <?php echo e($item->unit); ?></td>
                                    <td class="py-3 px-2 text-right">Rp <?php echo e(number_format($item->estimated_price, 0, ',', '.')); ?></td>
                                    <td class="py-3 px-2 text-right font-bold" style="color: #FFC232;">
                                        Rp <?php echo e(number_format($item->getSubtotal(), 0, ',', '.')); ?>
                        ...
                        <tfoot>
                            <tr class="border-t-2" style="border-color: #22AF85;">
                                ...
                                <td class="py-4 px-2 text-right font-bold text-xl" style="color: #FFC232;">
                                    Rp <?php echo e(number_format($materialRequest->total_estimated_cost, 0, ',', '.')); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 sticky top-4">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->status === 'PENDING'): ?>
                        <form action="<?php echo e(route('material-requests.approve', $materialRequest)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('material-requests.reject', $materialRequest)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('material-requests.cancel', $materialRequest)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->status === 'APPROVED'): ?>
                        <form action="<?php echo e(route('material-requests.mark-purchased', $materialRequest)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->status === 'PURCHASED'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->status === 'REJECTED'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($materialRequest->status === 'CANCELLED'): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\material-requests\show.blade.php ENDPATH**/ ?>