        ...
        <div class="flex items-center gap-8">
            ...
            <div class="flex items-center gap-4 group cursor-pointer pl-2">
                ...
                <div class="w-12 h-12 rounded-2xl bg-[#22AF85] p-[2px]">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=FFFFFF&color=22AF85&bold=true" class="w-full h-full rounded-[14px] object-cover" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-[1600px] mx-auto px-8 mt-10 space-y-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <h3 class="text-4xl font-black font-inter tracking-tight text-gray-900 lowercase">Rp <?php echo e(number_format($stats['total_valuation'], 0, ',', '.')); ?></h3>
                <div class="flex items-center gap-2 mt-4">
                    ...
                    <span class="text-[10px] font-black text-[#22AF85] uppercase tracking-widest">+<?php echo e($stats['valuation_trend']); ?>% vs Bulan Lalu</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <h3 class="text-4xl font-black font-inter tracking-tight text-gray-900"><?php echo e($stats['low_stock_count']); ?> Item</h3>
            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <h3 class="text-4xl font-black font-inter tracking-tight text-gray-900"><?php echo e($stats['pending_requests']); ?> Pesanan</h3>
            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border-4 border-[#22AF85]/10 relative overflow-hidden group">
                ...
                <h3 class="text-4xl font-black font-inter tracking-tight text-gray-900">Rp <?php echo e(number_format($stats['total_purchased_value'], 0, ',', '.')); ?></h3>
                <p class="text-[10px] font-black text-[#22AF85] uppercase mt-4 tracking-[0.15em]"><?php echo e($stats['total_purchased_count']); ?> Transaksi Berstatus Purchased</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div class="lg:col-span-8 bg-white rounded-[3rem] p-12 shadow-sm border border-gray-100 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between mb-12">
                        ...
                        <a href="<?php echo e(route('admin.supply-chain.transactions')); ?>" wire:navigate class="px-7 py-3 bg-[#FFC232] text-gray-900 text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-gray-900 hover:text-white transition-all flex items-center gap-3 shadow-lg shadow-[#FFC232]/20 border border-[#FFC232]">
                            Matriks Detail
                    ...
                    <div class="space-y-10">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $topConsumed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="group">
                            <div class="flex items-center justify-between mb-4 text-xs font-black uppercase tracking-[0.1em]">
                                <div class="flex items-center gap-4">
                                    <span class="text-gray-900 text-base"><?php echo e($item->material->name); ?></span>
                                    <span class="text-gray-300 font-bold">Batch #<?php echo e(rand(1000, 9999)); ?></span>
                                </div>
                                <div class="text-right flex items-center gap-3">
                                    <span class="text-gray-900 font-inter text-base"><?php echo e(number_format($item->total_qty, 0)); ?> <span class="text-[10px] text-gray-400 font-bold uppercase"><?php echo e($item->material->unit); ?></span></span>
                                    <span class="px-3 py-1 bg-gray-50 text-[10px] rounded-lg tracking-widest <?php echo e(str_contains($item->status_label, 'Kritikal') ? 'text-[#FFC232] bg-gray-900' : ($item->ratio > 80 ? 'text-[#22AF85]' : 'text-gray-500')); ?>">
                            ...
                            <div class="h-4 bg-gray-50 rounded-full overflow-hidden border border-gray-100 p-1">
                                <div class="h-full <?php echo e($item->color_class); ?> rounded-full transition-all duration-1000 origin-left scale-x-0" 
                                     x-init="setTimeout(() => $el.classList.remove('scale-x-0'), 200)"
                                     style="width: <?php echo e($item->ratio); ?>%"></div>
                            </div>
                        </div>
            ...
            <div class="lg:col-span-4 bg-white rounded-[3rem] p-12 shadow-sm border border-gray-100 flex flex-col">
                ...
                <div class="flex-1 relative space-y-12">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $auditLedger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="relative pl-16 group pb-4">
                        
                        <div class="absolute left-0 top-0 w-11 h-11 rounded-2xl <?php echo e($tx->type == 'IN' ? 'bg-[#22AF85] text-white shadow-[#22AF85]/30' : 'bg-[#FFC232] text-gray-900 shadow-[#FFC232]/30'); ?> shadow-lg flex items-center justify-center z-10 transition-all group-hover:scale-110">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tx->type == 'IN'): ?>
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <h5 class="text-[13px] font-black text-gray-900 leading-none"><?php echo e($tx->event_label); ?></h5>
                                    <span class="px-2 py-0.5 rounded-lg <?php echo e($tx->type == 'IN' ? 'bg-emerald-50 text-[#22AF85]' : 'bg-amber-50 text-[#FFC232]'); ?> text-[8px] font-black tracking-widest uppercase border border-current/20">
                                        <?php echo e($tx->status_label); ?>

                                    </span>
                                </div>
                                <span class="text-[9px] font-black text-gray-300 uppercase italic"><?php echo e($tx->created_at->format('H:i')); ?> WIB</span>
                            </div>
                            <p class="text-[11px] font-bold text-gray-400 leading-relaxed pr-4">
                                <?php echo e(number_format($tx->quantity, 0)); ?> <?php echo e($tx->material->unit); ?> '<?php echo e($tx->material->name); ?>' <?php echo e($tx->type == 'IN' ? 'masuk' : 'keluar'); ?> untuk <?php echo e($tx->ref_detail); ?>.
                            </p>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <a href="<?php echo e(route('admin.supply-chain.transactions')); ?>" wire:navigate class="w-full mt-14 py-5 bg-gray-50 text-gray-400 text-[10px] font-black uppercase tracking-[0.25em] rounded-[2rem] hover:bg-gray-900 hover:text-white transition-all text-center border-2 border-transparent hover:border-gray-900">
                    Unduh Log Lengkap
                </a>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bottlenecks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="group hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-8">
                                <p class="text-sm font-black text-gray-900 leading-none"><?php echo e($order->spk_number); ?></p>
                                <p class="text-[10px] text-gray-400 font-bold uppercase mt-2 tracking-widest"><?php echo e($order->customer_name); ?> • <?php echo e($order->shoe_brand); ?></p>
                            </td>
                            <td class="px-6 py-8">
                                <div class="flex items-center gap-5">
                                    ...
                                    <div>
                                        <p class="text-sm font-black text-gray-700 leading-none"><?php echo e($order->materials->first()->name ?? 'N/A'); ?></p>
                                        <p class="text-[10px] text-gray-400 font-bold uppercase mt-2 tracking-wider"><?php echo e($order->materials->first()->category ?? '-'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-8 text-center">
                                <span class="text-sm font-black text-[#FFC232] bg-[#FFC232]/5 px-3 py-1 rounded-lg">
                                    <?php echo e($order->materials->sum('pivot.quantity')); ?> <?php echo e($order->materials->first()->unit ?? 'Unit'); ?>
                            ...
                            <td class="px-6 py-8 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="<?php echo e(route('material-requests.create', ['workOrderId' => $order->id])); ?>" wire:navigate class="px-8 py-3.5 bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-gray-800 transition-all shadow-xl shadow-gray-200">
                                        Buat RFQ
                                    </a>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\admin\supply-chain\dashboard.blade.php ENDPATH**/ ?>