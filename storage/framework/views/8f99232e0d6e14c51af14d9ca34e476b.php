    ...
    <div class="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="w-10 h-10 rounded-xl bg-gray-200 border border-gray-100 overflow-hidden shadow-sm">
                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&background=22AF85&color=fff" alt="User">
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-8 pt-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e(route('material-requests.create')); ?>" wire:navigate class="px-6 py-3 bg-[#FFC232] text-gray-900 text-sm font-black rounded-xl hover:shadow-lg hover:shadow-[#FFC232]/20 transition-all flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <div class="bg-white rounded-[24px] border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-gray-200/40 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="absolute left-0 top-0 bottom-0 w-[5px] <?php echo e($statusColor); ?>"></div>
                    ...
                    <div class="p-8 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="w-16 h-16 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-[#22AF85]/5 group-hover:text-[#22AF85] transition-colors">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->status == 'CANCELLED' || $request->status == 'REJECTED'): ?>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center gap-3">
                                    <h2 class="text-xl font-black text-gray-900 tracking-tight group-hover:text-[#22AF85] transition-colors"><?php echo e($request->request_number); ?></h2>
                                    <span class="px-2.5 py-1 rounded-lg <?php echo e($statusColor); ?>/10 text-<?php echo e(str_starts_with($statusColor, 'bg-') ? substr($statusColor, 3) : $statusColor); ?> text-[10px] font-black uppercase tracking-widest border border-<?php echo e(str_starts_with($statusColor, 'bg-') ? substr($statusColor, 3) : $statusColor); ?>/20">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->type == 'SHOPPING'): ?> BELANJA <?php else: ?> PO PRODUKSI <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> • <?php echo e($request->status); ?>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-2">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-sm font-bold text-gray-700"><?php echo e($request->requestedBy->name ?? 'System'); ?></span>
                                    </div>
                                    <div class="flex flex-col">
                                        <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Date</span>
                                        <span class="text-sm font-bold text-gray-700"><?php echo e($request->created_at->format('d M Y')); ?></span>
                                    </div>
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-sm font-bold text-gray-700">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->work_order_id): ?>
                                                <?php echo e($request->workOrder->spk_number); ?>

                                            <?php else: ?>
                                                <span class="text-[#22AF85]"><?php echo e($request->items->pluck('work_order_id')->unique()->filter()->count()); ?> SPKs</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </span>
                                    </div>
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-sm font-bold text-gray-700 uppercase">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->work_order_id): ?>
                                                <?php echo e($request->workOrder->category ?? '-'); ?>
                        ...
                        <div class="flex items-center gap-12 self-end lg:self-center">
                            <div class="flex flex-col text-right">
                                ...
                                <span class="text-2xl font-black text-gray-900">Rp <?php echo e(number_format($request->total_estimated_cost, 0, ',', '.')); ?></span>
                            </div>
                            
                            <div class="flex flex-col lg:flex-row items-center gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->status === 'APPROVED' || ($request->status === 'PENDING' && $request->type === 'SHOPPING')): ?>
                                    <button wire:click="quickFulfill(<?php echo e($request->id); ?>)" 
                                            wire:confirm="Konfirmasi penerimaan barang untuk <?php echo e($request->request_number); ?>? Stok akan bertambah dan SPK akan otomatis dialokasikan."
                                ...
                                <a href="<?php echo e(route('material-requests.show', $request)); ?>" wire:navigate class="flex items-center gap-3 px-8 py-4 rounded-2xl bg-[#FFC232] text-gray-900 font-black text-sm hover:shadow-lg hover:shadow-[#FFC232]/20 transition-all group/btn border-none whitespace-nowrap">
                                    Detail
                                ...
                                <button wire:click="deleteRequest(<?php echo e($request->id); ?>)" 
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\livewire\procurement\index.blade.php ENDPATH**/ ?>