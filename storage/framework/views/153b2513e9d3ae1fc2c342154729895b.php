...
<div id="spkModal" class="hidden fixed inset-0 bg-gray-900/80 backdrop-blur-md overflow-y-auto h-full w-full z-[100] transition-all duration-300">
    <div class="relative top-10 mx-auto p-0 border-0 w-full max-w-4xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2.5rem] bg-white mb-20 overflow-hidden">
        ...
        <div class="p-10">
            <form action="<?php echo e(route('cs.spk.generate', $lead->id)); ?>" method="POST" class="space-y-10">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                        <div class="flex-1 text-center md:text-left">
                            ...
                            <div id="spkPreview" class="text-4xl md:text-5xl font-mono font-black text-white tracking-tighter truncate selection:bg-[#22AF85]">
                                F-<?php echo e(date('ym-d')); ?>-XXXX-<?php echo e(strtoupper($lead->cs->cs_code ?? '??')); ?>
                        ...
                        <div class="w-full md:w-auto grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="manual_cs_code" id="manualCsInput" required maxlength="5" value="<?php echo e($lead->cs->cs_code ?? ''); ?>" 
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="expected_delivery_date" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="special_instructions" rows="4" 
                                      ...
                                      placeholder="Catatan pengerjaan atau request khusus customer..."><?php echo e($lead->getAcceptedQuotation()->notes ?? ''); ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="p-8 bg-gray-50/50 rounded-[2.5rem] border-2 border-gray-100 space-y-6">
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="customer_name" value="<?php echo e($lead->customer_name); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="customer_phone" value="<?php echo e($lead->customer_phone); ?>" required
                                           class="w-full px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-black text-gray-900 bg-white shadow-sm">
                                </div>
                            </div>
                            <div>
                                ...
                                <textarea name="customer_address" rows="2" required
                                          class="w-full px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-bold text-gray-900 bg-white shadow-sm"><?php echo e($lead->customer_address); ?></textarea>
                            </div>
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">Kota</label>
                                    <input type="text" name="customer_city" value="<?php echo e($lead->customer_city); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="customer_province" value="<?php echo e($lead->customer_province); ?>" required
                                           class="w-full px-5 py-3 rounded-xl border-2 border-white focus:border-[#22AF85] focus:ring-0 text-xs font-bold text-gray-900 bg-white shadow-sm">
                                </div>
                            </div>
                        </div>
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($acceptedQuotation && count($acceptedQuotation->quotationItems ?? []) > 0): ?>
                    <div class="pt-10 border-t border-gray-100">
                        <h4 class="text-xs font-black text-gray-900 uppercase tracking-[0.2em] mb-8 flex items-center justify-between">
                            ...
                            <span class="px-4 py-1.5 bg-[#22AF85]/10 text-[#22AF85] rounded-full text-[9px] font-black uppercase tracking-widest border border-[#22AF85]/20">
                                Active Quotation: #<?php echo e($acceptedQuotation->quotation_number); ?>

                            </span>
                        </h4>

                        <div class="space-y-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $acceptedQuotation->quotationItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotationItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="bg-gray-50/50 rounded-[2.5rem] p-8 border-2 border-gray-100 transition-all duration-500 hover:border-[#22AF85]/20 hover:bg-white hover:shadow-2xl hover:shadow-gray-200/50 group">
                                    <div class="flex flex-col md:flex-row gap-8">
                                        ...
                                        <div class="md:w-1/3 space-y-4">
                                            <div class="flex items-start gap-4">
                                                <div class="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-3xl shadow-sm border border-gray-100 group-hover:scale-110 transition-transform">
                                                    <?php echo e($quotationItem->category_icon); ?>

                                                </div>
                                                <div>
                                                    <h5 class="text-lg font-black text-gray-900 leading-tight">Item #<?php echo e($quotationItem->item_number); ?></h5>
                                                    <p class="text-xs text-[#22AF85] font-black uppercase tracking-widest mt-1"><?php echo e($quotationItem->category); ?></p>
                                                </div>
                                            </div>
                                            <div class="p-5 bg-white rounded-2xl border border-gray-100 space-y-2 shadow-sm">
                                                <div class="flex justify-between text-[10px] font-bold">
                                                    ...
                                                    <span class="text-gray-900 font-black"><?php echo e($quotationItem->shoe_brand ?: '-'); ?></span>
                                                </div>
                                                <div class="flex justify-between text-[10px] font-bold">
                                                    <span class="text-gray-400 uppercase tracking-widest">Color</span>
                                                    <span class="text-gray-900 font-black"><?php echo e($quotationItem->shoe_color ?: '-'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-1 space-y-6">
                                            <div class="relative">
                                                <input type="text" id="search-services-<?php echo e($quotationItem->id); ?>" onkeyup="filterServices(<?php echo e($quotationItem->id); ?>)"
                                            ...
                                            <div id="services-container-<?php echo e($quotationItem->id); ?>" class="max-h-80 overflow-y-auto space-y-3 pr-2 custom-scrollbar">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <div class="service-wrapper-<?php echo e($quotationItem->id); ?>-<?php echo e($service->id); ?>">
                                                        <label class="service-item-<?php echo e($quotationItem->id); ?> flex items-center justify-between p-5 bg-white border-2 border-gray-50 rounded-[1.5rem] hover:border-[#22AF85]/30 cursor-pointer transition-all active:scale-[0.98] shadow-sm select-none"
                                                               data-service-name="<?php echo e(strtolower($service->name)); ?>"
                                                               data-service-category="<?php echo e(strtolower($service->category ?? '')); ?>">
                                                            <div class="flex items-center gap-5">
                                                                <input type="checkbox" name="items[<?php echo e($quotationItem->id); ?>][services][]" value="<?php echo e($service->id); ?>"
                                                                       id="service-<?php echo e($quotationItem->id); ?>-<?php echo e($service->id); ?>"
                                                                       data-item-id="<?php echo e($quotationItem->id); ?>" data-price="<?php echo e($service->price); ?>" 
                                                                       data-name="<?php echo e($service->name); ?>" data-category="<?php echo e($service->category ?: '-'); ?>"
                                                                       onchange="toggleServiceDetail(<?php echo e($quotationItem->id); ?>, <?php echo e($service->id); ?>); updateItemTotal(<?php echo e($quotationItem->id); ?>); updateSelectedServices(<?php echo e($quotationItem->id); ?>);"
                                                                       class="service-checkbox w-6 h-6 rounded-lg border-2 border-gray-100 text-[#22AF85] focus:ring-0 transition-all">
                                                                <div>
                                                                    <p class="text-sm font-black text-gray-900"><?php echo e($service->name); ?></p>
                                                                    <p class="text-[9px] text-[#22AF85] font-black uppercase tracking-widest mt-1"><?php echo e($service->category ?: 'General'); ?></p>
                                                                </div>
                                                            </div>
                                                            <span class="text-sm font-black text-gray-900">Rp <?php echo e(number_format($service->price, 0, ',', '.')); ?></span>
                                                        </label>
                                                        
                                                        <div id="detail-<?php echo e($quotationItem->id); ?>-<?php echo e($service->id); ?>" class="hidden mt-3 mx-4 p-6 bg-[#22AF85]/5 border-2 border-dashed border-[#22AF85]/20 rounded-[1.5rem]">
                                                            <label class="block text-[10px] font-black text-[#22AF85] uppercase tracking-[0.2em] mb-3">Detail Instruksi Jasa</label>
                                                            <textarea name="items[<?php echo e($quotationItem->id); ?>][service_details][<?php echo e($service->id); ?>]"
                                                                      id="detail-input-<?php echo e($quotationItem->id); ?>-<?php echo e($service->id); ?>"
                                                                      oninput="updateSelectedServices(<?php echo e($quotationItem->id); ?>)"
                                            ...
                                            <div class="p-6 bg-gray-900 rounded-[2rem] border-2 border-gray-800 shadow-xl">
                                                <div class="flex justify-between items-center mb-4">
                                                    ...
                                                    <button type="button" onclick="toggleCustomService(<?php echo e($quotationItem->id); ?>)"
                                                ...
                                                <div id="custom-service-<?php echo e($quotationItem->id); ?>" class="hidden space-y-4 pt-4 border-t border-gray-800">
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <input type="text" id="custom-name-<?php echo e($quotationItem->id); ?>" placeholder="Nama Layanan"
                                                               class="px-5 py-3 rounded-xl border-0 bg-gray-800 text-white text-xs font-bold focus:ring-2 focus:ring-[#22AF85]">
                                                        <input type="number" id="custom-price-<?php echo e($quotationItem->id); ?>" placeholder="Harga (IDR)"
                                                               class="px-5 py-3 rounded-xl border-0 bg-gray-800 text-white text-xs font-bold focus:ring-2 focus:ring-[#22AF85]">
                                                    </div>
                                                    <div>
                                                        <select id="custom-category-<?php echo e($quotationItem->id); ?>"
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services->pluck('category')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                                <option value="<?php echo e($category); ?>"><?php echo e($category); ?></option>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                            <option value="General">Lainnya / General</option>
                                                        </select>
                                                    </div>
                                                    <textarea id="custom-description-<?php echo e($quotationItem->id); ?>" placeholder="Detail teknis..."
                                                    ...
                                                    <button type="button" onclick="addCustomService(<?php echo e($quotationItem->id); ?>)"
                                                ...
                                                <div id="selected-summary-<?php echo e($quotationItem->id); ?>" class="mt-6 space-y-2 hidden">
                                                    <p class="text-[9px] font-black text-gray-500 uppercase tracking-widest mb-3">Service Pipeline:</p>
                                                    <div id="selected-list-<?php echo e($quotationItem->id); ?>" class="space-y-2"></div>
                                                </div>

                                                <div class="mt-8 pt-6 border-t border-gray-800 flex justify-between items-center">
                                                    <span class="text-[10px] font-black text-gray-500 uppercase tracking-widest">Subtotal Item #<?php echo e($quotationItem->item_number); ?></span>
                                                    <span class="text-2xl font-black text-white" id="item-subtotal-<?php echo e($quotationItem->id); ?>">Rp 0</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="items[<?php echo e($quotationItem->id); ?>][quotation_item_id]" value="<?php echo e($quotationItem->id); ?>">
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\cs\leads\partials\modals\spk.blade.php ENDPATH**/ ?>