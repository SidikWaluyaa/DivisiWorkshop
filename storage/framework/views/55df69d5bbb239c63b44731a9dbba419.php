     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-bold text-xl text-white leading-tight flex items-center gap-2">
                ...
                <?php echo e(__('Manajemen Pembelian')); ?>
            ...
            <div class="flex items-center gap-3">
                <div class="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 text-white text-sm">
                    ...
                    <span class="font-bold ml-1"><?php echo e($purchases->total()); ?></span>
                </div>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-12" x-data="{ selected: [] }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg shadow-orange-500/30 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-3xl font-bold"><?php echo e($stats['total_pending']); ?></h3>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/30 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-3xl font-bold"><?php echo e($stats['total_ordered']); ?></h3>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-rose-500 to-pink-600 rounded-2xl p-6 text-white shadow-lg shadow-rose-500/30 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-bold truncate" title="Rp <?php echo e(number_format($stats['total_unpaid'], 0, ',', '.')); ?>">
                            Rp <?php echo e(number_format($stats['total_unpaid'], 0, ',', '.')); ?>
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white shadow-lg shadow-teal-500/30 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 class="text-2xl font-bold truncate" title="Rp <?php echo e(number_format($stats['total_outstanding'], 0, ',', '.')); ?>">
                             Rp <?php echo e(number_format($stats['total_outstanding'], 0, ',', '.')); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-teal-100 dark:border-gray-700 overflow-hidden mb-6 p-5">
                <form method="GET" action="<?php echo e(route('admin.purchases.index')); ?>">
                    <div class="flex flex-col xl:flex-row justify-between items-end gap-4">
                        ...
                        <div class="w-full xl:w-auto flex flex-col md:flex-row gap-4 items-end">
                            ...
                            <div class="flex gap-2 w-full md:w-auto">
                                <div>
                                    <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>" class="w-full py-2.5 rounded-xl border-gray-200 focus:border-teal-500 focus:ring focus:ring-teal-200 focus:ring-opacity-50 text-sm bg-gray-50 focus:bg-white" title="Tanggal Awal">
                                </div>
                                <span class="self-center text-gray-400">-</span>
                                <div>
                                    <input type="date" name="end_date" value="<?php echo e(request('end_date')); ?>" class="w-full py-2.5 rounded-xl border-gray-200 focus:border-teal-500 focus:ring focus:ring-teal-200 focus:ring-opacity-50 text-sm bg-gray-50 focus:bg-white" title="Tanggal Akhir">
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('start_date')): ?>
                                    <a href="<?php echo e(route('admin.purchases.index')); ?>" class="px-4 py-2.5 bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-xl transition-colors font-medium text-sm">Reset</a>
                        ...
                        <div class="flex items-center gap-3 w-full xl:w-auto justify-end mt-4 xl:mt-0">
                             ...
                             <a href="<?php echo e(route('admin.purchases.export-pdf', request()->all())); ?>" target="_blank" class="px-4 py-2.5 bg-gray-800 text-white rounded-xl hover:bg-gray-700 transition-colors flex items-center gap-2 font-medium text-sm shadow-lg shadow-gray-500/30">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <form id="bulkDeleteForm" action="<?php echo e(route('admin.purchases.bulk-destroy')); ?>" method="POST" onsubmit="return confirm('Yakin hapus ' + selected.length + ' pembelian terpilih?')">
                    <?php echo csrf_field(); ?>
                ...
                <div class="block lg:hidden grid grid-cols-1 divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <div class="p-4 bg-white dark:bg-gray-800 hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex justify-between items-start mb-2">
                            <div class="flex items-center gap-3">
                                 <input type="checkbox" value="<?php echo e($purchase->id); ?>" x-model="selected" class="rounded border-gray-300 text-teal-600 shadow-sm w-5 h-5 focus:ring-teal-500">
                                 <div>
                                     <div class="font-mono font-bold text-teal-700 dark:text-teal-300 text-sm"><?php echo e($purchase->po_number); ?></div>
                                     <div class="text-xs text-gray-400"><?php echo e($purchase->created_at->format('d M Y')); ?></div>
                                 </div>
                            </div>
                             <span class="px-2 py-0.5 inline-flex text-[10px] font-bold rounded-full
                                <?php if($purchase->status === 'pending'): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
                                <?php elseif($purchase->status === 'ordered'): ?> bg-blue-100 text-blue-800 border border-blue-200
                                <?php elseif($purchase->status === 'received'): ?> bg-green-100 text-green-800 border border-green-200
                                <?php else: ?> bg-red-100 text-red-800 border border-red-200
                                <?php endif; ?>">
                        ...
                        <div class="ml-8 mb-3 space-y-1">
                            <div class="flex justify-between items-center text-sm">
                                 <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($purchase->supplier_name ?? '-'); ?></span>
                                 <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchase->quality_rating): ?>
                                    <div class="flex text-yellow-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=0; $i<$purchase->quality_rating; $i++): ?>
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e($purchase->material->name ?? 'Material Terhapus'); ?> 
                                <span class="text-xs text-gray-500">(<?php echo e($purchase->quantity); ?> <?php echo e($purchase->material->unit ?? '-'); ?>)</span>
                            </div>
                             <div class="flex justify-between items-center mt-2">
                                <span class="font-bold text-gray-900 dark:text-white">Rp <?php echo e(number_format($purchase->total_price, 0, ',', '.')); ?></span>
                                 <span class="px-2 py-0.5 inline-flex text-[10px] font-bold rounded-full
                                    <?php if($purchase->payment_status === 'paid'): ?> bg-green-100 text-green-800 border border-green-200
                                    <?php elseif($purchase->payment_status === 'partial'): ?> bg-orange-100 text-orange-800 border border-orange-200
                                    <?php else: ?> bg-red-100 text-red-800 border border-red-200
                                    <?php endif; ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchase->payment_status !== 'paid'): ?>
                                <div class="text-right text-xs text-red-500 font-bold">
                                    Sisa: Rp <?php echo e(number_format($purchase->outstanding_amount, 0, ',', '.')); ?>
                        ...
                        <div class="flex justify-end gap-2 ml-8 border-t border-gray-100 pt-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchase->payment_status !== 'paid'): ?>
                                <button onclick="openPaymentModal(<?php echo e($purchase->id); ?>, <?php echo e($purchase->outstanding_amount); ?>, '<?php echo e($purchase->po_number); ?>')" 
                            ...
                            <tr class="bg-gradient-to-r from-teal-50 to-emerald-50 dark:from-gray-700 dark:to-gray-700">
                                <th scope="col" class="px-6 py-4 text-left">
                                    <input type="checkbox" 
                                           ...
                                           @click="selected = $el.checked ? <?php echo e(json_encode($purchases->pluck('id'))); ?> : []"
                                           :checked="selected.length === <?php echo e($purchases->count()); ?> && <?php echo e($purchases->count()); ?> > 0">
                                </th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-teal-50/30 dark:hover:bg-gray-700 transition-colors group">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" value="<?php echo e($purchase->id); ?>" x-model="selected" class="rounded border-gray-300 text-teal-600 shadow-sm focus:ring-teal-500">
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="font-mono text-sm font-bold text-teal-700 dark:text-teal-300"><?php echo e($purchase->po_number); ?></span>
                                    <div class="text-xs text-gray-400"><?php echo e($purchase->created_at->format('d M Y')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($purchase->supplier_name ?? '-'); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchase->quality_rating): ?>
                                        <div class="text-xs text-yellow-500 flex" title="Rating: <?php echo e($purchase->quality_rating); ?>/5">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=0; $i<$purchase->quality_rating; $i++): ?>
                                                <svg class="w-3 h-3 fill-current" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($purchase->material->name ?? 'Material Terhapus'); ?></div>
                                    <div class="text-xs text-gray-500">@ Rp <?php echo e(number_format($purchase->unit_price, 0, ',', '.')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                                    <?php echo e($purchase->quantity); ?> <span class="text-xs text-gray-500"><?php echo e($purchase->material->unit ?? '-'); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap font-bold text-gray-900 dark:text-white">
                                    Rp <?php echo e(number_format($purchase->total_price, 0, ',', '.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\admin\purchases\index.blade.php ENDPATH**/ ?>