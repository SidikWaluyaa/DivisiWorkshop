...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="text-center">
        ...
        <div class="inline-flex items-center rounded-full bg-gray-100 px-4 py-1.5 text-sm font-bold text-gray-600 mb-8 border border-gray-200">
            Ticket #<?php echo e($complaint->id); ?>

        </div>

        <p class="text-gray-500 mb-8 leading-relaxed">
            Terima kasih telah memberitahu kami. Tim Admin akan segera memeriksa laporan Anda dan menghubungi nomor WhatsApp 
            <span class="font-bold text-teal-600 bg-teal-50 px-1 rounded"><?php echo e($complaint->customer_phone); ?></span> 
            dalam waktu maksimal 1x24 jam.
        </p>

        <a href="<?php echo e(route('tracking.index')); ?>" class="w-full bg-gradient-to-r from-teal-500 to-teal-600 text-white font-black py-4 px-6 rounded-xl hover:from-teal-600 hover:to-teal-700 transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 text-lg">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\complaints\success.blade.php ENDPATH**/ ?>