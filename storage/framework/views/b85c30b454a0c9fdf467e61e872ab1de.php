        ...
        <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
                ...
                <div class="w-full xl:w-auto bg-white dark:bg-gray-800 p-2 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-wrap items-center gap-3">
                    <form method="GET" action="<?php echo e(route('shipping.index')); ?>" class="flex flex-wrap items-center gap-3 w-full">
                        <!-- Search Box -->
                        ...
                        <select name="status" class="bg-gray-50/50 border-gray-200 text-gray-700 text-sm rounded-xl focus:ring-[#22AF85] focus:border-[#22AF85] block py-2.5 px-4 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all">
                            ...
                            <option value="unverified" <?php echo e(request('status') == 'unverified' ? 'selected' : ''); ?>>Belum Diverifikasi</option>
                        </select>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search', 'status', 'date_start', 'date_end'])): ?>
                            <a href="<?php echo e(route('shipping.index')); ?>" class="p-2.5 bg-gray-100 text-gray-500 rounded-xl hover:bg-gray-200 transition-all dark:bg-gray-700 dark:text-gray-300" title="Reset Filters">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="overflow-x-auto relative max-h-[750px]">
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $shippings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="group hover:bg-gray-50/80 dark:hover:bg-gray-700/40 transition-all duration-200">
                                <td class="px-6 py-6 text-center">
                                    <span class="text-xs font-mono font-bold text-gray-400">#<?php echo e($shipping->id); ?></span>
                                </td>
                                <td class="px-6 py-6 border-l-4 border-transparent group-hover:border-[#22AF85] transition-all">
                                    <div class="flex flex-col">
                                        <span class="font-bold text-gray-900 dark:text-white text-base"><?php echo e($shipping->customer_name); ?></span>
                                        <span class="text-xs text-[#22AF85] font-semibold mt-0.5 flex items-center gap-1.5">
                                            ...
                                            <?php echo e($shipping->customer_phone); ?>

                                        </span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipping->workOrder?->customer_address): ?>
                                            <span class="text-[11px] text-gray-500 dark:text-gray-400 mt-1 flex items-start gap-1.5 leading-relaxed">
                                                ...
                                                <?php echo e($shipping->workOrder->customer_address); ?>

                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span class="text-[10px] text-gray-400 mt-1.5 uppercase font-bold tracking-tighter">Masuk: <?php echo e($shipping->tanggal_masuk->format('d M Y')); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-6">
                                    <span class="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg text-xs font-mono font-black border border-gray-200 dark:border-gray-600 group-hover:bg-white transition-all">
                                        <?php echo e($shipping->spk_number); ?>

                                    </span>
                                </td>

                                <td class="px-4 py-6">
                                    <form id="form-<?php echo e($shipping->id); ?>" action="<?php echo e(route('shipping.update', $shipping->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                        <select name="kategori_pengiriman" @change="saveForm(<?php echo e($shipping->id); ?>)" 
                                            ...
                                            <option value="Ojek Online" <?php echo e($shipping->kategori_pengiriman == 'Ojek Online' ? 'selected' : ''); ?>>🛵 Ojek Online</option>
                                            <option value="Ambil Sendiri" <?php echo e($shipping->kategori_pengiriman == 'Ambil Sendiri' ? 'selected' : ''); ?>>🏠 Ambil Sendiri</option>
                                            <option value="Ekspedisi" <?php echo e($shipping->kategori_pengiriman == 'Ekspedisi' ? 'selected' : ''); ?>>📦 Ekspedisi</option>
                                        </select>
                                </td>

                                <td class="px-6 py-6 text-center">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="is_verified" value="1" <?php echo e($shipping->is_verified ? 'checked' : ''); ?> class="sr-only peer" @change="saveForm(<?php echo e($shipping->id); ?>)">
                                        <div class="w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#22AF85]"></div>
                                    </label>
                                </td>

                                <td class="px-6 py-6">
                                    <select name="pic" @change="saveForm(<?php echo e($shipping->id); ?>)" 
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $technicians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <option value="<?php echo e($tech->name); ?>" <?php echo e($shipping->pic == $tech->name ? 'selected' : ''); ?>>👤 <?php echo e($tech->name); ?></option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </select>
                                </td>

                                <td class="px-6 py-6">
                                    <input type="date" name="tanggal_pengiriman" value="<?php echo e($shipping->tanggal_pengiriman?->format('Y-m-d')); ?>" @change="saveForm(<?php echo e($shipping->id); ?>)" 
                                ...
                                <td class="px-6 py-6">
                                    <div class="relative w-[160px]">
                                        <input type="text" name="resi_pengiriman" value="<?php echo e($shipping->resi_pengiriman); ?>" @change="saveForm(<?php echo e($shipping->id); ?>)" 
                                ...
                                <td class="px-6 py-6 text-center">
                                    <div class="flex flex-col items-center justify-center gap-1">
                                        <div id="save-indicator-<?php echo e($shipping->id); ?>" class="hidden group-indicator select-none">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-[#22AF85]/10 text-[#22AF85] animate-pulse">
                                                Saved
                                            </span>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shipping->resi_pengiriman): ?>
                ...
                <!-- Pagination Section -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shippings->hasPages()): ?>
                <div class="px-8 py-6 bg-gray-50 dark:bg-gray-800/10 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <span class="text-xs text-gray-500 font-bold uppercase tracking-tight">Menampilkan <?php echo e($shippings->firstItem()); ?>-<?php echo e($shippings->lastItem()); ?> dari <?php echo e($shippings->total()); ?> Data</span>
                    <div>
    ...
    <div x-show="showManifestModal" 
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white dark:bg-gray-800 rounded-2xl shadow-2xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6 border border-gray-100 dark:border-gray-700">
                ...
                <form action="<?php echo e(route('shipping.manifest.preview')); ?>" method="GET" target="_blank" @submit="showManifestModal = false">
                    <div class="space-y-5">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Tanggal Mulai</label>
                                <input type="date" name="date_start" value="<?php echo e(date('Y-m-d')); ?>" 
                            ...
                            <div>
                                ...
                                <input type="date" name="date_end" value="<?php echo e(date('Y-m-d')); ?>" 
                                    class="w-full bg-gray-50 border-gray-200 rounded-xl focus:ring-[#22AF85] focus:border-[#22AF85] dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all py-3 px-4 text-sm font-bold">
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\SistemWorkshop\resources\views\shipping\index.blade.php ENDPATH**/ ?>