<?php
/**
 * API to export CS LEADS (Status: CLOSING) for Google Sheets Sync
 * 
 * Usage: GET /api/sync_cs_leads.php?token=YOUR_SECURE_TOKEN_HERE
 */
...
// 4. Query CS Leads with status CLOSING
$query = "SELECT 
            customer_name,
            customer_phone,
            status
...
echo json_encode([
    'status' => 'success',
    'module' => 'CS Leads',
    'description' => 'Data Leads dengan status CLOSING',
    'count' => count($data),
    'data' => $data
], JSON_PRETTY_PRINT);
