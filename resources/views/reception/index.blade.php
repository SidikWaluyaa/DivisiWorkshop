                                    ...
                                    <tr class="bg-white hover:bg-teal-50/30 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <button type="button" onclick="document.getElementById('wa-{{ $order->id }}').submit()" class="p-2 text-green-500 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors" title="Kirim WA Konfirmasi Terima (Manual)">
