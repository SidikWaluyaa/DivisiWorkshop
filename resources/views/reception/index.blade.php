                            ...
                            <form method="GET" action="{{ route('reception.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                                ...
                                <div class="col-span-1 sm:col-span-2 md:col-span-2 flex flex-col sm:flex-row justify-end gap-2 items-end">
                                    ...
                                    <button type="button" 
                                       ...
                                       class="px-5 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all text-sm font-bold flex items-center justify-center gap-2 shadow-md"
                                       title="Download daftar followup SPK hasil filter (PDF)">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                                        PDF
                                    </button>
                                    <button type="button" 
                                       onclick="downloadBulkExcel()"
                                       class="px-5 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all text-sm font-bold flex items-center justify-center gap-2 shadow-md"
                                       title="Download daftar followup SPK hasil filter (Excel)">
