    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gray-100 dark:bg-gray-900">
         <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('reception.index')" :active="request()->routeIs('reception.*')">
             ...
             <x-responsive-nav-link :href="route('preparation.index')" :active="request()->routeIs('preparation.*')">
                {{ __('Preparation') }}
            </x-responsive-nav-link>
             <x-responsive-nav-link :href="route('sortir.index')" :active="request()->routeIs('sortir.*')">
                {{ __('Sortir') }}
            </x-responsive-nav-link>
             <x-responsive-nav-link :href="route('production.index')" :active="request()->routeIs('production.*')">
                {{ __('Production') }}
            </x-responsive-nav-link>
             <x-responsive-nav-link :href="route('qc.index')" :active="request()->routeIs('qc.*')">
                {{ __('QC') }}
            </x-responsive-nav-link>
             <x-responsive-nav-link :href="route('finish.index')" :active="request()->routeIs('finish.*')">
                {{ __('Selesai') }}
            </x-responsive-nav-link>
        </div>
