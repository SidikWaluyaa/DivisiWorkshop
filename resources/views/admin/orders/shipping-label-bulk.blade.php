...
<body>
    <div class="no-print bg-slate-100 p-4 flex justify-between items-center border-b border-slate-200">
        <span class="text-xs font-black uppercase text-slate-500 tracking-wider">Bulk Print Shipping Labels ({{ $orders->count() }} Label)</span>
        <button class="print-btn" onclick="window.print()">🖨️ Cetak Semua Label</button>
    </div>
                        ...
                        <div class="w-[40%] border-r-[2px] border-[#FFC232] px-4 py-2 flex flex-col justify-center gap-1">
                            ...
                            <div class="space-y-1">
                                <div class="flex items-center gap-2">
                                    <div class="w-5 h-5 bg-emerald-55 text-[#22B086] rounded-full flex items-center justify-center shrink-0 border border-emerald-100/50">
