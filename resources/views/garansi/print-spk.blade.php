...
<head>
    ...
    <title>SPK GARANSI - {{ $warranty->garansi_spk_number }}</title>
            ...
            <div class="grid grid-cols-2 gap-4 avoid-break">
                <div class="space-y-3">
                    <div class="bg-gray-50 rounded-lg p-2.5 px-4 border border-gray-100 flex items-center justify-between">
                        ...
                        <span class="text-sm font-black font-mono tracking-tighter text-orange-600">{{ $warranty->garansi_spk_number }}</span>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-2.5 px-4 border border-gray-100 flex items-center justify-between">
                        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-tight">SPK Asli</span>
                        <span class="text-[11px] font-bold font-mono tracking-tighter text-gray-400">{{ $order->spk_number }}</span>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-2.5 px-4 border border-gray-100 flex items-center justify-between">
