{{-- Charts Script (ApexCharts) + Real-Time Polling --}}
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    const funnelData = @json($production['funnel']);
    ...
    revenueChart = new ApexCharts(document.querySelector("#revenueChart"), {
        ...
        series: [{
            name: 'Pendapatan',
            data: @json($businessIntel['revenue']['data']),
        }],
        xaxis: {
            categories: @json($businessIntel['revenue']['labels']),
    ...
    const API_URL = @json(route('dashboard.api-data'));
    ...
    function updateSpkList(selector, spks, type) {
        ...
        const baseUrl = @json(url('reception'));
