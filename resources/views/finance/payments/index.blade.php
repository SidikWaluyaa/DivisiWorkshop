                                ...
                                <tr class="hover:bg-[#F8FAFC] transition-all duration-300 group">
                                    <td class="px-10 py-8">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="text-sm font-black text-gray-900 italic uppercase tracking-tighter group-hover:text-[#1B8A68] transition-colors">{{ $payment->invoice->invoice_number ?? '-' }}</div>
                                    ...
                                    <td class="px-10 py-8 text-center">
                                        <div class="text-xs font-black text-gray-600 italic tracking-tight uppercase">{{ $payment->payment_date->format('d M Y') }}</div>
                                    </td>
                                    <td class="px-10 py-8 text-center">
                                        @if($payment->verified)
                                    ...
                                    <td class="px-10 py-8">
                                        <div class="text-xs font-black text-gray-600 italic uppercase tracking-tight">{{ $payment->creator->name ?? '-' }}</div>
                                    </td>
                                    <td class="px-10 py-8">
                                        <div class="text-xs text-gray-400 italic max-w-[200px] truncate">{{ $payment->notes ?? '-' }}</div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
