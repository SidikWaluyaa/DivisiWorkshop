...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td>: {{ $startDate ? date('d/m/Y', strtotime($startDate)) : 'Semua' }} s/d {{ $endDate ? date('d/m/Y', strtotime($endDate)) : 'Sekarang' }}</td>
        ...
        <tbody>
            ...
            @forelse($payments as $index => $payment)
                ...
                <tr>
                    ...
                    <td class="font-bold">{{ $payment->invoice->invoice_number ?? '-' }}</td>
                    <td style="word-wrap: break-word;">{{ $payment->invoice->customer->name ?? '-' }}</td>
