        ...
        <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col xl:flex-row justify-between items-center gap-4 bg-white/60 p-4 rounded-[1.5rem] shadow-lg border border-white glass-panel relative z-[50]">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Export Excel Button --}}
                    <a href="{{ route('storage.dashboard.export-excel', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-md transition-all active:scale-95 duration-200 flex items-center justify-center gap-2">
