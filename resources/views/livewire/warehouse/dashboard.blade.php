        ...
        <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col xl:flex-row justify-between items-center gap-4 bg-white/60 p-4 rounded-[1.5rem] shadow-lg border border-white glass-panel relative z-[50]">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Export Excel Button --}}
                    <a href="{{ route('storage.dashboard.export-excel', [
                        'start_date' => $startDate, 
                        'end_date' => $endDate, 
                        'active_tab' => $activeTab,
                        'search' => $search,
                        'sortir_filter' => $sortirFilter,
                        'sortir_service_id' => $sortirServiceId,
                        'sortir_category' => $sortirCategory,
                        'sortir_est_start' => $sortirEstStart,
                        'sortir_est_end' => $sortirEstEnd,
                        'production_filter' => $productionFilter,
                        'production_service_id' => $productionServiceId,
                        'production_category' => $productionCategory,
                        'production_est_start' => $productionEstStart,
                        'production_est_end' => $productionEstEnd,
                        'production_sort' => $productionSort,
                        'production_limit' => $productionLimit,
                        'qc_filter' => $qcFilter,
                        'qc_entered_start' => $qcEnteredStart,
                        'qc_entered_end' => $qcEnteredEnd
                    ]) }}" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-md transition-all active:scale-95 duration-200 flex items-center justify-center gap-2">
            ...
            <div x-show="activeTab === 'sortir_dashboard'" x-transition:enter="transition ease-out duration-300" x-cloak class="space-y-6">
                ...
                <div class="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-4 bg-white p-4 rounded-[1.5rem] shadow-md border border-gray-100">
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div class="relative shrink-0" wire:key="sortir-est-picker-container">
                            ...
                            <div wire:ignore wire:key="sortir-est-flatpickr-hidden" class="hidden">
                                <input x-ref="sortirEstInput" x-init="
                                    ...
                                    $watch('$wire.sortirEstStart', (value) => {
                                        if ($el._flatpickr) {
                                            if (value) {
                                                $el._flatpickr.setDate([value, $wire.sortirEstEnd], false);
                                            } else {
                                                $el._flatpickr.clear();
                                            }
                                        }
                ...
                <div class="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-4 bg-white p-4 rounded-[1.5rem] shadow-md border border-gray-100">
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div class="relative shrink-0" wire:key="production-est-picker-container">
                            ...
                            <div wire:ignore wire:key="production-est-flatpickr-hidden" class="hidden">
                                <input x-ref="productionEstInput" x-init="
                                    ...
                                    $watch('$wire.productionEstStart', (value) => {
                                        if ($el._flatpickr) {
                                            if (value) {
                                                $el._flatpickr.setDate([value, $wire.productionEstEnd], false);
                                            } else {
                                                $el._flatpickr.clear();
                                            }
                                        }
