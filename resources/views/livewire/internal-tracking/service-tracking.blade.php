        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-gray-100 pb-5">
            ...
            <div class="flex items-center gap-3 self-start md:self-center">
                ...
                <button wire:click="exportExcel" wire:loading.attr="disabled"
                   class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 active:scale-95 text-white text-xs font-black rounded-xl transition-all shadow-lg shadow-emerald-500/20 hover:scale-[1.02] disabled:opacity-50">
                    <span wire:loading.remove wire:target="exportExcel">📊 EXPORT DATA</span>
                    <span wire:loading wire:target="exportExcel" class="inline-flex items-center gap-1.5">
