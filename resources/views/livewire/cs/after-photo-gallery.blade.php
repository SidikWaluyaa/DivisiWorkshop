        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8" id="photo-grid">
            @forelse($workOrders as $wo)
                ...
                <div wire:key="wo-{{ $wo->id }}" 
                    ...
                    <div class="flex h-72 sm:h-96 relative group/container cursor-pointer"
                         @click="showLightbox(
                        ...
                        {{-- Before Side --}}
                        <div class="w-1/2 relative overflow-hidden border-r border-white dark:border-gray-900">
                            @if($before)
                                <img src="{{ Storage::url($before->file_path) }}" loading="lazy" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            @else
                                <div class="w-full h-full bg-gray-100 dark:bg-gray-700 flex flex-col items-center justify-center text-gray-400 p-4 text-center">
                        ...
                        <div class="w-1/2 relative overflow-hidden">
                            @if($after)
                                <img src="{{ Storage::url($after->file_path) }}" loading="lazy" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                            @else
                                <div class="w-full h-full bg-gray-100 dark:bg-gray-700 flex flex-col items-center justify-center text-gray-400 p-4 text-center">
                                    <svg class="w-10 h-10 mb-2 opacity-20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
