                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        @if($warranty->workOrder->customer_phone)
                                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $warranty->workOrder->customer_phone) }}" target="_blank" class="flex items-center gap-1.5 px-3 py-1 bg-green-500/10 text-green-600 rounded-lg text-[10px] font-black hover:bg-green-500 hover:text-white transition-all">
