<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="cs_code" name="cs_code" type="text" class="mt-1 block w-full uppercase" :value="old('cs_code', data_get($user, 'cs_code'))" maxlength="3" placeholder="Contoh: AD, QA" />
