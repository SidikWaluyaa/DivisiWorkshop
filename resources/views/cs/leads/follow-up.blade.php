<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm">
            ...
            <span class="font-black text-white text-base tracking-wide">{{ __('Follow-up Leads') }}</span>
        </div>
    </x-slot>
    ...
    <div class="py-12 bg-gray-50/50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-white via-white/95 to-orange-50/40 p-6 sm:p-8 border border-white/80 shadow-[0_20px_50px_rgba(249,115,22,0.08)] mb-8 backdrop-blur-xl">
                {{-- Decorative background glow --}}
                <div class="absolute -right-20 -top-20 w-80 h-80 bg-orange-400/10 rounded-full blur-3xl pointer-events-none"></div>
                <div class="absolute -left-20 -bottom-20 w-72 h-72 bg-blue-400/10 rounded-full blur-3xl pointer-events-none"></div>

                <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    {{-- Left info --}}
                    <div class="flex items-start sm:items-center gap-4 sm:gap-5">
                        <div class="relative shrink-0">
                            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr from-orange-600 via-orange-500 to-amber-400 flex items-center justify-center text-white shadow-lg shadow-orange-500/30 ring-4 ring-white">
                        ...
                        <div>
                            <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black tracking-wider uppercase bg-orange-100 text-orange-800 border border-orange-200/60 inline-flex items-center gap-1.5">
                                    <span class="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse"></span>
                                    Stage 3: Follow Up & Reminder
                                </span>
                            ...
                            <h1 class="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight flex items-center gap-2">
                                Follow-up Konsultasi Leads
                            </h1>
                            <p class="text-xs sm:text-sm text-gray-500 font-medium mt-0.5">
                                Monitoring dan penanganan lead warm yang telah dikirimi penawaran untuk memacu konversi closing.
                            </p>
                        </div>
                    </div>
