                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
                        <form method="GET" class="flex-1 grid grid-cols-1 md:grid-cols-4 gap-3 w-full">
                            ...
                            <div class="flex gap-2 col-span-1 md:col-span-2" x-data="{
                                ...
                                <a href="{{ route('cs.spk.report-excel', request()->all()) }}" class="px-4 bg-gray-100 text-gray-700 hover:bg-emerald-600 hover:text-white rounded-2xl font-black text-xs uppercase tracking-widest transition flex items-center justify-center gap-1.5 shadow-sm active:scale-95" title="Unduh Excel">
