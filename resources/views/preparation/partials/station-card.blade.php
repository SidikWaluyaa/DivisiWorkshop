             ...
             <div class="md:col-span-2 space-y-4">
                 ...
                 @if($order->notes)
                     <div class="p-3.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-xs text-gray-700 dark:text-gray-300">
                         <span class="block font-bold text-gray-400 dark:text-gray-500 uppercase text-[9px] tracking-wide mb-1">Catatan CS:</span>
                         "{{ $order->notes }}"
                     </div>
                 @endif
                 ...
                 <div x-show="showPhotos" class="pt-4 border-t border-gray-200 dark:border-gray-700" style="display: none;" x-transition>
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                         <div>
                             <span class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider block mb-1.5">Before (Awal)</span>
                             <x-photo-uploader :order="$order" :step="strtoupper('PREP_' . $type . '_BEFORE')" />
                         </div>
                         <div>
                             <span class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider block mb-1.5">After (Akhir)</span>
                     ...
                     <div class="space-y-3">
                         ...
                         <div x-show="showFinishModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" style="display: none;" x-transition>
                             <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-5 w-80 border border-gray-200 dark:border-gray-700" @click.away="showFinishModal = false">
                                 ...
                                 <input type="datetime-local" x-model="finishDate" class="w-full text-xs border border-gray-300 dark:border-gray-600 rounded-lg mb-4 focus:ring-green-500 focus:border-green-500 dark:bg-gray-750 dark:text-white">
                                 <div class="flex justify-end gap-2">
                                     <button @click="showFinishModal = false" class="px-3 py-1.5 bg-gray-100 text-gray-700 dark:text-gray-355 rounded-lg text-xs font-bold">Batal</button>
