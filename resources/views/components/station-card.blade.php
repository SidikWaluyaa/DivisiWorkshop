     ...
     <td class="px-6 py-4 whitespace-nowrap">
         ...
         @if($techName)
             <div class="flex items-center gap-1.5">
                 <div class="w-5 h-5 rounded-full bg-{{ $stationColor }}-100 dark:bg-{{ $stationColor }}-950/40 flex items-center justify-center text-[10px] text-{{ $stationColor }}-700 dark:text-{{ $stationColor }}-400 font-bold">
                     {{ substr($techName, 0, 1) }}
                 </div>
