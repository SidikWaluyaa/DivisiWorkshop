...
<head>
    ...
    <style>
        ...
        @page { 
            size: {{ $order->fast_track_status === 'yes' ? 'A5 landscape' : 'A4' }}; 
            margin: 0; 
        }
...
<body class="bg-gray-100 p-8 flex justify-center min-h-screen print:p-0 print:h-auto {{ $order->fast_track_status === 'yes' ? 'fast-track-a5' : '' }}">
