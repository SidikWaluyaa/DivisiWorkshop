...
<head>
    ...
    <title>Cetak Massal SPK ({{ $orders->count() }} Dokumen)</title>
...
<body class="bg-gray-100 p-8 flex flex-col items-center min-h-screen print:p-0 print:h-auto">
    ...
    <div class="page-container overflow-hidden page-a4">
        ...
        <!-- MAIN AREA (RIGHT) -->
        <main class="main-content" style="padding: {{ $mainPadding }}; gap: {{ $mainGap }};">
            {{-- ORDER INFO BOX --}}
