...
<body class="flex items-center justify-center p-4 min-h-screen">
    ...
    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('services.whatsapp.support_number', '628123456789')) }}?text={{ urlencode('Halo Shoe Workshop, saya butuh bantuan terkait status tracking sepatu saya.') }}" 
       target="_blank" 
