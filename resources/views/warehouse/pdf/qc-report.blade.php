...
<head>
    <meta charset="utf-8">
    <title>Laporan Audit SLA Tahap QC</title>
    <style>
        body {
...
<body>
    ...
    <table class="header-table" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <h1 class="brand-title">Laporan Audit SLA Tahap QC</h1>
    ...
    <table class="kpi-table" cellpadding="0" cellspacing="0">
        <tr>
            <td width="33.3%">
                <div class="kpi-card">
                    <div class="kpi-title">Total Antrean QC</div>
                    <div class="kpi-value">{{ $summary['total_items_in_qc'] }} SPK</div>
                </div>
            </td>
            <td width="33.3%">
        ...
        <tbody>
            @forelse($items as $item)
                <tr class="{{ $item['is_overdue'] ? 'overdue-row' : ($item['is_upcoming'] ? 'upcoming-row' : '') }}">
                    ...
                    <td>{{ $item['entered_qc_at_formatted'] }} ({{ $item['days_in_qc'] }} H)</td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center" style="padding: 30px; font-weight: bold; color: #64748b; font-size: 12px;">
                        Tidak ada data antrean QC pada filter ini.
                    </td>
                </tr>
            @endforelse
        </tbody>
