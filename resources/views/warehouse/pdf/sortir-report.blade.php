...
<head>
    <meta charset="utf-8">
    <title>Laporan Audit Stagnasi Tahap Sortir</title>
    <style>
        body {
        ...
        .data-table tr:nth-child(even):not(.overdue-row) {
            background-color: #f8fafc;
        }
        .data-table tr {
...
<body>
    ...
    <table class="header-table" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <h1 class="brand-title">Laporan Audit Stagnasi Tahap Sortir</h1>
                <p class="brand-subtitle">Sistem Workshop Logistik & Operational SLA</p>
            </td>
            <td class="meta-text">
    ...
    <div class="filter-container">
        ...
        <table class="filter-grid" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="filter-label">Tingkat Stagnasi:</td>
                <td class="filter-value">{{ $filter['overdue_only'] }}</td>
                <td colspan="2"></td>
            </tr>
        </table>
    </div>
    ...
    <table class="kpi-table" cellpadding="0" cellspacing="0">
        <tr>
            <td width="33.3%">
                <div class="kpi-card">
                    <div class="kpi-title">Total Antrean di Sortir</div>
                    <div class="kpi-value">{{ $summary['total_items_in_sortir'] }} SPK</div>
                </div>
            </td>
            <td width="33.3%">
                <div class="kpi-card-rose">
                    <div class="kpi-title">Stagnan (> 3 Hari)</div>
                    <div class="kpi-value-rose">{{ $summary['overdue_items_count'] }} SPK</div>
                </div>
            </td>
            <td width="33.3%">
                <div class="kpi-card">
                    <div class="kpi-title">Rata-Rata Lama Sortir</div>
                    <div class="kpi-value">{{ $summary['average_days_in_sortir'] }} Hari</div>
                </div>
            </td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            @forelse($items as $item)
                <tr class="{{ $item['is_overdue'] ? 'overdue-row' : '' }}">
                    ...
                    <td class="text-center">
                        @if($item['is_overdue'])
                            <span class="badge badge-overdue">TERTAHAN</span>
                        @else
    ...
    <div class="footer">
        ...
        </script> - Laporan Audit SLA Stagnasi Sortir
    </div>
