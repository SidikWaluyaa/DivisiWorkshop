...
<head>
    <meta charset="utf-8">
    <title>Laporan Piutang SPK Selesai (After Selesai)</title>
    <style>
        body {
...
<body>
    ...
    <table class="header-table" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <h1 class="brand-title">Laporan Piutang SPK Selesai (After Selesai)</h1>
    ...
    <table class="kpi-table" cellpadding="0" cellspacing="0">
        <tr>
            <td width="50%">
                <div class="kpi-card">
                    <div class="kpi-title">Total Invoice Selesai</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center" style="color: #64748b; padding: 20px;">Tidak ada data piutang setelah selesai.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="footer">
        Laporan Piutang SPK Selesai - Sistem Workshop Logistik &copy; {{ date('Y') }}
    </div>
