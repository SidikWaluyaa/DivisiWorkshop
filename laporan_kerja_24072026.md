...
* **Perubahan & Manfaatnya:**
  ...
  * **Tombol Akses Stasiun Langsung (Direct Link):** Popup kini dilengkapi dengan tombol **"Buka [Nama Stasiun] ➔"** (misal: Buka Stasiun QC / Stasiun Sortir) yang akan membuka tab baru langsung menuju stasiun SPK terkait. Untuk divisi yang tidak memiliki halaman detail individu (seperti *QC* dan *Preparation*), tombol akan mengarahkan ke halaman daftar stasiun divisi terkait (`index`) secara aman guna menghindari error *BadMethodCallException*.
