...
* **Perubahan & Manfaatnya:**
  ...
  * **Tombol Akses Stasiun Langsung (Direct Link):** Popup kini dilengkapi dengan tombol **"Buka [Nama Stasiun] ➔"** (misal: Buka Stasiun QC / Stasiun Sortir) yang akan membuka tab baru langsung menuju halaman stasiun SPK terkait untuk pemrosesan instan.
