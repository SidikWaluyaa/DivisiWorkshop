...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\SistemWorkshop\public\storage' => 'string',
            ...
            'chunk-upload.storage.chunks' => 'string',
            'chunk-upload.storage.disk' => 'string',
            'chunk-upload.clear.timestamp' => 'string',
            'chunk-upload.clear.schedule.enabled' => 'boolean',
            'chunk-upload.clear.schedule.cron' => 'string',
            'chunk-upload.chunk.name.use.session' => 'boolean',
            'chunk-upload.chunk.name.use.browser' => 'boolean',
            'chunk-upload.handlers.custom' => 'array',
            'chunk-upload.handlers.override' => 'array',
...
'access-cs','access-gudang','access-workshop','access-finance','access-cx',
'cs.override-locked','cs.manage-all',);
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.dashboard_api_key',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','cors.paths',
...
'database.connections.mysql.timezone','database.connections.mysql.engine','database.connections.mysql.options','database.connections.mariadb.driver','database.connections.mariadb.url',
...
'database.redis.cache.backoff_cap','excel.exports.chunk_size','excel.exports.pre_calculate_formulas','excel.exports.strict_null_comparison','excel.exports.csv.delimiter',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\SistemWorkshop\\public\\storage',
...
'session.same_site','session.partitioned','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages',
...
'livewire.payload.max_components','chunk-upload.storage.chunks','chunk-upload.storage.disk','chunk-upload.clear.timestamp','chunk-upload.clear.schedule.enabled',
'chunk-upload.clear.schedule.cron','chunk-upload.chunk.name.use.session','chunk-upload.chunk.name.use.browser','chunk-upload.handlers.custom','chunk-upload.handlers.override',
...
'dompdf.options.enable_html5_parser','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','access',);
        registerArgumentsSet('routes', 
'default-livewire.update','livewire.upload-file',
'livewire.preview-file','api.public.regional.provinces','api.public.regional.regencies',
'api.public.regional.districts','api.public.regional.villages','tracking.index','tracking.track','reception.qc-reject-report',
'cx-issues.report','webhooks.sleekflow','dashboard','dashboard.api-data','internal-tracking.index',
'regional.provinces','regional.regencies','regional.districts','regional.villages','profile.edit',
'profile.update','profile.destroy','admin.orders.show','admin.orders.update-shoe-info','admin.orders.update-shipping-address',
'admin.orders.update-customer-info','admin.orders.update-estimation-date','admin.orders.shipping-label','admin.orders.services.add','admin.orders.services.update',
'admin.orders.services.remove','admin.services.bulk-destroy','admin.services.export-excel','admin.services.template','admin.services.import',
'admin.services.index','admin.services.create','admin.services.store','admin.services.show','admin.services.edit',
'admin.services.update','admin.services.destroy','admin.promotions.toggle-active','admin.promotions.index','admin.promotions.create',
'admin.promotions.store','admin.promotions.show','admin.promotions.edit','admin.promotions.update','admin.promotions.destroy',
'admin.materials.bulk-destroy','admin.materials.export-pdf','admin.materials.export-excel','admin.materials.template','admin.materials.import',
'admin.materials.reconcile','admin.materials.index','admin.materials.create','admin.materials.store','admin.materials.show',
'admin.materials.edit','admin.materials.update','admin.materials.destroy','admin.supply-chain.index','admin.supply-chain.transactions',
'admin.users.bulk-destroy','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.complaints.trash','admin.complaints.restore',
'admin.complaints.force-delete','admin.complaints.index','admin.complaints.create','admin.complaints.store','admin.complaints.show',
'admin.complaints.edit','admin.complaints.update','admin.complaints.destroy','admin.complaints.api_reply','admin.purchases.export-pdf',
'admin.purchases.bulk-destroy','admin.purchases.index','admin.purchases.create','admin.purchases.store','admin.purchases.show',
'admin.purchases.edit','admin.purchases.update','admin.purchases.destroy','admin.purchases.payment','admin.performance.index',
'admin.system.index','admin.system.reset','admin.system.cleanup-orphaned-storage','admin.master-issues.toggle','admin.master-issues.index',
'admin.master-issues.create','admin.master-issues.store','admin.master-issues.edit','admin.master-issues.update','admin.master-issues.destroy',
'admin.master-solutions.toggle','admin.master-solutions.index','admin.master-solutions.create','admin.master-solutions.store','admin.master-solutions.edit',
'admin.master-solutions.update','admin.master-solutions.destroy','admin.data-integrity.index','admin.data-integrity.trash','admin.data-integrity.limbo',
'admin.data-integrity.restore-many','admin.data-integrity.force-delete-many','admin.data-integrity.cleanup','admin.data-integrity.repair-customer-links','admin.data-integrity.logs',
'admin.data-integrity.logs.clear','admin.customers.search-json','admin.customers.index','admin.customers.create','admin.customers.store',
'admin.customers.show','admin.customers.edit','admin.customers.update','admin.customers.destroy','admin.customers.upload-photo',
'admin.customers.photos.chunk','admin.customers.destroy-photo','admin.reports.index','admin.reports.financial','admin.reports.productivity',
'reception.index','reception.trash','reception.restore','reception.force-delete','reception.bulk-force-delete',
'reception.template','reception.export','reception.import','reception.store','reception.bulk-delete',
'reception.update-email','reception.update-shoe-info','reception.update-order','reception.print-tag','reception.print-spk',
'reception.process','reception.receive','reception.confirm','reception.send-email','reception.skip-assessment',
'reception.bulk-skip-assessment','reception.show','reception.process-reception','reception.destroy','manifest.index',
'manifest.create','manifest.store','manifest.show','manifest.receive','assessment.index',
'assessment.create','assessment.store','assessment.print-spk','assessment.skip-production','assessment.destroy',
'workshop.dashboard','workshop.dashboard.api-stats','workshop.export','workshop.dashboard-v2','preparation.index',
'preparation.show','preparation.update','preparation.update-station','preparation.finish','preparation.approve',
'preparation.reject','preparation.bulk-update','sortir.index','sortir.show','sortir.add-material',
'sortir.update-materials','sortir.add-service','sortir.destroy-material','sortir.finish','sortir.skip-production',
'sortir.bulk-skip-production','sortir.bulk-update','production.index','production.update-station','production.finish',
'production.approve','production.reject','production.late-info','production.late-info.update-description','production.late-info.update-new-estimation',
'production.late-info.update-material-arrival','production.late-info.update-material-name','production.late-info.upload-material-photo','production.late-info.material-info','production.late-info.delete-material-photo',
'production.bulk-update','qc.index','qc.show','qc.update-station','qc.update',
'qc.fail','qc.bulk-update','qc.pass','qc.finish','qc.approve',
'qc.reject','finish.trash','finish.restore','finish.force-delete','finish.bulk-restore',
'finish.bulk-force-delete','finish.bulk-destroy','finish.index','finish.show','finish.destroy',
'finish.pickup','finish.pickup-delivery','finish.add-service','finish.create-oto','finish.send-email',
'finish.generate-report','finish.bulk-delete-selection','shipping.index','shipping.manifest.preview','shipping.manifest.download',
'shipping.update','cx.dashboard','cx.dashboard.api-stats','cx.index','cx.history',
'cx.process','cx.destroy','cx.cancelled','cx.oto.index','cx.oto.contact',
'cx.oto.accept','cx.oto.reject','cx.oto.cancel','cx.after-confirmation.index','cx.after-confirmation.update',
'cs.dashboard','cs.analytics','cs.leads.lost','cs.export','cs.leads.store',
'cs.leads.show','cs.leads.update','cs.items.update','cs.leads.destroy','cs.leads.update-status',
'cs.leads.move-konsultasi','cs.leads.move-closing','cs.leads.move-follow-up','cs.leads.mark-lost','cs.quotations.store',
'cs.quotations.send','cs.quotations.accept','cs.quotations.reject','cs.quotations.export-pdf','cs.activities.store',
'cs.leads.set-follow-up','cs.workshop-payment','cs.spk.index','cs.spk.bulk-destroy','cs.spk.generate',
'cs.spk.mark-dp-paid','cs.spk.hand-to-workshop','cs.spk.export-pdf','cs.spk.shipping-label','cs.leads.konsultasi',
'cs.leads.follow-up','cs.leads.closing','cs.greeting.index','cs.greeting.template','cs.greeting.import',
'cs.greeting.claim','cs.greeting.bulk-delete','cs.greeting.bulk-delete-filtered','cx-issues.store','cx-issues.update',
'cx-issues.toggle-shipping','gallery.index','gallery.show','finance.invoices.index','finance.invoices.create',
'finance.invoices.store','finance.invoices.show','finance.invoices.payment','finance.invoices.update-shipping','finance.invoices.update-estimasi',
'finance.invoices.delete','finance.index','finance.export-excel','finance.payments.index','finance.payments.create',
'finance.payments.store','finance.mutations.index','finance.mutations.import','finance.mutations.template','finance.verifications.index',
'finance.verifications.verify','finance.donations','finance.donations.restore','finance.donations.force','finance.show',
'finance.payment.store','finance.status.update','finance.shipping.update','finance.export-payment-history','finance.destroy',
'finance.shipping.search','finance.shipping.rates','finance.print-invoice','finance.update-due-date','work-order-photos.store',
'work-order-photos.chunk','photos.process','photos.bulk-destroy','photos.destroy','photos.set-as-cover',
'photos.set-as-reference','orders.whatsapp_send','orders.whatsapp_template_test','storage.manual.racks.index','storage.manual.racks.store',
'storage.manual.racks.print-pdf','storage.manual.racks.sync','storage.manual.racks.update','storage.manual.racks.destroy','storage.manual.index',
'storage.manual.create','storage.manual.store','storage.manual.history','storage.manual.show','storage.manual.edit',
'storage.manual.update','storage.manual.bulk-destroy','storage.manual.destroy','storage.manual.release','storage.dashboard',
'storage.dashboard.api-stats','storage.racks.sync','storage.racks.trash','storage.racks.restore','storage.racks.force-delete',
'storage.racks.print-pdf','storage.racks.index','storage.racks.create','storage.racks.store','storage.racks.show',
'storage.racks.edit','storage.racks.update','storage.racks.destroy','storage.index','storage.store',
'storage.retrieve','storage.unassign','storage.search','storage.label','storage.shipping-label',
'storage.available-racks','storage.rack-details','storage.bulk-retrieve','storage.bulk-unassign','storage.bulk-destroy-selection',
'storage.show','material-requests.index','material-requests.create','material-requests.show','material-requests.approve',
'material-requests.reject','material-requests.mark-purchased','material-requests.cancel','material-requests.create-po','materials.selection.create',
'materials.selection.store','complaints.index','complaints.store','complaints.success','cs.guest.form',
'cs.guest.update','api.cx.master-issues','api.cx.master-solutions','api.cs.promos.for-service','api.cs.promos.validate',
'api.cs.promos.calculate','api.cs.promos.active','api.sync.work-orders','api.sync.shipping','finish.view-report',
'customer.verify-address','customer.report','login','password.request',
...
'127c60d07d774ee9f2dcafa7fa21d7d9::admin.supply-chain.dashboard','127c60d07d774ee9f2dcafa7fa21d7d9::admin.supply-chain.ledger','127c60d07d774ee9f2dcafa7fa21d7d9::cx.after-confirmation-list','127c60d07d774ee9f2dcafa7fa21d7d9::internal-tracking','127c60d07d774ee9f2dcafa7fa21d7d9::procurement.create',
'127c60d07d774ee9f2dcafa7fa21d7d9::procurement.index','127c60d07d774ee9f2dcafa7fa21d7d9::procurement.show','127c60d07d774ee9f2dcafa7fa21d7d9::sortir.detail','127c60d07d774ee9f2dcafa7fa21d7d9::sortir.index','127c60d07d774ee9f2dcafa7fa21d7d9::warehouse.dashboard',
'127c60d07d774ee9f2dcafa7fa21d7d9::workshop.dashboard-v2','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.material-alerts','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.production-lead-time-chart','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.recent-activity-feed','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.service-mix-chart',
'127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.spk-matrix','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.spk-pipeline-chart','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.top-metrics','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.top-service-names','127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.urgent-action-grid',
'127c60d07d774ee9f2dcafa7fa21d7d9::workshop.widgets.workload-heatmap','85600c9e19a1e672b5f768032e5f0aab::application-logo','85600c9e19a1e672b5f768032e5f0aab::auth-session-status','85600c9e19a1e672b5f768032e5f0aab::bar-chart','85600c9e19a1e672b5f768032e5f0aab::countdown-badge',
'85600c9e19a1e672b5f768032e5f0aab::cs-lead-card','85600c9e19a1e672b5f768032e5f0aab::danger-button','85600c9e19a1e672b5f768032e5f0aab::donut-chart','85600c9e19a1e672b5f768032e5f0aab::dropdown','85600c9e19a1e672b5f768032e5f0aab::dropdown-link',
'85600c9e19a1e672b5f768032e5f0aab::edit-issue-modal','85600c9e19a1e672b5f768032e5f0aab::flash-message','85600c9e19a1e672b5f768032e5f0aab::input-error','85600c9e19a1e672b5f768032e5f0aab::input-label','85600c9e19a1e672b5f768032e5f0aab::kpi-card',
'85600c9e19a1e672b5f768032e5f0aab::leaderboard','85600c9e19a1e672b5f768032e5f0aab::line-chart','85600c9e19a1e672b5f768032e5f0aab::modal','85600c9e19a1e672b5f768032e5f0aab::modal-custom','85600c9e19a1e672b5f768032e5f0aab::nav-link',
'85600c9e19a1e672b5f768032e5f0aab::period-filter','85600c9e19a1e672b5f768032e5f0aab::photo-uploader','85600c9e19a1e672b5f768032e5f0aab::primary-button','85600c9e19a1e672b5f768032e5f0aab::report-modal','85600c9e19a1e672b5f768032e5f0aab::responsive-nav-link',
'85600c9e19a1e672b5f768032e5f0aab::revision-modal','85600c9e19a1e672b5f768032e5f0aab::secondary-button','85600c9e19a1e672b5f768032e5f0aab::station-card','85600c9e19a1e672b5f768032e5f0aab::text-input','85600c9e19a1e672b5f768032e5f0aab::warehouse.⚡dashboard',
'85600c9e19a1e672b5f768032e5f0aab::workload-bar','85600c9e19a1e672b5f768032e5f0aab::workshop-filter-bar','85600c9e19a1e672b5f768032e5f0aab::⚡internal-tracking','admin.complaints.index','admin.complaints.show',
'admin.complaints.trash','admin.cs.dashboard.index','admin.cs.greeting.index','admin.customers.create','admin.customers.edit',
'admin.customers.index','admin.customers.show','admin.data-integrity.index','admin.data-integrity.limbo','admin.data-integrity.logs',
'admin.data-integrity.trash','admin.master-issues.index','admin.master-solutions.index','admin.materials.index','admin.materials.pdf',
'admin.orders.shipping-label','admin.orders.show','admin.performance.index','admin.promotions.form','admin.promotions.index',
'admin.purchases.create','admin.purchases.edit','admin.purchases.index','admin.purchases.pdf','admin.reports.financial_pdf',
'admin.reports.index','admin.reports.productivity_pdf','admin.services.index','admin.supply-chain.dashboard','admin.supply-chain.index',
'admin.supply-chain.ledger','admin.supply-chain.transactions','admin.system.index','admin.users.index','application-logo',
'assessment.create','assessment.index','assessment.print-spk-a4','assessment.print-spk-premium','auth-session-status',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','bar-chart','complaints.index','complaints.success','components.application-logo',
'components.auth-session-status','components.bar-chart','components.countdown-badge','components.cs-lead-card','components.danger-button',
'components.donut-chart','components.dropdown','components.dropdown-link','components.edit-issue-modal','components.flash-message',
'components.input-error','components.input-label','components.kpi-card','components.leaderboard','components.line-chart',
'components.modal','components.modal-custom','components.nav-link','components.period-filter','components.photo-uploader',
'components.primary-button','components.report-modal','components.responsive-nav-link','components.revision-modal','components.secondary-button',
'components.station-card','components.text-input','components.warehouse.⚡dashboard','components.workload-bar','components.workshop-filter-bar',
'components.⚡internal-tracking','countdown-badge','cs-lead-card','cs.dashboard','cs.dashboard.partials.lead-card',
'cs.leads.closing','cs.leads.follow-up','cs.leads.guest-form','cs.leads.konsultasi','cs.leads.lost',
'cs.leads.partials.activity-timeline','cs.leads.partials.customer-info','cs.leads.partials.header','cs.leads.partials.modals.edit-customer','cs.leads.partials.modals.edit-item',
'cs.leads.partials.modals.follow-up','cs.leads.partials.modals.handover','cs.leads.partials.modals.log-activity','cs.leads.partials.modals.quotation','cs.leads.partials.modals.spk',
'cs.leads.partials.quick-actions','cs.leads.partials.quotations','cs.leads.partials.scripts','cs.leads.partials.spk-detail','cs.leads.show',
'cs.pdf.shipping-label','cs.spk.index','customer.customer-report','customer.report-pending','customer.verify-address',
'cx.after-confirmation-list','cx.after-confirmation.index','cx.cancelled','cx.dashboard.index','cx.history',
'cx.index','cx.issue-report','cx.oto.index','danger-button','dashboard',
'dashboard-v2','dashboard-v2.sections.business-intel','dashboard-v2.sections.charts-script','dashboard-v2.sections.header','dashboard-v2.sections.journey-map',
'dashboard-v2.sections.kpi-cards','dashboard-v2.sections.production','dashboard-v2.sections.urgent-actions','dashboard.partials.business-intelligence','dashboard.partials.filters',
'dashboard.partials.header','dashboard.partials.inventory','dashboard.partials.logistics','dashboard.partials.metrics','dashboard.partials.operational',
'donut-chart','dropdown','dropdown-link','edit-issue-modal','emails.orders.finished',
'emails.orders.received','f4ac99e09542ff494432bc959d4fee61::app','f4ac99e09542ff494432bc959d4fee61::guest','f4ac99e09542ff494432bc959d4fee61::navigation','f4ac99e09542ff494432bc959d4fee61::partials.sidebar-content',
'f4ac99e09542ff494432bc959d4fee61::sidebar','finance.create-invoice','finance.donations.index','finance.index','finance.invoices',
'finance.mutations.import','finance.payment-history-export','finance.payments.create','finance.payments.index','finance.print-invoice',
'finance.print-invoice-gabungan','finance.show','finance.show-invoice','finance.verifications.index','finish.index',
'finish.show','finish.trash','flash-message','gallery.index','gallery.show',
'input-error','input-label','internal-tracking','kpi-card','layouts.app',
'layouts.guest','layouts.navigation','layouts.partials.sidebar-content','layouts.sidebar','layouts::app',
'layouts::guest','layouts::navigation','layouts::partials.sidebar-content','layouts::sidebar','leaderboard',
'line-chart','livewire.admin.supply-chain.dashboard','livewire.admin.supply-chain.ledger','livewire.cx.after-confirmation-list','livewire.internal-tracking',
'livewire.procurement.create','livewire.procurement.index','livewire.procurement.show','livewire.sortir.detail','livewire.sortir.index',
'livewire.warehouse.dashboard','livewire.workshop.dashboard-v2','livewire.workshop.widgets.material-alerts','livewire.workshop.widgets.production-lead-time-chart','livewire.workshop.widgets.recent-activity-feed',
'livewire.workshop.widgets.service-mix-chart','livewire.workshop.widgets.spk-matrix','livewire.workshop.widgets.spk-pipeline-chart','livewire.workshop.widgets.top-metrics','livewire.workshop.widgets.top-service-names',
'livewire.workshop.widgets.urgent-action-grid','livewire.workshop.widgets.workload-heatmap','manifest.create','manifest.index','manifest.show',
'manual-storage.create','manual-storage.edit','manual-storage.history','manual-storage.index','manual-storage.racks.index',
'manual-storage.show','material-requests.index','material-requests.show','materials.selection','modal',
'modal-custom','nav-link','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
...
'pagination::tailwind','pdf.rack_manifest','pdf.warehouse_rack_manifest','period-filter','photo-uploader',
'preparation.index','preparation.partials.station-card','preparation.show','primary-button','procurement.create',
'procurement.index','procurement.show','production.index','production.late-info','production.material-info',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','qc.index',
'qc.show','reception.import-errors','reception.index','reception.partials.modals','reception.partials.order-actions',
'reception.partials.scripts','reception.print-tag','reception.qc-reject-report','reception.show','reception.trash',
'report-modal','reports.finish-report-pdf','reports.workshop-analytics','responsive-nav-link','revision-modal',
'secondary-button','shipping.index','shipping.manifest_pdf','shipping.manifest_preview','sortir.detail',
'sortir.index','sortir.index','sortir.partials.priority-badge','sortir.show','station-card',
'storage.index','storage.label','storage.partials.assign-modal','storage.racks.index','storage.racks.trash',
'storage.shipping-label','text-input','tracking.index','tracking.result','vendor.pagination.bootstrap-4',
...
'vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','warehouse.dashboard','warehouse.dashboard.index',
'warehouse.⚡dashboard','welcome','workload-bar','workshop-filter-bar','workshop.dashboard-v2',
'workshop.dashboard.index','workshop.dashboard.partials.spk-matrix','workshop.widgets.material-alerts','workshop.widgets.production-lead-time-chart','workshop.widgets.recent-activity-feed',
'workshop.widgets.service-mix-chart','workshop.widgets.spk-matrix','workshop.widgets.spk-pipeline-chart','workshop.widgets.top-metrics','workshop.widgets.top-service-names',
'workshop.widgets.urgent-action-grid','workshop.widgets.workload-heatmap','⚡internal-tracking','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.laragon.www.SistemWorkshop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'QUEUE_CONNECTION','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','DB_TIMEZONE','SESSION_DRIVER','SESSION_LIFETIME',
...
'RAJAONGKIR_API_KEY','CEKAT_INBOX_ID','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','CEKAT_BASE_URL','CEKAT_API_KEY',
'DASHBOARD_API_KEY',);
