...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','excel.exports.chunk_size',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\SistemWorkshop\\public\\storage','logging.default','logging.deprecations.channel',
...
'dompdf.options.enable_html5_parser','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'web','api',);
        registerArgumentsSet('routes', 'tracking.index','tracking.track','dashboard',
'profile.edit','profile.update','profile.destroy','admin.orders.show','admin.orders.shipping-label',
'admin.services.bulk-destroy','admin.services.export-excel','admin.services.template','admin.services.import','admin.services.index',
'admin.services.create','admin.services.store','admin.services.show','admin.services.edit','admin.services.update',
'admin.services.destroy','admin.materials.bulk-destroy','admin.materials.export-pdf','admin.materials.export-excel','admin.materials.template',
'admin.materials.import','admin.materials.index','admin.materials.create','admin.materials.store','admin.materials.show',
'admin.materials.edit','admin.materials.update','admin.materials.destroy','admin.users.bulk-destroy','admin.users.index',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.complaints.trash','admin.complaints.restore','admin.complaints.force-delete','admin.complaints.index',
'admin.complaints.create','admin.complaints.store','admin.complaints.show','admin.complaints.edit','admin.complaints.update',
'admin.complaints.destroy','admin.complaints.api_reply','admin.purchases.export-pdf','admin.purchases.bulk-destroy','admin.purchases.index',
'admin.purchases.create','admin.purchases.store','admin.purchases.show','admin.purchases.edit','admin.purchases.update',
'admin.purchases.destroy','admin.purchases.payment','admin.performance.index','admin.system.index','admin.system.reset',
'admin.customers.index','admin.customers.create','admin.customers.store','admin.customers.show','admin.customers.edit',
'admin.customers.update','admin.customers.destroy','admin.customers.upload-photo','admin.reports.index','admin.reports.financial',
'admin.reports.productivity','reception.index','reception.trash','reception.restore','reception.force-delete',
'reception.bulk-force-delete','reception.template','reception.export','reception.import','reception.store',
'reception.bulk-delete','reception.update-email','reception.update-shoe-info','reception.update-order','reception.print-tag',
'reception.print-spk','reception.process','reception.receive','reception.confirm','reception.send-email',
'reception.skip-assessment','reception.bulk-skip-assessment','reception.show','reception.process-reception','reception.destroy',
'assessment.index','assessment.create','assessment.store','assessment.print-spk','assessment.destroy',
'workshop.dashboard','workshop.export','preparation.index','preparation.show','preparation.update',
'preparation.update-station','preparation.finish','preparation.approve','preparation.reject','preparation.bulk-update',
'sortir.index','sortir.show','sortir.add-material','sortir.update-materials','sortir.add-service',
'sortir.destroy-material','sortir.finish','sortir.skip-production','sortir.bulk-skip-production','sortir.bulk-update',
'production.index','production.update-station','production.finish','production.approve','production.reject',
...
'finish.pickup','finish.add-service','finish.create-oto','finish.send-email','cx.dashboard',
'cx.index','cx.process','cx.destroy','cx.cancelled','cx.oto.index',
'cx.oto.contact','cx.oto.accept','cx.oto.reject','cx.oto.cancel','cs.dashboard',
'cs.export','cs.leads.store','cs.leads.show','cs.leads.destroy','cs.leads.update-status',
'cs.leads.move-konsultasi','cs.leads.move-closing','cs.leads.mark-lost','cs.quotations.store','cs.quotations.send',
'cs.quotations.accept','cs.quotations.reject','cs.quotations.export-pdf','cs.spk.generate','cs.spk.mark-dp-paid',
'cs.spk.hand-to-workshop','cs.spk.export-pdf','cs.workshop-payment','cs.activities.store','cs.leads.set-follow-up',
'cx-issues.store','gallery.index','gallery.show','finance.index','finance.donations',
'finance.donations.restore','finance.donations.force','finance.show','finance.payment.store','finance.status.update',
'finance.shipping.update','finance.export-payment-history','finance.destroy','finance.shipping.search','finance.shipping.rates',
'finance.print-invoice','finance.update-due-date','finance.verify-spk.approve','finance.verify-spk.reject','finance.verify-wo.approve',
'finance.verify-wo.reject','work-order-photos.store','photos.destroy','photos.set-as-cover','orders.whatsapp_send',
'orders.whatsapp_template_test','algorithm.dashboard','algorithm.toggle','algorithm.run','algorithm.config.update',
'algorithm.metrics','algorithm.logs','storage.dashboard','storage.racks.index','storage.racks.create',
'storage.racks.store','storage.racks.show','storage.racks.edit','storage.racks.update','storage.racks.destroy',
'storage.index','storage.store','storage.retrieve','storage.unassign','storage.search',
'storage.label','storage.shipping-label','storage.available-racks','storage.show','complaints.index',
'complaints.store','complaints.success','cs.guest.form','cs.guest.update','register','login','password.request','password.email',
...
'admin.complaints.index','admin.complaints.show','admin.complaints.trash','admin.customers.create','admin.customers.edit',
'admin.customers.index','admin.customers.show','admin.materials.index','admin.materials.pdf','admin.orders.shipping-label',
'admin.orders.show','admin.performance.index','admin.purchases.create','admin.purchases.edit','admin.purchases.index',
'admin.purchases.pdf','admin.reports.financial_pdf','admin.reports.index','admin.reports.productivity_pdf','admin.services.index',
'admin.system.index','admin.users.index','algorithm.dashboard.index','assessment.create','assessment.index',
'assessment.print-spk','assessment.print-spk-a4','assessment.print-spk-premium','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','complaints.index',
'complaints.success','components.application-logo','components.auth-session-status','components.bar-chart','components.countdown-badge',
'components.cs-lead-card','components.danger-button','components.donut-chart','components.dropdown','components.dropdown-link',
'components.flash-message','components.input-error','components.input-label','components.kpi-card','components.leaderboard',
'components.line-chart','components.modal','components.nav-link','components.period-filter','components.photo-uploader',
'components.primary-button','components.report-modal','components.responsive-nav-link','components.secondary-button','components.station-card',
'components.text-input','components.workload-bar','components.workshop-filter-bar','cs.dashboard','cs.leads.guest-form',
'cs.leads.show','cs.pdf.quotation','cs.pdf.spk','cx.cancelled','cx.dashboard.index',
'cx.index','cx.oto.index','dashboard','dashboard.partials.business-intelligence','dashboard.partials.filters',
...
'emails.orders.finished','emails.orders.received','finance.donations.index','finance.index','finance.payment-history-export',
'finance.print-invoice','finance.show','finish.index','finish.show','finish.trash',
'gallery.index','gallery.show','layouts.app','layouts.guest','layouts.navigation',
'layouts.partials.sidebar-content','layouts.sidebar','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
...
'pagination::tailwind','preparation.index','preparation.partials.station-card','preparation.show','production.index',
...
'qc.show','reception.import-errors','reception.index','reception.print-tag','reception.show',
'reception.trash','reports.workshop-analytics','sortir.index','sortir.show','storage.index',
'storage.label','storage.partials.assign-modal','storage.racks.index','storage.shipping-label','tracking.index',
'tracking.result','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'warehouse.dashboard.index','welcome','workshop.dashboard.index','workshop.dashboard.partials.spk-matrix','laravel-exceptions-renderer::components.badge',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RAJAONGKIR_API_KEY','CEKAT_INBOX_ID','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',
'CEKAT_BASE_URL','CEKAT_API_KEY',);
