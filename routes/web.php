...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('cx')->name('cx.')->group(function () {
        ...
        Route::middleware('access:cx')->group(function () {
            ...
            Route::post('/oto/{id}/toggle-automation', [App\Http\Controllers\CXOTOController::class, 'toggleAutomation'])->name('oto.toggle-automation');
    ...
    Route::middleware('access:finance')->group(function () {
        ...
        Route::get('finance/dashboard/export-excel', [App\Http\Controllers\FinanceReportController::class, 'exportExcel'])->name('finance.dashboard.export-excel');
